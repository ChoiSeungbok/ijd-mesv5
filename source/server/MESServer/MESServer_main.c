                   ...
                   LPSTR lpszCmdLine, int nCmdShow)
{
    ...
    //    LOG_head("##### DBC_execute_query Null Terminate #####################################");

    //    sprintf(s_sql_short, "SELECT MSG_ID FROM MMSGMSGDEF WHERE MSG_ID = 'WIP-0001'");

    //    LOG_add("sql size", MP_INT, strlen(s_sql_short));
    //    DBC_execute_query(s_sql_short, &i_col);
    //    if(DB_error_code == DB_SUCCESS)
    //    {   memset(s_data, 0x00, sizeof(s_data)); DBC_get_next(); DBC_get_value(0, s_data, sizeof(s_data));
    ...
    //    DBC_execute_query(s_sql_big, &i_col);
    //    if(DB_error_code == DB_SUCCESS)
    //    {   memset(s_data, 0x00, sizeof(s_data)); DBC_get_next(); DBC_get_value(0, s_data, sizeof(s_data));
    //        LOG_add("sql data", MP_STR, sizeof(s_data), s_data); } else { LOG_add("DB_ERR", MP_STR, sizeof(DB_error_msg), DB_error_msg); }
    //    DBC_close_dsql();
    ...
    //    COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_SYSTEM, MP_LOG_CATE_SYSTEM);
    //    /*****************************/
    //    LOG_head("##### DBC_execute_query Not Null Terminate #####################################");
    ...
    //    COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_SYSTEM, MP_LOG_CATE_SYSTEM);
    //    /*****************************/
    //    LOG_head("##### DBC_execute_query2 Null Terminate #####################################");

    //    sprintf(s_sql_short, "SELECT MSG_ID FROM MMSGMSGDEF WHERE MSG_ID = 'WIP-0001'");

    //    LOG_add("sql size", MP_INT, strlen(s_sql_short));
    //    DBC_execute_query2(s_sql_short);
    //    if(DB_error_code == DB_SUCCESS)
    //    {   memset(s_data, 0x00, sizeof(s_data)); DBC_get_next(); DBC_get_value(0, s_data, sizeof(s_data));
    //        LOG_add("sql data", MP_STR, sizeof(s_data), s_data); } else { LOG_add("DB_ERR", MP_STR, sizeof(DB_error_msg), DB_error_msg); }
    //    DBC_close_dsql();
    ...
    //    COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_SYSTEM, MP_LOG_CATE_SYSTEM);
    //    /*****************************/
    //    LOG_head("##### DBC_execute_query2 Not Null Terminate #####################################");
    ...
    //    COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_SYSTEM, MP_LOG_CATE_SYSTEM);
    //    /*****************************/
    //    LOG_head("##### DBC_execute_query3 Null Terminate #####################################");

    //    sprintf(s_sql_short, "SELECT MSG_ID FROM MMSGMSGDEF WHERE MSG_ID = 'WIP-0001'");

    //    LOG_add("sql size", MP_INT, strlen(s_sql_short));
    //    DBC_execute_query3(s_sql_short);
    //    if(DB_error_code == DB_SUCCESS)
    //    {   memset(s_data, 0x00, sizeof(s_data)); DBC_get_next(); DBC_get_value(0, s_data, sizeof(s_data));
    //        LOG_add("sql data", MP_STR, sizeof(s_data), s_data); } else { LOG_add("DB_ERR", MP_STR, sizeof(DB_error_msg), DB_error_msg); }
    //    DBC_close_dsql();
    ...
    //    COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_SYSTEM, MP_LOG_CATE_SYSTEM);
    //    /*****************************/
    //    LOG_head("##### DBC_execute_query3 Not Null Terminate #####################################");
...
int WinInitApplication(HINSTANCE hInst)
{
    ...
    else if (strcmp(s_app_name, "EISServer") == 0)
    {
        wndclass.hIcon = LoadIcon(hInst, (LPCTSTR)IDI_EISServer);
        wndclass.hIconSm = LoadIcon(hInst, (LPCTSTR)IDI_EISServer);
    }
    else if (strcmp(s_app_name, "INFServer") == 0)
    {
        wndclass.hIcon = LoadIcon(hInst, (LPCTSTR)IDI_INFServer);
        wndclass.hIconSm = LoadIcon(hInst, (LPCTSTR)IDI_INFServer);
    }
