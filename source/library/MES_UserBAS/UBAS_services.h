...
DllExport int BAS_Update_Calendar_List_Before_1(TRSNode *in_node, TRSNode *out_node);
DllExport int BAS_Update_Calendar_List_After_1(TRSNode *in_node, TRSNode *out_node);
