...
void BAS_UserRoutine_add_service()
{
    ...
    COM_add_service("MES_UserBAS", "BAS_Update_Calendar_List_Before", REPLY, BAS_Update_Calendar_List_Before_1);
    COM_add_service("MES_UserBAS", "BAS_Update_Calendar_List_After", REPLY, BAS_Update_Calendar_List_After_1);
