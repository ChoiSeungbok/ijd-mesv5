...
REM Set system environment variable "ORA_HOME" - xxxx\Oracle\Ora19c
set ORA_HOME=C:\app\client\LISNER\product\19.0.0\client_1

REM ---------------------
REM  VS2010 Standard Debug, Release Mode
REM ---------------------

 proc PARSE=PARTIAL SQLCHECK=SEMANTICS USERID=mesmgr/mesmgr@IJDMES iname=%1 oname=%2\%1.c include="..\..\..\inc\dbinc" include="%VCINSTALLDIR%\include" include="%ORA_HOME%\precomp\public" define="_ALM" define="_BOM" define="_EDC" define="_FMB" define="_INV" define="_ORD" define="_POP" define="_QCM" define="_RAS" define="_RCP" define="_RTD" define="_SPC" define="_WIP" define="_CRR" define="_TOOL"
 REM  proc PARSE=PARTIAL SQLCHECK=SEMANTICS USERID=mesmgr/mesmgr@TIJDMES iname=%1 oname=%2\%1.c include="..\..\..\inc\dbinc" include="%VCINSTALLDIR%\include" include="%ORA_HOME%\precomp\public" define="_ALM" define="_BOM" define="_EDC" define="_FMB" define="_INV" define="_ORD" define="_POP" define="_QCM" define="_RAS" define="_RCP" define="_RTD" define="_SPC" define="_WIP" define="_CRR" define="_TOOL"
 REM  proc PARSE=PARTIAL SQLCHECK=SEMANTICS USERID=mesmgr/mesmgr@IJDVEM iname=%1 oname=%2\%1.c include="..\..\..\inc\dbinc" include="%VCINSTALLDIR%\include" include="%ORA_HOME%\precomp\public" define="_ALM" define="_BOM" define="_EDC" define="_FMB" define="_INV" define="_ORD" define="_POP" define="_QCM" define="_RAS" define="_RCP" define="_RTD" define="_SPC" define="_WIP" define="_CRR" define="_TOOL"
