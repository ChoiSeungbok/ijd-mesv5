/*******************************************************************************
    ...
    File Name   : USPM_Update_Spec_Character_Character.c
    Description : User Routine for SPM_Update_Spec_Character_Character
...
int SPM_Update_Spec_Character_Before_1(TRSNode *in_node, TRSNode *out_node)
{
...
int SPM_Update_Spec_Character_After_1(TRSNode *in_node, TRSNode *out_node)
{
