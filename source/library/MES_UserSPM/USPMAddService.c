...
void SPM_UserRoutine_add_service()
{
	...
	COM_add_service("MES_UserSPM", "SPM_Update_Spec_Character_Before", REPLY, SPM_Update_Spec_Character_Before_1);
	COM_add_service("MES_UserSPM", "SPM_Update_Spec_Character_After", REPLY, SPM_Update_Spec_Character_After_1);
...
void SLC_BIND_FUNCTION()
{
	...
	SLC_ADD_FUNCTION("SPM_Update_Spec_Character_Before", 1);
	SLC_ADD_FUNCTION("SPM_Update_Spec_Character_After", 1);
