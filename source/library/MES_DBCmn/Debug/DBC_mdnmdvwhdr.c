...
static unsigned int sqlctx = 9107499;
...
"select VIEW_ID ,COL_NAME ,DISPLAY_NAME ,COL_DESC ,CREATE_TIME ,CREATE_USER_\
ID ,UPDATE_TIME ,UPDATE_USER_ID  from MDNMDVWHDR where VIEW_ID=:b0 order by V\
IEW_ID asc ,COL_NAME asc             ";

 static const char *sq0011 = 
"select W.VIEW_ID ,W.COL_NAME ,W.DISPLAY_NAME ,W.COL_DESC ,TO_CHAR(NVL(U.COL\
_SEQ,99999)) ,W.CREATE_USER_ID ,W.UPDATE_TIME ,W.UPDATE_USER_ID  from MDNMDVW\
HDR W ,MDNMDVUHDR U where (((((W.VIEW_ID=U.VIEW_ID(+) and W.COL_NAME=U.COL_NA\
ME(+)) and W.VIEW_ID=:b0) and U.VIEW_ID(+)=:b0) and U.FACTORY(+)=:b2) and U.U\
SER_ID(+)=:b3) order by U.COL_SEQ            ";
...
{13,4130,846,0,0,
5,0,0,1,197,0,4,44,0,0,10,2,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,0,
60,0,0,2,193,0,4,68,0,0,9,1,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,
111,0,0,3,209,0,4,125,0,0,10,2,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,0,
166,0,0,4,79,0,4,184,0,0,3,2,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,
193,0,0,5,61,0,2,220,0,0,2,2,0,1,0,1,97,0,0,1,97,0,0,
216,0,0,6,42,0,2,226,0,0,1,1,0,1,0,1,97,0,0,
235,0,0,7,158,0,3,254,0,0,8,8,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,
0,1,97,0,0,1,97,0,0,1,97,0,0,
282,0,0,8,254,0,3,290,0,0,2,2,0,1,0,1,97,0,0,1,97,0,0,
305,0,0,9,159,0,5,330,0,0,8,8,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,
0,1,97,0,0,1,97,0,0,1,97,0,0,
352,0,0,10,189,0,9,382,0,0,1,1,0,1,0,1,97,0,0,
371,0,0,11,351,0,9,404,0,0,4,4,0,1,0,1,97,0,0,1,0,0,0,1,97,0,0,1,97,0,0,
402,0,0,10,0,0,13,432,0,0,8,0,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,
0,2,97,0,0,2,97,0,0,2,97,0,0,
449,0,0,11,0,0,13,443,0,0,8,0,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,
0,2,97,0,0,2,97,0,0,2,97,0,0,
496,0,0,10,0,0,15,481,0,0,0,0,0,1,0,
511,0,0,11,0,0,15,484,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_mdnmdvwhdr.pc
**    DB Type     : Unix Oracle
...
void DBC_add_null_mdnmdvwhdr(struct MDNMDVWHDR_N_TAG *MDNMDVWHDR_N, struct MDNMDVWHDR_TAG *MDNMDVWHDR);
void DBC_del_null_mdnmdvwhdr(struct MDNMDVWHDR_N_TAG *MDNMDVWHDR_N, struct MDNMDVWHDR_TAG *MDNMDVWHDR);


/* SQL SELECT Function */
void DBC_select_mdnmdvwhdr(int sel_type, struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MDNMDVWHDR_N_TAG MDNMDVWHDR_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_mdnmdvwhdr(&MDNMDVWHDR_N, MDNMDVWHDR);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                    ...
                    UPDATE_USER_ID
                INTO 
                    :MDNMDVWHDR_N.VIEW_ID,
                    :MDNMDVWHDR_N.COL_NAME,
                    :MDNMDVWHDR_N.DISPLAY_NAME,
                    :MDNMDVWHDR_N.COL_DESC,
                    :MDNMDVWHDR_N.CREATE_TIME,
                    :MDNMDVWHDR_N.CREATE_USER_ID,
                    :MDNMDVWHDR_N.UPDATE_TIME,
                    :MDNMDVWHDR_N.UPDATE_USER_ID
                FROM MDNMDVWHDR
                WHERE VIEW_ID = :MDNMDVWHDR_N.VIEW_ID
                    AND COL_NAME = :MDNMDVWHDR_N.COL_NAME; */ 

{
            ...
            sqlstm.stmt = "select VIEW_ID ,COL_NAME ,DISPLAY_NAME ,COL_DESC\
 ,CREATE_TIME ,CREATE_USER_ID ,UPDATE_TIME ,UPDATE_USER_ID into :b0,:b1,:b2,:\
b3,:b4,:b5,:b6,:b7  from MDNMDVWHDR where (VIEW_ID=:b0 and COL_NAME=:b1)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MDNMDVWHDR_N.VIEW_ID);
            ...
            sqlstm.sqhstv[1] = (         void  *)(MDNMDVWHDR_N.COL_NAME);
            ...
            sqlstm.sqhstv[2] = (         void  *)(MDNMDVWHDR_N.DISPLAY_NAME);
            ...
            sqlstm.sqhstv[3] = (         void  *)(MDNMDVWHDR_N.COL_DESC);
            ...
            sqlstm.sqhstv[4] = (         void  *)(MDNMDVWHDR_N.CREATE_TIME);
            ...
            sqlstm.sqhstv[5] = (         void  *)(MDNMDVWHDR_N.CREATE_USER_ID);
            ...
            sqlstm.sqhstv[6] = (         void  *)(MDNMDVWHDR_N.UPDATE_TIME);
            ...
            sqlstm.sqhstv[7] = (         void  *)(MDNMDVWHDR_N.UPDATE_USER_ID);
            ...
            sqlstm.sqhstv[8] = (         void  *)(MDNMDVWHDR_N.VIEW_ID);
            ...
            sqlstm.sqhstv[9] = (         void  *)(MDNMDVWHDR_N.COL_NAME);
...

{
            ...
            sqlstm.stmt = "select VIEW_ID ,COL_NAME ,DISPLAY_NAME ,COL_DESC\
 ,CREATE_TIME ,CREATE_USER_ID ,UPDATE_TIME ,UPDATE_USER_ID into :b0,:b1,:b2,:\
b3,:b4,:b5,:b6,:b7  from MDNMDVWHDR where (VIEW_ID=:b0 and ROWNUM=1)";
            sqlstm.iters = (unsigned int  )1;
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_mdnmdvwhdr(&MDNMDVWHDR_N, MDNMDVWHDR);
    }

    DB_stop_query_timer("DBC_select_mdnmdvwhdr", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_mdnmdvwhdr_for_update(int sel_type, struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.stmt = "select VIEW_ID ,COL_NAME ,DISPLAY_NAME ,COL_DESC\
 ,CREATE_TIME ,CREATE_USER_ID ,UPDATE_TIME ,UPDATE_USER_ID into :b0,:b1,:b2,:\
b3,:b4,:b5,:b6,:b7  from MDNMDVWHDR where (VIEW_ID=:b0 and COL_NAME=:b1) for \
update ";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_select_mdnmdvwhdr_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_mdnmdvwhdr_scalar(int sel_type, struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MDNMDVWHDR where\
 (VIEW_ID=:b1 and COL_NAME=:b2)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MDNMDVWHDR_N.VIEW_ID);
            sqlstm.sqhstl[1] = (unsigned int  )31;
            sqlstm.sqhsts[1] = (         int  )0;
            sqlstm.sqindv[1] = (         void  *)0;
            sqlstm.sqinds[1] = (         int  )0;
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MDNMDVWHDR_N.COL_NAME);
            sqlstm.sqhstl[2] = (unsigned int  )31;
            sqlstm.sqhsts[2] = (         int  )0;
            sqlstm.sqindv[2] = (         void  *)0;
            sqlstm.sqinds[2] = (         int  )0;
    ...
    DB_stop_query_timer("DBC_select_mdnmdvwhdr_scalar", sel_type);
...
/* SQL DELETE Function */
void DBC_delete_mdnmdvwhdr(int sel_type, struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MDNMDVWHDR
                WHERE VIEW_ID = :MDNMDVWHDR_N.VIEW_ID
                    AND COL_NAME = :MDNMDVWHDR_N.COL_NAME; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MDNMDVWHDR  where (VIEW_ID=:b0 and \
COL_NAME=:b1)";
            sqlstm.iters = (unsigned int  )1;
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MDNMDVWHDR  where VIEW_ID=:b0";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_delete_mdnmdvwhdr", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_mdnmdvwhdr(struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MDNMDVWHDR( 
                    VIEW_ID, 
                    COL_NAME, 
                    DISPLAY_NAME,
                    COL_DESC,
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MDNMDVWHDR (VIEW_ID,COL_NAME,DISPLAY_NAME,CO\
L_DESC,CREATE_TIME,CREATE_USER_ID,UPDATE_TIME,UPDATE_USER_ID) values (:b0,:b1\
,:b2,:b3,:b4,:b5,:b6,:b7)";
    sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_insert_mdnmdvwhdr", 0);
}

/* SQL INSERT Function */
void DBC_insert_select_mdnmdvwhdr(struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
    ...
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MDNMDVWHDR (VIEW_ID,COL_NAME,DISPLAY_NAME,CO\
L_DESC,CREATE_TIME,CREATE_USER_ID,UPDATE_TIME,UPDATE_USER_ID)select :b0 ,COL_\
NAME ,DISPLAY_NAME ,COL_DESC ,CREATE_TIME ,CREATE_USER_ID ,UPDATE_TIME ,UPDAT\
E_USER_ID  from MDNMDVWHDR where VIEW_ID=:b1";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (         void  *)(MDNMDVWHDR_N.COL_NAME);
    sqlstm.sqhstl[0] = (unsigned int  )31;
    sqlstm.sqhsts[0] = (         int  )0;
    sqlstm.sqindv[0] = (         void  *)0;
    sqlstm.sqinds[0] = (         int  )0;
...
/* SQL UPDATE Function */
void DBC_update_mdnmdvwhdr(int sel_type, struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MDNMDVWHDR SET
                    DISPLAY_NAME = :MDNMDVWHDR_N.DISPLAY_NAME,
                    COL_DESC = :MDNMDVWHDR_N.COL_DESC,
                    CREATE_TIME = :MDNMDVWHDR_N.CREATE_TIME,
                    CREATE_USER_ID = :MDNMDVWHDR_N.CREATE_USER_ID,
                    UPDATE_TIME = :MDNMDVWHDR_N.UPDATE_TIME,
                    UPDATE_USER_ID = :MDNMDVWHDR_N.UPDATE_USER_ID
                WHERE VIEW_ID = :MDNMDVWHDR_N.VIEW_ID
                    AND COL_NAME = :MDNMDVWHDR_N.COL_NAME; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MDNMDVWHDR  set DISPLAY_NAME=:b0,COL_DESC\
=:b1,CREATE_TIME=:b2,CREATE_USER_ID=:b3,UPDATE_TIME=:b4,UPDATE_USER_ID=:b5 wh\
ere (VIEW_ID=:b6 and COL_NAME=:b7)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MDNMDVWHDR_N.DISPLAY_NAME);
            sqlstm.sqhstl[0] = (unsigned int  )31;
            sqlstm.sqhsts[0] = (         int  )0;
            sqlstm.sqindv[0] = (         void  *)0;
            sqlstm.sqinds[0] = (         int  )0;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MDNMDVWHDR_N.COL_DESC);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MDNMDVWHDR_N.CREATE_TIME);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MDNMDVWHDR_N.CREATE_USER_ID);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MDNMDVWHDR_N.UPDATE_TIME);
            sqlstm.sqhstl[4] = (unsigned int  )15;
            sqlstm.sqhsts[4] = (         int  )0;
            sqlstm.sqindv[4] = (         void  *)0;
            sqlstm.sqinds[4] = (         int  )0;
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MDNMDVWHDR_N.UPDATE_USER_ID);
            sqlstm.sqhstl[5] = (unsigned int  )21;
            sqlstm.sqhsts[5] = (         int  )0;
            sqlstm.sqindv[5] = (         void  *)0;
            sqlstm.sqinds[5] = (         int  )0;
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)(MDNMDVWHDR_N.VIEW_ID);
            ...
            sqlstm.sqadto[6] = (unsigned short )0;
            sqlstm.sqtdso[6] = (unsigned short )0;
            sqlstm.sqhstv[7] = (         void  *)(MDNMDVWHDR_N.COL_NAME);
    ...
    DB_stop_query_timer("DBC_update_mdnmdvwhdr", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_mdnmdvwhdr(int sel_type, struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MDNMDVWHDR_CUR_1 CURSOR FOR
                SELECT 
                    VIEW_ID,
                    COL_NAME,
                    DISPLAY_NAME,
            ...
            /* EXEC SQL OPEN DBC_MDNMDVWHDR_CUR_1; */ 

{
        ...
        case 2:
            /* EXEC SQL DECLARE DBC_MDNMDVWHDR_CUR_2 CURSOR FOR
                SELECT 
                    W.VIEW_ID,
                    W.COL_NAME,
                    W.DISPLAY_NAME,
                    W.COL_DESC,
                    TO_CHAR(NVL(U.COL_SEQ,99999)),
                    W.CREATE_USER_ID,
                    W.UPDATE_TIME,
                    W.UPDATE_USER_ID
                FROM MDNMDVWHDR W, MDNMDVUHDR U
                WHERE  W.VIEW_ID=U.VIEW_ID(+)
                AND W.COL_NAME = U.COL_NAME(+)
                AND W.VIEW_ID=:MDNMDVWHDR_N.VIEW_ID
                AND U.VIEW_ID(+)=:MDNMDVWHDR_N.VIEW_ID
                AND U.FACTORY(+)=:MDNMDVWHDR_N.COL_NAME
                AND U.USER_ID(+)=:MDNMDVWHDR_N.DISPLAY_NAME
                ORDER BY U.COL_SEQ; */ 

            /* EXEC SQL OPEN DBC_MDNMDVWHDR_CUR_2; */ 

{
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MDNMDVWHDR_N.DISPLAY_NAME);
    ...
    DB_stop_query_timer("DBC_open_mdnmdvwhdr", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_mdnmdvwhdr(int sel_type, struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MDNMDVWHDR_CUR_1 INTO
                :MDNMDVWHDR_N.VIEW_ID,
                :MDNMDVWHDR_N.COL_NAME,
                :MDNMDVWHDR_N.DISPLAY_NAME,
                :MDNMDVWHDR_N.COL_DESC,
...

{
            ...
            break;
        case 2:
            /* EXEC SQL FETCH DBC_MDNMDVWHDR_CUR_2 INTO
                :MDNMDVWHDR_N.VIEW_ID,
                :MDNMDVWHDR_N.COL_NAME,
                :MDNMDVWHDR_N.DISPLAY_NAME,
                :MDNMDVWHDR_N.COL_DESC,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_mdnmdvwhdr", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_mdnmdvwhdr(int sel_type)
{
    DB_start_query_timer();
    DB_error_code = 0;
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MDNMDVWHDR_CUR_1; */ 

{
            ...
            break;
        case 2:
            /* EXEC SQL CLOSE DBC_MDNMDVWHDR_CUR_2; */ 

{
    ...
    DB_stop_query_timer("DBC_close_mdnmdvwhdr", sel_type);
}


/* Initialize Function */
void DBC_init_mdnmdvwhdr(struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    /* memset by Space */
    memset(MDNMDVWHDR, ' ', sizeof(struct MDNMDVWHDR_TAG));
...
{
    /* memset by NULL */
    memset(MDNMDVWHDR_N, '\0', sizeof(struct MDNMDVWHDR_N_TAG));
    
    MEMCPY_AN(MDNMDVWHDR_N->VIEW_ID, MDNMDVWHDR->VIEW_ID, sizeof(MDNMDVWHDR->VIEW_ID));
    MEMCPY_AN(MDNMDVWHDR_N->COL_NAME, MDNMDVWHDR->COL_NAME, sizeof(MDNMDVWHDR->COL_NAME));
    MEMCPY_AN(MDNMDVWHDR_N->DISPLAY_NAME, MDNMDVWHDR->DISPLAY_NAME, sizeof(MDNMDVWHDR->DISPLAY_NAME));
    MEMCPY_AN(MDNMDVWHDR_N->COL_DESC, MDNMDVWHDR->COL_DESC, sizeof(MDNMDVWHDR->COL_DESC));
    MEMCPY_AN(MDNMDVWHDR_N->CREATE_TIME, MDNMDVWHDR->CREATE_TIME, sizeof(MDNMDVWHDR->CREATE_TIME));
    MEMCPY_AN(MDNMDVWHDR_N->CREATE_USER_ID, MDNMDVWHDR->CREATE_USER_ID, sizeof(MDNMDVWHDR->CREATE_USER_ID));
    MEMCPY_AN(MDNMDVWHDR_N->UPDATE_TIME, MDNMDVWHDR->UPDATE_TIME, sizeof(MDNMDVWHDR->UPDATE_TIME));
    MEMCPY_AN(MDNMDVWHDR_N->UPDATE_USER_ID, MDNMDVWHDR->UPDATE_USER_ID, sizeof(MDNMDVWHDR->UPDATE_USER_ID));
}
...
void DBC_del_null_mdnmdvwhdr(struct MDNMDVWHDR_N_TAG *MDNMDVWHDR_N, struct MDNMDVWHDR_TAG *MDNMDVWHDR)
{
    MEMCPY_DN(MDNMDVWHDR->VIEW_ID, MDNMDVWHDR_N->VIEW_ID, sizeof(MDNMDVWHDR->VIEW_ID));
    MEMCPY_DN(MDNMDVWHDR->COL_NAME, MDNMDVWHDR_N->COL_NAME, sizeof(MDNMDVWHDR->COL_NAME));
    MEMCPY_DN(MDNMDVWHDR->DISPLAY_NAME, MDNMDVWHDR_N->DISPLAY_NAME, sizeof(MDNMDVWHDR->DISPLAY_NAME));
    MEMCPY_DN(MDNMDVWHDR->COL_DESC, MDNMDVWHDR_N->COL_DESC, sizeof(MDNMDVWHDR->COL_DESC));
    MEMCPY_DN(MDNMDVWHDR->CREATE_TIME, MDNMDVWHDR_N->CREATE_TIME, sizeof(MDNMDVWHDR->CREATE_TIME));
    MEMCPY_DN(MDNMDVWHDR->CREATE_USER_ID, MDNMDVWHDR_N->CREATE_USER_ID, sizeof(MDNMDVWHDR->CREATE_USER_ID));
    MEMCPY_DN(MDNMDVWHDR->UPDATE_TIME, MDNMDVWHDR_N->UPDATE_TIME, sizeof(MDNMDVWHDR->UPDATE_TIME));
    MEMCPY_DN(MDNMDVWHDR->UPDATE_USER_ID, MDNMDVWHDR_N->UPDATE_USER_ID, sizeof(MDNMDVWHDR->UPDATE_USER_ID));
}
