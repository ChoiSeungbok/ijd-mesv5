...
"select LOT_ID ,HIST_SEQ ,CRR_ID ,FACTORY ,QTY_1 ,QTY_2 ,QTY_3 ,CRR_SEQ ,HIS\
T_DEL_FLAG ,CREATE_USER_ID ,CREATE_TIME  from MWIPCRRLTH where FACTORY=:b0 or\
der by LOT_ID asc ,HIST_SEQ asc ,CRR_ID asc             ";

 static const char *sq0010 = 
"select LOT_ID ,HIST_SEQ ,CRR_ID ,FACTORY ,QTY_1 ,QTY_2 ,QTY_3 ,CRR_SEQ ,HIS\
T_DEL_FLAG ,CREATE_USER_ID ,CREATE_TIME  from MWIPCRRLTH where (LOT_ID=:b0 an\
d HIST_SEQ=:b1) order by CRR_SEQ asc             ";
...
{13,4130,873,0,0,
5,0,0,1,234,0,4,45,0,0,14,3,0,1,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,4,0,0,2,
4,0,0,2,4,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
76,0,0,2,246,0,4,107,0,0,14,3,0,1,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,4,0,0,
2,4,0,0,2,4,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
147,0,0,3,78,0,4,172,0,0,3,2,0,1,0,2,4,0,0,1,97,0,0,1,3,0,0,
174,0,0,4,77,0,2,207,0,0,3,3,0,1,0,1,97,0,0,1,3,0,0,1,97,0,0,
201,0,0,5,41,0,2,214,0,0,1,1,0,1,0,1,97,0,0,
220,0,0,6,176,0,3,241,0,0,11,11,0,1,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,4,0,
0,1,4,0,0,1,4,0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
279,0,0,7,183,0,5,286,0,0,11,11,0,1,0,1,97,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,3,0,0,
1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
338,0,0,8,76,0,5,301,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,
365,0,0,9,208,0,9,352,0,0,1,1,0,1,0,1,97,0,0,
384,0,0,10,201,0,9,373,0,0,2,2,0,1,0,1,97,0,0,1,3,0,0,
407,0,0,9,0,0,13,401,0,0,11,0,0,1,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,4,0,0,
2,4,0,0,2,4,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
466,0,0,10,0,0,13,416,0,0,11,0,0,1,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,4,0,
0,2,4,0,0,2,4,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
525,0,0,9,0,0,15,457,0,0,0,0,0,1,0,
540,0,0,10,0,0,15,461,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_mwipcrrlth.pc
**    DB Type     : Unix Oracle
...
void DBC_add_null_mwipcrrlth(struct MWIPCRRLTH_N_TAG *MWIPCRRLTH_N, struct MWIPCRRLTH_TAG *MWIPCRRLTH);
void DBC_del_null_mwipcrrlth(struct MWIPCRRLTH_N_TAG *MWIPCRRLTH_N, struct MWIPCRRLTH_TAG *MWIPCRRLTH);


/* SQL SELECT Function */
void DBC_select_mwipcrrlth(int sel_type, struct MWIPCRRLTH_TAG *MWIPCRRLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MWIPCRRLTH_N_TAG MWIPCRRLTH_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_mwipcrrlth(&MWIPCRRLTH_N, MWIPCRRLTH);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                ...
                INTO 
                    :MWIPCRRLTH_N.LOT_ID,
                    :MWIPCRRLTH_N.HIST_SEQ,
                    :MWIPCRRLTH_N.CRR_ID,
                    :MWIPCRRLTH_N.FACTORY,
                    :MWIPCRRLTH_N.QTY_1,
                    :MWIPCRRLTH_N.QTY_2,
                    :MWIPCRRLTH_N.QTY_3,
                    :MWIPCRRLTH_N.CRR_SEQ,
                    :MWIPCRRLTH_N.HIST_DEL_FLAG,
                    :MWIPCRRLTH_N.CREATE_USER_ID,
                    :MWIPCRRLTH_N.CREATE_TIME
                FROM MWIPCRRLTH
                WHERE LOT_ID = :MWIPCRRLTH_N.LOT_ID
                    AND HIST_SEQ = :MWIPCRRLTH_N.HIST_SEQ
                    AND CRR_ID = :MWIPCRRLTH_N.CRR_ID; */ 

{
            ...
            sqlstm.stmt = "select LOT_ID ,HIST_SEQ ,CRR_ID ,FACTORY ,QTY_1 \
,QTY_2 ,QTY_3 ,CRR_SEQ ,HIST_DEL_FLAG ,CREATE_USER_ID ,CREATE_TIME into :b0,:\
b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10  from MWIPCRRLTH where ((LOT_ID=:b0 a\
nd HIST_SEQ=:b1) and CRR_ID=:b2)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MWIPCRRLTH_N.LOT_ID);
            ...
            sqlstm.sqhstv[1] = (         void  *)&(MWIPCRRLTH_N.HIST_SEQ);
            ...
            sqlstm.sqhstv[2] = (         void  *)(MWIPCRRLTH_N.CRR_ID);
            ...
            sqlstm.sqhstv[3] = (         void  *)(MWIPCRRLTH_N.FACTORY);
            ...
            sqlstm.sqhstv[4] = (         void  *)&(MWIPCRRLTH_N.QTY_1);
            ...
            sqlstm.sqhstv[5] = (         void  *)&(MWIPCRRLTH_N.QTY_2);
            ...
            sqlstm.sqhstv[6] = (         void  *)&(MWIPCRRLTH_N.QTY_3);
            ...
            sqlstm.sqhstv[7] = (         void  *)&(MWIPCRRLTH_N.CRR_SEQ);
            ...
            sqlstm.sqhstv[8] = (         void  *)(MWIPCRRLTH_N.HIST_DEL_FLAG);
            ...
            sqlstm.sqhstv[9] = (         void  *)(MWIPCRRLTH_N.CREATE_USER_ID);
            ...
            sqlstm.sqhstv[10] = (         void  *)(MWIPCRRLTH_N.CREATE_TIME);
            ...
            sqlstm.sqhstv[11] = (         void  *)(MWIPCRRLTH_N.LOT_ID);
            ...
            sqlstm.sqhstv[12] = (         void  *)&(MWIPCRRLTH_N.HIST_SEQ);
            ...
            sqlstm.sqhstv[13] = (         void  *)(MWIPCRRLTH_N.CRR_ID);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_mwipcrrlth(&MWIPCRRLTH_N, MWIPCRRLTH);
    }
    DB_stop_query_timer("DBC_select_mwipcrrlth", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_mwipcrrlth_for_update(int sel_type, struct MWIPCRRLTH_TAG *MWIPCRRLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
,QTY_2 ,QTY_3 ,CRR_SEQ ,HIST_DEL_FLAG ,CREATE_USER_ID ,CREATE_TIME into :b0,:\
b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10  from MWIPCRRLTH where ((LOT_ID=:b0 a\
nd HIST_SEQ=:b1) and CRR_ID=:b2) for update ";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_select_mwipcrrlth_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_mwipcrrlth_scalar(int sel_type, struct MWIPCRRLTH_TAG *MWIPCRRLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MWIPCRRLTH where\
 (LOT_ID=:b1 and HIST_SEQ=:b2)";
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MWIPCRRLTH_N.LOT_ID);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)&(MWIPCRRLTH_N.HIST_SEQ);
    ...
    DB_stop_query_timer("DBC_select_mwipcrrlth_scalar", sel_type);
    return d_value;
}


/* SQL DELETE Function */
void DBC_delete_mwipcrrlth(int sel_type, struct MWIPCRRLTH_TAG *MWIPCRRLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MWIPCRRLTH
                WHERE LOT_ID = :MWIPCRRLTH_N.LOT_ID
                    AND HIST_SEQ = :MWIPCRRLTH_N.HIST_SEQ
                    AND CRR_ID = :MWIPCRRLTH_N.CRR_ID; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MWIPCRRLTH  where ((LOT_ID=:b0 and \
HIST_SEQ=:b1) and CRR_ID=:b2)";
            sqlstm.iters = (unsigned int  )1;
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MWIPCRRLTH  where LOT_ID=:b0";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_delete_mwipcrrlth", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_mwipcrrlth(struct MWIPCRRLTH_TAG *MWIPCRRLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MWIPCRRLTH (
                    LOT_ID,
                    HIST_SEQ,
                    CRR_ID,
                    FACTORY,
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MWIPCRRLTH (LOT_ID,HIST_SEQ,CRR_ID,FACTORY,Q\
TY_1,QTY_2,QTY_3,CRR_SEQ,HIST_DEL_FLAG,CREATE_USER_ID,CREATE_TIME) values (:b\
0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10)";
    ...
    DB_stop_query_timer("DBC_insert_mwipcrrlth", 0);
}


/* SQL UPDATE Function */
void DBC_update_mwipcrrlth(int sel_type, struct MWIPCRRLTH_TAG *MWIPCRRLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MWIPCRRLTH SET
                    FACTORY = :MWIPCRRLTH_N.FACTORY,
                    QTY_1 = :MWIPCRRLTH_N.QTY_1,
                    QTY_2 = :MWIPCRRLTH_N.QTY_2,
                    QTY_3 = :MWIPCRRLTH_N.QTY_3,
                    CRR_SEQ = :MWIPCRRLTH_N.CRR_SEQ,
                    HIST_DEL_FLAG = :MWIPCRRLTH_N.HIST_DEL_FLAG,
                    CREATE_USER_ID = :MWIPCRRLTH_N.CREATE_USER_ID,
                    CREATE_TIME = :MWIPCRRLTH_N.CREATE_TIME
                WHERE LOT_ID = :MWIPCRRLTH_N.LOT_ID
                    AND HIST_SEQ = :MWIPCRRLTH_N.HIST_SEQ
                    AND CRR_ID = :MWIPCRRLTH_N.CRR_ID; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MWIPCRRLTH  set FACTORY=:b0,QTY_1=:b1,QTY\
_2=:b2,QTY_3=:b3,CRR_SEQ=:b4,HIST_DEL_FLAG=:b5,CREATE_USER_ID=:b6,CREATE_TIME\
=:b7 where ((LOT_ID=:b8 and HIST_SEQ=:b9) and CRR_ID=:b10)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MWIPCRRLTH_N.FACTORY);
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)&(MWIPCRRLTH_N.QTY_1);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)&(MWIPCRRLTH_N.QTY_2);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)&(MWIPCRRLTH_N.QTY_3);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)&(MWIPCRRLTH_N.CRR_SEQ);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MWIPCRRLTH_N.HIST_DEL_FLAG);
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)(MWIPCRRLTH_N.CREATE_USER_ID);
            ...
            sqlstm.sqadto[6] = (unsigned short )0;
            sqlstm.sqtdso[6] = (unsigned short )0;
            sqlstm.sqhstv[7] = (         void  *)(MWIPCRRLTH_N.CREATE_TIME);
            ...
            sqlstm.sqadto[7] = (unsigned short )0;
            sqlstm.sqtdso[7] = (unsigned short )0;
            sqlstm.sqhstv[8] = (         void  *)(MWIPCRRLTH_N.LOT_ID);
            ...
            sqlstm.sqadto[8] = (unsigned short )0;
            sqlstm.sqtdso[8] = (unsigned short )0;
            sqlstm.sqhstv[9] = (         void  *)&(MWIPCRRLTH_N.HIST_SEQ);
            ...
            sqlstm.sqadto[9] = (unsigned short )0;
            sqlstm.sqtdso[9] = (unsigned short )0;
            sqlstm.sqhstv[10] = (         void  *)(MWIPCRRLTH_N.CRR_ID);
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MWIPCRRLTH  set HIST_DEL_FLAG=:b0 where (\
LOT_ID=:b1 and HIST_SEQ=:b2)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MWIPCRRLTH_N.HIST_DEL_FLAG);
    ...
    DB_stop_query_timer("DBC_update_mwipcrrlth", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_mwipcrrlth(int sel_type, struct MWIPCRRLTH_TAG *MWIPCRRLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MWIPCRRLTH_CUR_1 CURSOR FOR
                SELECT 
                    LOT_ID,
                    HIST_SEQ,
                    CRR_ID,
                    ...
                    CREATE_TIME
                FROM MWIPCRRLTH
                WHERE FACTORY = :MWIPCRRLTH_N.FACTORY 
                ORDER BY LOT_ID ASC,
                    HIST_SEQ ASC,
                    CRR_ID ASC; */ 

            /* EXEC SQL OPEN DBC_MWIPCRRLTH_CUR_1; */ 

{
        ...
        case 2:
            /* EXEC SQL DECLARE DBC_MWIPCRRLTH_CUR_2 CURSOR FOR
                SELECT 
                    LOT_ID,
                    HIST_SEQ,
                    CRR_ID,
            ...
            /* EXEC SQL OPEN DBC_MWIPCRRLTH_CUR_2; */ 

{
    ...
    DB_stop_query_timer("DBC_open_mwipcrrlth", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_mwipcrrlth(int sel_type, struct MWIPCRRLTH_TAG *MWIPCRRLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MWIPCRRLTH_CUR_1 INTO 
                                                    :MWIPCRRLTH_N.LOT_ID,
                                                    :MWIPCRRLTH_N.HIST_SEQ,
                                                    :MWIPCRRLTH_N.CRR_ID,
                                                    :MWIPCRRLTH_N.FACTORY,
...

{
        ...
        case 2:
            /* EXEC SQL FETCH DBC_MWIPCRRLTH_CUR_2 INTO 
                                                    :MWIPCRRLTH_N.LOT_ID,
                                                    :MWIPCRRLTH_N.HIST_SEQ,
                                                    :MWIPCRRLTH_N.CRR_ID,
                                                    :MWIPCRRLTH_N.FACTORY,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_mwipcrrlth", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_mwipcrrlth(int sel_type)
{
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MWIPCRRLTH_CUR_1; */ 

{
        ...
        case 2:
            /* EXEC SQL CLOSE DBC_MWIPCRRLTH_CUR_2; */ 

{
    ...
    DB_stop_query_timer("DBC_close_mwipcrrlth", sel_type);
}


/* Initialize Function */
void DBC_init_mwipcrrlth(struct MWIPCRRLTH_TAG *MWIPCRRLTH)
{
    /* memset by Space */
    memset(MWIPCRRLTH, ' ', sizeof(struct MWIPCRRLTH_TAG));
    
    MWIPCRRLTH->QTY_1 = 0;
    MWIPCRRLTH->QTY_2 = 0;
    MWIPCRRLTH->QTY_3 = 0;
    MWIPCRRLTH->CRR_SEQ = 0;
    MWIPCRRLTH->HIST_SEQ = 0;
}
...
{
    /* memset by NULL */
    memset(MWIPCRRLTH_N, '\0', sizeof(struct MWIPCRRLTH_N_TAG));
    
    MEMCPY_AN(MWIPCRRLTH_N->LOT_ID, MWIPCRRLTH->LOT_ID, sizeof(MWIPCRRLTH->LOT_ID));
    MWIPCRRLTH_N->HIST_SEQ = MWIPCRRLTH->HIST_SEQ;
    MEMCPY_AN(MWIPCRRLTH_N->CRR_ID, MWIPCRRLTH->CRR_ID, sizeof(MWIPCRRLTH->CRR_ID));
    MEMCPY_AN(MWIPCRRLTH_N->FACTORY, MWIPCRRLTH->FACTORY, sizeof(MWIPCRRLTH->FACTORY));
    MWIPCRRLTH_N->QTY_1 = MWIPCRRLTH->QTY_1;
    MWIPCRRLTH_N->QTY_2 = MWIPCRRLTH->QTY_2;
    MWIPCRRLTH_N->QTY_3 = MWIPCRRLTH->QTY_3;
    MWIPCRRLTH_N->CRR_SEQ = MWIPCRRLTH->CRR_SEQ;
    MWIPCRRLTH_N->HIST_DEL_FLAG[0] = MWIPCRRLTH->HIST_DEL_FLAG;
    MEMCPY_AN(MWIPCRRLTH_N->CREATE_USER_ID, MWIPCRRLTH->CREATE_USER_ID, sizeof(MWIPCRRLTH->CREATE_USER_ID));
    MEMCPY_AN(MWIPCRRLTH_N->CREATE_TIME, MWIPCRRLTH->CREATE_TIME, sizeof(MWIPCRRLTH->CREATE_TIME));
}
...
void DBC_del_null_mwipcrrlth(struct MWIPCRRLTH_N_TAG *MWIPCRRLTH_N, struct MWIPCRRLTH_TAG *MWIPCRRLTH)
{
    MEMCPY_DN(MWIPCRRLTH->LOT_ID, MWIPCRRLTH_N->LOT_ID, sizeof(MWIPCRRLTH->LOT_ID));
    MWIPCRRLTH->HIST_SEQ = MWIPCRRLTH_N->HIST_SEQ;
    MEMCPY_DN(MWIPCRRLTH->CRR_ID, MWIPCRRLTH_N->CRR_ID, sizeof(MWIPCRRLTH->CRR_ID));
    MEMCPY_DN(MWIPCRRLTH->FACTORY, MWIPCRRLTH_N->FACTORY, sizeof(MWIPCRRLTH->FACTORY));
    MWIPCRRLTH->QTY_1 = MWIPCRRLTH_N->QTY_1;
    MWIPCRRLTH->QTY_2 = MWIPCRRLTH_N->QTY_2;
    MWIPCRRLTH->QTY_3 = MWIPCRRLTH_N->QTY_3;
    MWIPCRRLTH->CRR_SEQ = MWIPCRRLTH_N->CRR_SEQ;
    MWIPCRRLTH->HIST_DEL_FLAG = MWIPCRRLTH_N->HIST_DEL_FLAG[0];
    MEMCPY_DN(MWIPCRRLTH->CREATE_USER_ID, MWIPCRRLTH_N->CREATE_USER_ID, sizeof(MWIPCRRLTH->CREATE_USER_ID));
    MEMCPY_DN(MWIPCRRLTH->CREATE_TIME, MWIPCRRLTH_N->CREATE_TIME, sizeof(MWIPCRRLTH->CREATE_TIME));
}
