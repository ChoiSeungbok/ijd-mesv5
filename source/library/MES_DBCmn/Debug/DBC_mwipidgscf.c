...
static unsigned int sqlctx = 9141019;
...
"select GEN_ID ,CONFIRM_KEY ,RULE_ID ,RULE_SEQ ,SEQ_CONFIRM_KEY  from MWIPID\
GSCF where ((RULE_ID=:b0 and RULE_SEQ=:b1) and SEQ_CONFIRM_KEY=:b2) order by \
GEN_ID asc             ";

 static const char *sq0011 = 
"select GEN_ID ,CONFIRM_KEY ,RULE_ID ,RULE_SEQ ,SEQ_CONFIRM_KEY  from MWIPID\
GSCF where ((GEN_ID=:b0 and CONFIRM_KEY=:b1) and RULE_ID=:b2) order by RULE_S\
EQ asc ,SEQ_CONFIRM_KEY asc             ";
...
{13,4130,846,0,0,
5,0,0,1,180,0,4,46,0,0,9,4,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,1,
97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
56,0,0,2,192,0,4,99,0,0,9,4,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,
1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
107,0,0,3,118,0,4,155,0,0,5,4,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
142,0,0,4,105,0,4,165,0,0,4,3,0,1,0,2,4,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
173,0,0,5,122,0,4,174,0,0,5,4,0,1,0,2,4,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,
208,0,0,6,100,0,2,213,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
239,0,0,7,42,0,2,221,0,0,1,1,0,1,0,1,97,0,0,
258,0,0,8,105,0,3,249,0,0,5,5,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,
0,
293,0,0,9,118,0,5,284,0,0,5,5,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,
0,
328,0,0,10,175,0,9,332,0,0,3,3,0,1,0,1,97,0,0,1,3,0,0,1,97,0,0,
355,0,0,11,192,0,9,348,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,
382,0,0,10,0,0,13,376,0,0,5,0,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,
0,
417,0,0,11,0,0,13,385,0,0,5,0,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,
0,
452,0,0,10,0,0,15,420,0,0,0,0,0,1,0,
467,0,0,11,0,0,15,424,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_mwipidgscf.pc
**    DB Type     : Unix Oracle
...
void DBC_add_null_mwipidgscf(struct MWIPIDGSCF_N_TAG *MWIPIDGSCF_N, struct MWIPIDGSCF_TAG *MWIPIDGSCF);
void DBC_del_null_mwipidgscf(struct MWIPIDGSCF_N_TAG *MWIPIDGSCF_N, struct MWIPIDGSCF_TAG *MWIPIDGSCF);


/* SQL SELECT Function */
void DBC_select_mwipidgscf(int sel_type, struct MWIPIDGSCF_TAG *MWIPIDGSCF)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MWIPIDGSCF_N_TAG MWIPIDGSCF_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_mwipidgscf(&MWIPIDGSCF_N, MWIPIDGSCF);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                ...
                INTO 
                    :MWIPIDGSCF_N.GEN_ID,
                    :MWIPIDGSCF_N.CONFIRM_KEY,
                    :MWIPIDGSCF_N.RULE_ID,
                    :MWIPIDGSCF_N.RULE_SEQ,
                    :MWIPIDGSCF_N.SEQ_CONFIRM_KEY
                FROM MWIPIDGSCF
                WHERE GEN_ID = :MWIPIDGSCF_N.GEN_ID
                    AND CONFIRM_KEY = :MWIPIDGSCF_N.CONFIRM_KEY
                    AND RULE_ID = :MWIPIDGSCF_N.RULE_ID
                    AND RULE_SEQ = :MWIPIDGSCF_N.RULE_SEQ; */ 

{
            ...
            sqlstm.stmt = "select GEN_ID ,CONFIRM_KEY ,RULE_ID ,RULE_SEQ ,S\
EQ_CONFIRM_KEY into :b0,:b1,:b2,:b3,:b4  from MWIPIDGSCF where (((GEN_ID=:b0 \
and CONFIRM_KEY=:b1) and RULE_ID=:b2) and RULE_SEQ=:b3)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MWIPIDGSCF_N.GEN_ID);
            ...
            sqlstm.sqhstv[1] = (         void  *)(MWIPIDGSCF_N.CONFIRM_KEY);
            ...
            sqlstm.sqhstv[2] = (         void  *)(MWIPIDGSCF_N.RULE_ID);
            ...
            sqlstm.sqhstv[3] = (         void  *)&(MWIPIDGSCF_N.RULE_SEQ);
            ...
            sqlstm.sqhstv[4] = (         void  *)(MWIPIDGSCF_N.SEQ_CONFIRM_KEY);
            ...
            sqlstm.sqhstv[5] = (         void  *)(MWIPIDGSCF_N.GEN_ID);
            ...
            sqlstm.sqhstv[6] = (         void  *)(MWIPIDGSCF_N.CONFIRM_KEY);
            ...
            sqlstm.sqhstv[7] = (         void  *)(MWIPIDGSCF_N.RULE_ID);
            ...
            sqlstm.sqhstv[8] = (         void  *)&(MWIPIDGSCF_N.RULE_SEQ);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_mwipidgscf(&MWIPIDGSCF_N, MWIPIDGSCF);
    }

    DB_stop_query_timer("DBC_select_mwipidgscf", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_mwipidgscf_for_update(int sel_type, struct MWIPIDGSCF_TAG *MWIPIDGSCF)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.stmt = "select GEN_ID ,CONFIRM_KEY ,RULE_ID ,RULE_SEQ ,S\
EQ_CONFIRM_KEY into :b0,:b1,:b2,:b3,:b4  from MWIPIDGSCF where (((GEN_ID=:b0 \
and CONFIRM_KEY=:b1) and RULE_ID=:b2) and RULE_SEQ=:b3) for update ";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_select_mwipidgscf_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_mwipidgscf_scalar(int sel_type, struct MWIPIDGSCF_TAG *MWIPIDGSCF)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MWIPIDGSCF where\
 (((GEN_ID=:b1 and CONFIRM_KEY=:b2) and RULE_ID=:b3) and RULE_SEQ=:b4)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MWIPIDGSCF_N.GEN_ID);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MWIPIDGSCF_N.CONFIRM_KEY);
            sqlstm.sqhstl[2] = (unsigned int  )31;
            sqlstm.sqhsts[2] = (         int  )0;
            sqlstm.sqindv[2] = (         void  *)0;
            sqlstm.sqinds[2] = (         int  )0;
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MWIPIDGSCF_N.RULE_ID);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)&(MWIPIDGSCF_N.RULE_SEQ);
        ...
        case 2:
            /* EXEC SQL SELECT count(*) 
                INTO :d_value
                FROM MWIPIDGSCF
                WHERE RULE_ID = :MWIPIDGSCF_N.RULE_ID
                    AND RULE_SEQ = :MWIPIDGSCF_N.RULE_SEQ
                    AND SEQ_CONFIRM_KEY = :MWIPIDGSCF_N.SEQ_CONFIRM_KEY; */ 

{
            ...
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MWIPIDGSCF where\
 ((RULE_ID=:b1 and RULE_SEQ=:b2) and SEQ_CONFIRM_KEY=:b3)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MWIPIDGSCF_N.RULE_ID);
            sqlstm.sqhstl[1] = (unsigned int  )31;
            sqlstm.sqhsts[1] = (         int  )0;
            sqlstm.sqindv[1] = (         void  *)0;
            sqlstm.sqinds[1] = (         int  )0;
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)&(MWIPIDGSCF_N.RULE_SEQ);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MWIPIDGSCF_N.SEQ_CONFIRM_KEY);
            sqlstm.sqhstl[3] = (unsigned int  )31;
            sqlstm.sqhsts[3] = (         int  )0;
            sqlstm.sqindv[3] = (         void  *)0;
            sqlstm.sqinds[3] = (         int  )0;
        ...
        case 3:
            /* EXEC SQL SELECT count(*) 
                ...
                WHERE RULE_ID = :MWIPIDGSCF_N.RULE_ID
                    AND RULE_SEQ = :MWIPIDGSCF_N.RULE_SEQ
                    AND GEN_ID = :MWIPIDGSCF_N.GEN_ID
                    AND SEQ_CONFIRM_KEY = :MWIPIDGSCF_N.SEQ_CONFIRM_KEY; */ 

{
            ...
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MWIPIDGSCF where\
 (((RULE_ID=:b1 and RULE_SEQ=:b2) and GEN_ID=:b3) and SEQ_CONFIRM_KEY=:b4)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MWIPIDGSCF_N.GEN_ID);
    ...
    DB_stop_query_timer("DBC_select_mwipidgscf_scalar", sel_type);
...
/* SQL DELETE Function */
void DBC_delete_mwipidgscf(int sel_type, struct MWIPIDGSCF_TAG *MWIPIDGSCF)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MWIPIDGSCF
                WHERE GEN_ID = :MWIPIDGSCF_N.GEN_ID
                    AND CONFIRM_KEY = :MWIPIDGSCF_N.CONFIRM_KEY
                    AND RULE_ID = :MWIPIDGSCF_N.RULE_ID
                    AND RULE_SEQ = :MWIPIDGSCF_N.RULE_SEQ; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MWIPIDGSCF  where (((GEN_ID=:b0 and\
 CONFIRM_KEY=:b1) and RULE_ID=:b2) and RULE_SEQ=:b3)";
            sqlstm.iters = (unsigned int  )1;
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MWIPIDGSCF  where RULE_ID=:b0";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MWIPIDGSCF_N.RULE_ID);
    ...
    DB_stop_query_timer("DBC_delete_mwipidgscf", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_mwipidgscf(struct MWIPIDGSCF_TAG *MWIPIDGSCF)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MWIPIDGSCF( 
                    GEN_ID, 
                    CONFIRM_KEY, 
                    RULE_ID, 
                    RULE_SEQ, 
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MWIPIDGSCF (GEN_ID,CONFIRM_KEY,RULE_ID,RULE_\
SEQ,SEQ_CONFIRM_KEY) values (:b0,:b1,:b2,:b3,:b4)";
    sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_insert_mwipidgscf", 0);
}


/* SQL UPDATE Function */
void DBC_update_mwipidgscf(int sel_type, struct MWIPIDGSCF_TAG *MWIPIDGSCF)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MWIPIDGSCF SET
                    SEQ_CONFIRM_KEY = :MWIPIDGSCF_N.SEQ_CONFIRM_KEY
                WHERE GEN_ID = :MWIPIDGSCF_N.GEN_ID
                    AND CONFIRM_KEY = :MWIPIDGSCF_N.CONFIRM_KEY
                    AND RULE_ID = :MWIPIDGSCF_N.RULE_ID
                    AND RULE_SEQ = :MWIPIDGSCF_N.RULE_SEQ; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MWIPIDGSCF  set SEQ_CONFIRM_KEY=:b0 where\
 (((GEN_ID=:b1 and CONFIRM_KEY=:b2) and RULE_ID=:b3) and RULE_SEQ=:b4)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MWIPIDGSCF_N.SEQ_CONFIRM_KEY);
            sqlstm.sqhstl[0] = (unsigned int  )31;
            sqlstm.sqhsts[0] = (         int  )0;
            sqlstm.sqindv[0] = (         void  *)0;
            sqlstm.sqinds[0] = (         int  )0;
    ...
    DB_stop_query_timer("DBC_update_mwipidgscf", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_mwipidgscf(int sel_type, struct MWIPIDGSCF_TAG *MWIPIDGSCF)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MWIPIDGSCF_CUR_1 CURSOR FOR
                SELECT 
                    GEN_ID,
                    CONFIRM_KEY,
                    RULE_ID,
            ...
            /* EXEC SQL OPEN DBC_MWIPIDGSCF_CUR_1; */ 

{
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)&(MWIPIDGSCF_N.RULE_SEQ);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MWIPIDGSCF_N.SEQ_CONFIRM_KEY);
            sqlstm.sqhstl[2] = (unsigned int  )31;
            sqlstm.sqhsts[2] = (         int  )0;
            sqlstm.sqindv[2] = (         void  *)0;
            sqlstm.sqinds[2] = (         int  )0;
        ...
        case 2:
            /* EXEC SQL DECLARE DBC_MWIPIDGSCF_CUR_2 CURSOR FOR
                SELECT 
                    GEN_ID,
                    CONFIRM_KEY,
                    RULE_ID,
                ...
                WHERE GEN_ID = :MWIPIDGSCF_N.GEN_ID
                    AND CONFIRM_KEY = :MWIPIDGSCF_N.CONFIRM_KEY
                    AND RULE_ID = :MWIPIDGSCF_N.RULE_ID
                ORDER BY RULE_SEQ ASC, SEQ_CONFIRM_KEY ASC; */ 

            /* EXEC SQL OPEN DBC_MWIPIDGSCF_CUR_2; */ 

{
    ...
    DB_stop_query_timer("DBC_open_mwipidgscf", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_mwipidgscf(int sel_type, struct MWIPIDGSCF_TAG *MWIPIDGSCF)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MWIPIDGSCF_CUR_1 INTO
                :MWIPIDGSCF_N.GEN_ID,
                :MWIPIDGSCF_N.CONFIRM_KEY,
                :MWIPIDGSCF_N.RULE_ID,
                :MWIPIDGSCF_N.RULE_SEQ,
...

{
        ...
        case 2:
            /* EXEC SQL FETCH DBC_MWIPIDGSCF_CUR_2 INTO
                :MWIPIDGSCF_N.GEN_ID,
                :MWIPIDGSCF_N.CONFIRM_KEY,
                :MWIPIDGSCF_N.RULE_ID,
                :MWIPIDGSCF_N.RULE_SEQ,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_mwipidgscf", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_mwipidgscf(int sel_type)
{
    DB_start_query_timer();
    DB_error_code = 0;
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MWIPIDGSCF_CUR_1; */ 

{
        ...
        case 2:
            /* EXEC SQL CLOSE DBC_MWIPIDGSCF_CUR_2; */ 

{
    ...
    DB_stop_query_timer("DBC_close_mwipidgscf", sel_type);
}


/* Initialize Function */
void DBC_init_mwipidgscf(struct MWIPIDGSCF_TAG *MWIPIDGSCF)
{
    /* memset by Space */
    memset(MWIPIDGSCF, ' ', sizeof(struct MWIPIDGSCF_TAG));
    
    MWIPIDGSCF->RULE_SEQ = 0;
}
...
{
    /* memset by NULL */
    memset(MWIPIDGSCF_N, '\0', sizeof(struct MWIPIDGSCF_N_TAG));
    
    MEMCPY_AN(MWIPIDGSCF_N->GEN_ID, MWIPIDGSCF->GEN_ID, sizeof(MWIPIDGSCF->GEN_ID));
    MEMCPY_AN(MWIPIDGSCF_N->CONFIRM_KEY, MWIPIDGSCF->CONFIRM_KEY, sizeof(MWIPIDGSCF->CONFIRM_KEY));
    MEMCPY_AN(MWIPIDGSCF_N->RULE_ID, MWIPIDGSCF->RULE_ID, sizeof(MWIPIDGSCF->RULE_ID));
    MWIPIDGSCF_N->RULE_SEQ = MWIPIDGSCF->RULE_SEQ;
    MEMCPY_AN(MWIPIDGSCF_N->SEQ_CONFIRM_KEY, MWIPIDGSCF->SEQ_CONFIRM_KEY, sizeof(MWIPIDGSCF->SEQ_CONFIRM_KEY));
}
...
void DBC_del_null_mwipidgscf(struct MWIPIDGSCF_N_TAG *MWIPIDGSCF_N, struct MWIPIDGSCF_TAG *MWIPIDGSCF)
{
    MEMCPY_DN(MWIPIDGSCF->GEN_ID, MWIPIDGSCF_N->GEN_ID, sizeof(MWIPIDGSCF->GEN_ID));
    MEMCPY_DN(MWIPIDGSCF->CONFIRM_KEY, MWIPIDGSCF_N->CONFIRM_KEY, sizeof(MWIPIDGSCF->CONFIRM_KEY));
    MEMCPY_DN(MWIPIDGSCF->RULE_ID, MWIPIDGSCF_N->RULE_ID, sizeof(MWIPIDGSCF->RULE_ID));
    MWIPIDGSCF->RULE_SEQ = MWIPIDGSCF_N->RULE_SEQ;
    MEMCPY_DN(MWIPIDGSCF->SEQ_CONFIRM_KEY, MWIPIDGSCF_N->SEQ_CONFIRM_KEY, sizeof(MWIPIDGSCF->SEQ_CONFIRM_KEY));
}
