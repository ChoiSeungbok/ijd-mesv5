...
static unsigned int sqlctx = 9128907;
...
"select FACTORY ,RES_ID ,HIST_SEQ ,HIST_DEL_FLAG ,TOOL_ID ,TOOL_HIST_SEQ ,TO\
OL_HIST_DEL_FLAG  from MRASTOLRSH where ((FACTORY=:b0 and RES_ID=:b1) and HIS\
T_SEQ=:b2) order by TOOL_ID asc ,TOOL_HIST_SEQ asc             ";
...
{13,4130,873,0,0,
5,0,0,1,237,0,4,45,0,0,12,5,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,
2,3,0,0,2,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,
68,0,0,2,249,0,4,101,0,0,12,5,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,
0,2,3,0,0,2,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,
131,0,0,3,138,0,4,160,0,0,6,5,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
1,3,0,0,
170,0,0,4,120,0,2,198,0,0,5,5,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,
205,0,0,5,140,0,3,229,0,0,7,7,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,
0,1,3,0,0,1,97,0,0,
248,0,0,6,159,0,5,266,0,0,7,7,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,
0,1,97,0,0,1,3,0,0,
291,0,0,7,215,0,9,317,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,
318,0,0,7,0,0,13,345,0,0,7,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,
2,3,0,0,2,97,0,0,
361,0,0,7,0,0,15,382,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_mrastolrsh.pc
**    DB Type     : Unix Oracle
...
void DBC_add_null_mrastolrsh(struct MRASTOLRSH_N_TAG *MRASTOLRSH_N, struct MRASTOLRSH_TAG *MRASTOLRSH);
void DBC_del_null_mrastolrsh(struct MRASTOLRSH_N_TAG *MRASTOLRSH_N, struct MRASTOLRSH_TAG *MRASTOLRSH);


/* SQL SELECT Function */
void DBC_select_mrastolrsh(int sel_type, struct MRASTOLRSH_TAG *MRASTOLRSH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MRASTOLRSH_N_TAG MRASTOLRSH_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_mrastolrsh(&MRASTOLRSH_N, MRASTOLRSH);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                         ...
                         TOOL_HIST_DEL_FLAG
                INTO 
                    :MRASTOLRSH_N.FACTORY,
                    :MRASTOLRSH_N.RES_ID,
                    :MRASTOLRSH_N.HIST_SEQ,
                    :MRASTOLRSH_N.HIST_DEL_FLAG,
                    :MRASTOLRSH_N.TOOL_ID,
                    :MRASTOLRSH_N.TOOL_HIST_SEQ,
                    :MRASTOLRSH_N.TOOL_HIST_DEL_FLAG
                FROM MRASTOLRSH
                WHERE FACTORY = :MRASTOLRSH_N.FACTORY
                    AND RES_ID = :MRASTOLRSH_N.RES_ID
                    AND HIST_SEQ = :MRASTOLRSH_N.HIST_SEQ
                    AND TOOL_ID = :MRASTOLRSH_N.TOOL_ID
                    AND TOOL_HIST_SEQ = :MRASTOLRSH_N.TOOL_HIST_SEQ; */ 

{
            ...
            sqlstm.stmt = "select FACTORY ,RES_ID ,HIST_SEQ ,HIST_DEL_FLAG \
,TOOL_ID ,TOOL_HIST_SEQ ,TOOL_HIST_DEL_FLAG into :b0,:b1,:b2,:b3,:b4,:b5,:b6 \
 from MRASTOLRSH where ((((FACTORY=:b0 and RES_ID=:b1) and HIST_SEQ=:b2) and \
TOOL_ID=:b4) and TOOL_HIST_SEQ=:b5)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MRASTOLRSH_N.FACTORY);
            ...
            sqlstm.sqhstv[1] = (         void  *)(MRASTOLRSH_N.RES_ID);
            ...
            sqlstm.sqhstv[2] = (         void  *)&(MRASTOLRSH_N.HIST_SEQ);
            ...
            sqlstm.sqhstv[3] = (         void  *)(MRASTOLRSH_N.HIST_DEL_FLAG);
            ...
            sqlstm.sqhstv[4] = (         void  *)(MRASTOLRSH_N.TOOL_ID);
            ...
            sqlstm.sqhstv[5] = (         void  *)&(MRASTOLRSH_N.TOOL_HIST_SEQ);
            ...
            sqlstm.sqhstv[6] = (         void  *)(MRASTOLRSH_N.TOOL_HIST_DEL_FLAG);
            ...
            sqlstm.sqhstv[7] = (         void  *)(MRASTOLRSH_N.FACTORY);
            ...
            sqlstm.sqhstv[8] = (         void  *)(MRASTOLRSH_N.RES_ID);
            ...
            sqlstm.sqhstv[9] = (         void  *)&(MRASTOLRSH_N.HIST_SEQ);
            ...
            sqlstm.sqhstv[10] = (         void  *)(MRASTOLRSH_N.TOOL_ID);
            ...
            sqlstm.sqhstv[11] = (         void  *)&(MRASTOLRSH_N.TOOL_HIST_SEQ);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_mrastolrsh(&MRASTOLRSH_N, MRASTOLRSH);
    }
    DB_stop_query_timer("DBC_select_mrastolrsh", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_mrastolrsh_for_update(int sel_type, struct MRASTOLRSH_TAG *MRASTOLRSH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
TOOL_ID=:b4) and TOOL_HIST_SEQ=:b5) for update ";
    ...
    DB_stop_query_timer("DBC_select_mrastolrsh_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_mrastolrsh_scalar(int sel_type, struct MRASTOLRSH_TAG *MRASTOLRSH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MRASTOLRSH where\
 ((((FACTORY=:b1 and RES_ID=:b2) and HIST_SEQ=:b3) and TOOL_ID=:b4) and TOOL_\
HIST_SEQ=:b5)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MRASTOLRSH_N.FACTORY);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MRASTOLRSH_N.RES_ID);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)&(MRASTOLRSH_N.HIST_SEQ);
    ...
    DB_stop_query_timer("DBC_select_mrastolrsh_scalar", sel_type);
    return d_value;
}


/* SQL DELETE Function */
void DBC_delete_mrastolrsh(int sel_type, struct MRASTOLRSH_TAG *MRASTOLRSH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MRASTOLRSH
                WHERE FACTORY = :MRASTOLRSH_N.FACTORY
                    AND RES_ID = :MRASTOLRSH_N.RES_ID
                    AND HIST_SEQ = :MRASTOLRSH_N.HIST_SEQ
                    AND TOOL_ID = :MRASTOLRSH_N.TOOL_ID
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MRASTOLRSH  where ((((FACTORY=:b0 a\
nd RES_ID=:b1) and HIST_SEQ=:b2) and TOOL_ID=:b3) and TOOL_HIST_SEQ=:b4)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MRASTOLRSH_N.TOOL_ID);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)&(MRASTOLRSH_N.TOOL_HIST_SEQ);
    ...
    DB_stop_query_timer("DBC_delete_mrastolrsh", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_mrastolrsh(struct MRASTOLRSH_TAG *MRASTOLRSH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MRASTOLRSH (
                    FACTORY,
                    RES_ID,
                    HIST_SEQ,
                    HIST_DEL_FLAG,
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MRASTOLRSH (FACTORY,RES_ID,HIST_SEQ,HIST_DEL\
_FLAG,TOOL_ID,TOOL_HIST_SEQ,TOOL_HIST_DEL_FLAG) values (:b0,:b1,:b2,:b3,:b4,:\
b5,:b6)";
    sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_insert_mrastolrsh", 0);
}


/* SQL UPDATE Function */
void DBC_update_mrastolrsh(int sel_type, struct MRASTOLRSH_TAG *MRASTOLRSH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MRASTOLRSH SET
                    HIST_DEL_FLAG = :MRASTOLRSH_N.HIST_DEL_FLAG,
                    TOOL_HIST_DEL_FLAG = :MRASTOLRSH_N.TOOL_HIST_DEL_FLAG
                WHERE FACTORY = :MRASTOLRSH_N.FACTORY
                    AND RES_ID = :MRASTOLRSH_N.RES_ID
                    AND HIST_SEQ = :MRASTOLRSH_N.HIST_SEQ
                    AND TOOL_ID = :MRASTOLRSH_N.TOOL_ID
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MRASTOLRSH  set HIST_DEL_FLAG=:b0,TOOL_HI\
ST_DEL_FLAG=:b1 where ((((FACTORY=:b2 and RES_ID=:b3) and HIST_SEQ=:b4) and T\
OOL_ID=:b5) and TOOL_HIST_SEQ=:b6)";
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MRASTOLRSH_N.HIST_DEL_FLAG);
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MRASTOLRSH_N.TOOL_HIST_DEL_FLAG);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MRASTOLRSH_N.FACTORY);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MRASTOLRSH_N.RES_ID);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)&(MRASTOLRSH_N.HIST_SEQ);
            sqlstm.sqhstl[4] = (unsigned int  )sizeof(int);
            sqlstm.sqhsts[4] = (         int  )0;
            sqlstm.sqindv[4] = (         void  *)0;
            sqlstm.sqinds[4] = (         int  )0;
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MRASTOLRSH_N.TOOL_ID);
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)&(MRASTOLRSH_N.TOOL_HIST_SEQ);
    ...
    DB_stop_query_timer("DBC_update_mrastolrsh", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_mrastolrsh(int sel_type, struct MRASTOLRSH_TAG *MRASTOLRSH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MRASTOLRSH_CUR_1 CURSOR FOR
                SELECT 
                    FACTORY,
                    RES_ID,
                    HIST_SEQ,
            ...
            /* EXEC SQL OPEN DBC_MRASTOLRSH_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_open_mrastolrsh", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_mrastolrsh(int sel_type, struct MRASTOLRSH_TAG *MRASTOLRSH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MRASTOLRSH_CUR_1 INTO 
                                                    :MRASTOLRSH_N.FACTORY,
                                                    :MRASTOLRSH_N.RES_ID,
                                                    :MRASTOLRSH_N.HIST_SEQ,
                                                    :MRASTOLRSH_N.HIST_DEL_FLAG,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_mrastolrsh", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_mrastolrsh(int sel_type)
{
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MRASTOLRSH_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_close_mrastolrsh", sel_type);
}


/* Initialize Function */
void DBC_init_mrastolrsh(struct MRASTOLRSH_TAG *MRASTOLRSH)
{
    /* memset by Space */
    memset(MRASTOLRSH, ' ', sizeof(struct MRASTOLRSH_TAG));
    
    MRASTOLRSH->HIST_SEQ = 0;
    MRASTOLRSH->TOOL_HIST_SEQ = 0;
}
...
{
    /* memset by NULL */
    memset(MRASTOLRSH_N, '\0', sizeof(struct MRASTOLRSH_N_TAG));
    
    MEMCPY_AN(MRASTOLRSH_N->FACTORY, MRASTOLRSH->FACTORY, sizeof(MRASTOLRSH->FACTORY));
    MEMCPY_AN(MRASTOLRSH_N->RES_ID, MRASTOLRSH->RES_ID, sizeof(MRASTOLRSH->RES_ID));
    MRASTOLRSH_N->HIST_SEQ = MRASTOLRSH->HIST_SEQ;
    MRASTOLRSH_N->HIST_DEL_FLAG[0] = MRASTOLRSH->HIST_DEL_FLAG;
    MEMCPY_AN(MRASTOLRSH_N->TOOL_ID, MRASTOLRSH->TOOL_ID, sizeof(MRASTOLRSH->TOOL_ID));
    MRASTOLRSH_N->TOOL_HIST_SEQ = MRASTOLRSH->TOOL_HIST_SEQ;
    MRASTOLRSH_N->TOOL_HIST_DEL_FLAG[0] = MRASTOLRSH->TOOL_HIST_DEL_FLAG;
}
...
void DBC_del_null_mrastolrsh(struct MRASTOLRSH_N_TAG *MRASTOLRSH_N, struct MRASTOLRSH_TAG *MRASTOLRSH)
{
    MEMCPY_DN(MRASTOLRSH->FACTORY, MRASTOLRSH_N->FACTORY, sizeof(MRASTOLRSH->FACTORY));
    MEMCPY_DN(MRASTOLRSH->RES_ID, MRASTOLRSH_N->RES_ID, sizeof(MRASTOLRSH->RES_ID));
    MRASTOLRSH->HIST_SEQ = MRASTOLRSH_N->HIST_SEQ;
    MRASTOLRSH->HIST_DEL_FLAG = MRASTOLRSH_N->HIST_DEL_FLAG[0];
    MEMCPY_DN(MRASTOLRSH->TOOL_ID, MRASTOLRSH_N->TOOL_ID, sizeof(MRASTOLRSH->TOOL_ID));
    MRASTOLRSH->TOOL_HIST_SEQ = MRASTOLRSH_N->TOOL_HIST_SEQ;
    MRASTOLRSH->TOOL_HIST_DEL_FLAG = MRASTOLRSH_N->TOOL_HIST_DEL_FLAG[0];
}
