...
static unsigned int sqlctx = 9095043;
...
"select JOB_PROC_ID ,PROC_RUN_SUBNO ,HIST_SEQ ,START_TIME ,END_TIME ,ELAPSED\
_TIME ,STATUS_FLAG ,ERROR_MSG ,DB_ERROR_MSG ,PROC_KEY_1 ,PROC_KEY_2 ,PROC_KEY\
_3 ,PROC_KEY_4 ,PROC_KEY_5  from MBATPRCHIS  order by JOB_PROC_ID asc ,PROC_R\
UN_SUBNO asc ,HIST_SEQ asc             ";

 static const char *sq0008 = 
"select ROWSEQ ,JOB_PROC_ID ,PROC_RUN_SUBNO ,HIST_SEQ ,START_TIME ,END_TIME \
,ELAPSED_TIME ,STATUS_FLAG ,ERROR_MSG ,DB_ERROR_MSG ,PROC_KEY_1 ,PROC_KEY_2 ,\
PROC_KEY_3 ,PROC_KEY_4 ,PROC_KEY_5  from (select ROWNUM ROWSEQ ,JPH.*  from (\
select JOB_PROC_ID ,PROC_RUN_SUBNO ,HIST_SEQ ,START_TIME ,END_TIME ,ELAPSED_T\
IME ,STATUS_FLAG ,ERROR_MSG ,DB_ERROR_MSG ,PROC_KEY_1 ,PROC_KEY_2 ,PROC_KEY_3\
 ,PROC_KEY_4 ,PROC_KEY_5  from MBATPRCHIS where (JOB_PROC_ID=:b0 and START_TI\
ME between :b1 and :b2) order by START_TIME desc ,HIST_SEQ desc ,PROC_RUN_SUB\
NO asc  ) JPH ) where ROWSEQ>=:b3           ";
...
{13,4130,846,0,0,
5,0,0,1,326,0,4,45,0,0,17,3,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,
2,4,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,
0,1,97,0,0,1,97,0,0,1,3,0,0,
88,0,0,2,338,0,4,114,0,0,17,3,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,
0,2,4,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,1,97,0,0,1,97,0,0,1,3,0,0,
171,0,0,3,108,0,4,186,0,0,4,3,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
202,0,0,4,90,0,2,223,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,
229,0,0,5,252,0,3,253,0,0,14,14,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,
0,0,1,4,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,
97,0,0,
300,0,0,6,259,0,5,305,0,0,14,14,0,1,0,1,97,0,0,1,97,0,0,1,4,0,0,1,97,0,0,1,97,
0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,
3,0,0,
371,0,0,7,268,0,9,369,0,0,0,0,0,1,0,
386,0,0,8,581,0,9,415,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
417,0,0,7,0,0,13,442,0,0,14,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,
0,2,4,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,
488,0,0,8,0,0,13,460,0,0,15,0,0,1,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,
2,97,0,0,2,4,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,
0,2,97,0,0,
563,0,0,7,0,0,15,507,0,0,0,0,0,1,0,
578,0,0,8,0,0,15,511,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_mbatprchis.pc
**    DB Type     : Unix Oracle
...
void DBC_add_null_mbatprchis(struct MBATPRCHIS_N_TAG *MBATPRCHIS_N, struct MBATPRCHIS_TAG *MBATPRCHIS);
void DBC_del_null_mbatprchis(struct MBATPRCHIS_N_TAG *MBATPRCHIS_N, struct MBATPRCHIS_TAG *MBATPRCHIS);


/* SQL SELECT Function */
void DBC_select_mbatprchis(int sel_type, struct MBATPRCHIS_TAG *MBATPRCHIS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MBATPRCHIS_N_TAG MBATPRCHIS_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_mbatprchis(&MBATPRCHIS_N, MBATPRCHIS);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                    ...
                    PROC_KEY_5
                INTO 
                    :MBATPRCHIS_N.JOB_PROC_ID,
                    :MBATPRCHIS_N.PROC_RUN_SUBNO,
                    :MBATPRCHIS_N.HIST_SEQ,
                    :MBATPRCHIS_N.START_TIME,
                    :MBATPRCHIS_N.END_TIME,
                    :MBATPRCHIS_N.ELAPSED_TIME,
                    :MBATPRCHIS_N.STATUS_FLAG,
                    :MBATPRCHIS_N.ERROR_MSG,
                    :MBATPRCHIS_N.DB_ERROR_MSG,
                    :MBATPRCHIS_N.PROC_KEY_1,
                    :MBATPRCHIS_N.PROC_KEY_2,
                    :MBATPRCHIS_N.PROC_KEY_3,
                    :MBATPRCHIS_N.PROC_KEY_4,
                    :MBATPRCHIS_N.PROC_KEY_5
                FROM MBATPRCHIS
                WHERE JOB_PROC_ID = :MBATPRCHIS_N.JOB_PROC_ID
                    AND PROC_RUN_SUBNO = :MBATPRCHIS_N.PROC_RUN_SUBNO
                    AND HIST_SEQ = :MBATPRCHIS_N.HIST_SEQ; */ 

{
            ...
            sqlstm.stmt = "select JOB_PROC_ID ,PROC_RUN_SUBNO ,HIST_SEQ ,ST\
ART_TIME ,END_TIME ,ELAPSED_TIME ,STATUS_FLAG ,ERROR_MSG ,DB_ERROR_MSG ,PROC_\
KEY_1 ,PROC_KEY_2 ,PROC_KEY_3 ,PROC_KEY_4 ,PROC_KEY_5 into :b0,:b1,:b2,:b3,:b\
4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12,:b13  from MBATPRCHIS where ((JOB_PROC_I\
D=:b0 and PROC_RUN_SUBNO=:b1) and HIST_SEQ=:b2)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MBATPRCHIS_N.JOB_PROC_ID);
            ...
            sqlstm.sqhstv[1] = (         void  *)(MBATPRCHIS_N.PROC_RUN_SUBNO);
            ...
            sqlstm.sqhstv[2] = (         void  *)&(MBATPRCHIS_N.HIST_SEQ);
            ...
            sqlstm.sqhstv[3] = (         void  *)(MBATPRCHIS_N.START_TIME);
            ...
            sqlstm.sqhstv[4] = (         void  *)(MBATPRCHIS_N.END_TIME);
            ...
            sqlstm.sqhstv[5] = (         void  *)&(MBATPRCHIS_N.ELAPSED_TIME);
            ...
            sqlstm.sqhstv[6] = (         void  *)(MBATPRCHIS_N.STATUS_FLAG);
            ...
            sqlstm.sqhstv[7] = (         void  *)(MBATPRCHIS_N.ERROR_MSG);
            ...
            sqlstm.sqhstv[8] = (         void  *)(MBATPRCHIS_N.DB_ERROR_MSG);
            ...
            sqlstm.sqhstv[9] = (         void  *)(MBATPRCHIS_N.PROC_KEY_1);
            ...
            sqlstm.sqhstv[10] = (         void  *)(MBATPRCHIS_N.PROC_KEY_2);
            ...
            sqlstm.sqhstv[11] = (         void  *)(MBATPRCHIS_N.PROC_KEY_3);
            ...
            sqlstm.sqhstv[12] = (         void  *)(MBATPRCHIS_N.PROC_KEY_4);
            ...
            sqlstm.sqhstv[13] = (         void  *)(MBATPRCHIS_N.PROC_KEY_5);
            ...
            sqlstm.sqhstv[14] = (         void  *)(MBATPRCHIS_N.JOB_PROC_ID);
            ...
            sqlstm.sqhstv[15] = (         void  *)(MBATPRCHIS_N.PROC_RUN_SUBNO);
            ...
            sqlstm.sqhstv[16] = (         void  *)&(MBATPRCHIS_N.HIST_SEQ);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_mbatprchis(&MBATPRCHIS_N, MBATPRCHIS);
    }

    DB_stop_query_timer("DBC_select_mbatprchis", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_mbatprchis_for_update(int sel_type, struct MBATPRCHIS_TAG *MBATPRCHIS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
KEY_1 ,PROC_KEY_2 ,PROC_KEY_3 ,PROC_KEY_4 ,PROC_KEY_5 into :b0,:b1,:b2,:b3,:b\
4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12,:b13  from MBATPRCHIS where ((JOB_PROC_I\
D=:b0 and PROC_RUN_SUBNO=:b1) and HIST_SEQ=:b2) for update ";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_select_mbatprchis_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_mbatprchis_scalar(int sel_type, struct MBATPRCHIS_TAG *MBATPRCHIS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MBATPRCHIS where\
 ((JOB_PROC_ID=:b1 and PROC_RUN_SUBNO=:b2) and HIST_SEQ=:b3)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MBATPRCHIS_N.JOB_PROC_ID);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MBATPRCHIS_N.PROC_RUN_SUBNO);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)&(MBATPRCHIS_N.HIST_SEQ);
    ...
    DB_stop_query_timer("DBC_select_mbatprchis_scalar", sel_type);
...
/* SQL DELETE Function */
void DBC_delete_mbatprchis(int sel_type, struct MBATPRCHIS_TAG *MBATPRCHIS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MBATPRCHIS
                WHERE JOB_PROC_ID = :MBATPRCHIS_N.JOB_PROC_ID
                    AND PROC_RUN_SUBNO = :MBATPRCHIS_N.PROC_RUN_SUBNO
                    AND HIST_SEQ = :MBATPRCHIS_N.HIST_SEQ; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MBATPRCHIS  where ((JOB_PROC_ID=:b0\
 and PROC_RUN_SUBNO=:b1) and HIST_SEQ=:b2)";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_delete_mbatprchis", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_mbatprchis(struct MBATPRCHIS_TAG *MBATPRCHIS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MBATPRCHIS( 
                    JOB_PROC_ID, 
                    PROC_RUN_SUBNO, 
                    HIST_SEQ, 
                    START_TIME, 
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MBATPRCHIS (JOB_PROC_ID,PROC_RUN_SUBNO,HIST_\
SEQ,START_TIME,END_TIME,ELAPSED_TIME,STATUS_FLAG,ERROR_MSG,DB_ERROR_MSG,PROC_\
KEY_1,PROC_KEY_2,PROC_KEY_3,PROC_KEY_4,PROC_KEY_5) values (:b0,:b1,:b2,:b3,:b\
4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12,:b13)";
    sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_insert_mbatprchis", 0);
}


/* SQL UPDATE Function */
void DBC_update_mbatprchis(int sel_type, struct MBATPRCHIS_TAG *MBATPRCHIS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MBATPRCHIS SET
                    START_TIME = :MBATPRCHIS_N.START_TIME,
                    END_TIME = :MBATPRCHIS_N.END_TIME,
                    ELAPSED_TIME = :MBATPRCHIS_N.ELAPSED_TIME,
                    STATUS_FLAG = :MBATPRCHIS_N.STATUS_FLAG,
                    ERROR_MSG = :MBATPRCHIS_N.ERROR_MSG,
                    DB_ERROR_MSG = :MBATPRCHIS_N.DB_ERROR_MSG,
                    PROC_KEY_1 = :MBATPRCHIS_N.PROC_KEY_1,
                    PROC_KEY_2 = :MBATPRCHIS_N.PROC_KEY_2,
                    PROC_KEY_3 = :MBATPRCHIS_N.PROC_KEY_3,
                    PROC_KEY_4 = :MBATPRCHIS_N.PROC_KEY_4,
                    PROC_KEY_5 = :MBATPRCHIS_N.PROC_KEY_5
                WHERE JOB_PROC_ID = :MBATPRCHIS_N.JOB_PROC_ID
                    AND PROC_RUN_SUBNO = :MBATPRCHIS_N.PROC_RUN_SUBNO
                    AND HIST_SEQ = :MBATPRCHIS_N.HIST_SEQ; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MBATPRCHIS  set START_TIME=:b0,END_TIME=:\
b1,ELAPSED_TIME=:b2,STATUS_FLAG=:b3,ERROR_MSG=:b4,DB_ERROR_MSG=:b5,PROC_KEY_1\
=:b6,PROC_KEY_2=:b7,PROC_KEY_3=:b8,PROC_KEY_4=:b9,PROC_KEY_5=:b10 where ((JOB\
_PROC_ID=:b11 and PROC_RUN_SUBNO=:b12) and HIST_SEQ=:b13)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MBATPRCHIS_N.START_TIME);
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MBATPRCHIS_N.END_TIME);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)&(MBATPRCHIS_N.ELAPSED_TIME);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MBATPRCHIS_N.STATUS_FLAG);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MBATPRCHIS_N.ERROR_MSG);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MBATPRCHIS_N.DB_ERROR_MSG);
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)(MBATPRCHIS_N.PROC_KEY_1);
            ...
            sqlstm.sqadto[6] = (unsigned short )0;
            sqlstm.sqtdso[6] = (unsigned short )0;
            sqlstm.sqhstv[7] = (         void  *)(MBATPRCHIS_N.PROC_KEY_2);
            ...
            sqlstm.sqadto[7] = (unsigned short )0;
            sqlstm.sqtdso[7] = (unsigned short )0;
            sqlstm.sqhstv[8] = (         void  *)(MBATPRCHIS_N.PROC_KEY_3);
            ...
            sqlstm.sqadto[8] = (unsigned short )0;
            sqlstm.sqtdso[8] = (unsigned short )0;
            sqlstm.sqhstv[9] = (         void  *)(MBATPRCHIS_N.PROC_KEY_4);
            sqlstm.sqhstl[9] = (unsigned int  )101;
            sqlstm.sqhsts[9] = (         int  )0;
            sqlstm.sqindv[9] = (         void  *)0;
            sqlstm.sqinds[9] = (         int  )0;
            ...
            sqlstm.sqadto[9] = (unsigned short )0;
            sqlstm.sqtdso[9] = (unsigned short )0;
            sqlstm.sqhstv[10] = (         void  *)(MBATPRCHIS_N.PROC_KEY_5);
            sqlstm.sqhstl[10] = (unsigned int  )101;
            sqlstm.sqhsts[10] = (         int  )0;
            sqlstm.sqindv[10] = (         void  *)0;
            sqlstm.sqinds[10] = (         int  )0;
            ...
            sqlstm.sqadto[10] = (unsigned short )0;
            sqlstm.sqtdso[10] = (unsigned short )0;
            sqlstm.sqhstv[11] = (         void  *)(MBATPRCHIS_N.JOB_PROC_ID);
            ...
            sqlstm.sqadto[11] = (unsigned short )0;
            sqlstm.sqtdso[11] = (unsigned short )0;
            sqlstm.sqhstv[12] = (         void  *)(MBATPRCHIS_N.PROC_RUN_SUBNO);
            ...
            sqlstm.sqadto[12] = (unsigned short )0;
            sqlstm.sqtdso[12] = (unsigned short )0;
            sqlstm.sqhstv[13] = (         void  *)&(MBATPRCHIS_N.HIST_SEQ);
    ...
    DB_stop_query_timer("DBC_update_mbatprchis", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_mbatprchis(int sel_type, struct MBATPRCHIS_TAG *MBATPRCHIS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MBATPRCHIS_CUR_1 CURSOR FOR
                SELECT 
                    JOB_PROC_ID,
                    PROC_RUN_SUBNO,
                    HIST_SEQ,
                    ...
                    PROC_KEY_5
                FROM MBATPRCHIS
                ORDER BY JOB_PROC_ID ASC,
                    PROC_RUN_SUBNO ASC,
                    HIST_SEQ ASC; */ 

            /* EXEC SQL OPEN DBC_MBATPRCHIS_CUR_1; */ 

{
        ...
        case 2:
            /* EXEC SQL DECLARE DBC_MBATPRCHIS_CUR_2 CURSOR FOR
                SELECT ROWSEQ,
                    JOB_PROC_ID,
                    PROC_RUN_SUBNO,
                    HIST_SEQ,
                ...
                FROM (
                    ...
                    FROM (
                        ...
                        FROM MBATPRCHIS
                        WHERE JOB_PROC_ID = :MBATPRCHIS_N.JOB_PROC_ID
                            AND START_TIME BETWEEN :MBATPRCHIS_N.START_TIME AND :MBATPRCHIS_N.END_TIME
                        ORDER BY START_TIME DESC, HIST_SEQ DESC, PROC_RUN_SUBNO ASC
                    ) JPH
                )
                WHERE ROWSEQ >= :MBATPRCHIS_N.HIST_SEQ; */ 


            /* EXEC SQL OPEN DBC_MBATPRCHIS_CUR_2; */ 

{
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MBATPRCHIS_N.START_TIME);
            sqlstm.sqhstl[1] = (unsigned int  )15;
            sqlstm.sqhsts[1] = (         int  )0;
            sqlstm.sqindv[1] = (         void  *)0;
            sqlstm.sqinds[1] = (         int  )0;
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MBATPRCHIS_N.END_TIME);
    ...
    DB_stop_query_timer("DBC_open_mbatprchis", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_mbatprchis(int sel_type, struct MBATPRCHIS_TAG *MBATPRCHIS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MBATPRCHIS_CUR_1 INTO
                :MBATPRCHIS_N.JOB_PROC_ID,
                :MBATPRCHIS_N.PROC_RUN_SUBNO,
                :MBATPRCHIS_N.HIST_SEQ,
                :MBATPRCHIS_N.START_TIME,
...

{
        ...
        case 2:
            /* EXEC SQL FETCH DBC_MBATPRCHIS_CUR_2 INTO
...

{
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MBATPRCHIS_N.START_TIME);
            sqlstm.sqhstl[4] = (unsigned int  )15;
            sqlstm.sqhsts[4] = (         int  )0;
            sqlstm.sqindv[4] = (         void  *)0;
            sqlstm.sqinds[4] = (         int  )0;
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MBATPRCHIS_N.END_TIME);
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)&(MBATPRCHIS_N.ELAPSED_TIME);
            ...
            sqlstm.sqadto[6] = (unsigned short )0;
            sqlstm.sqtdso[6] = (unsigned short )0;
            sqlstm.sqhstv[7] = (         void  *)(MBATPRCHIS_N.STATUS_FLAG);
            ...
            sqlstm.sqadto[7] = (unsigned short )0;
            sqlstm.sqtdso[7] = (unsigned short )0;
            sqlstm.sqhstv[8] = (         void  *)(MBATPRCHIS_N.ERROR_MSG);
            sqlstm.sqhstl[8] = (unsigned int  )201;
            sqlstm.sqhsts[8] = (         int  )0;
            sqlstm.sqindv[8] = (         void  *)0;
            sqlstm.sqinds[8] = (         int  )0;
            ...
            sqlstm.sqadto[8] = (unsigned short )0;
            sqlstm.sqtdso[8] = (unsigned short )0;
            sqlstm.sqhstv[9] = (         void  *)(MBATPRCHIS_N.DB_ERROR_MSG);
            ...
            sqlstm.sqadto[9] = (unsigned short )0;
            sqlstm.sqtdso[9] = (unsigned short )0;
            sqlstm.sqhstv[10] = (         void  *)(MBATPRCHIS_N.PROC_KEY_1);
            sqlstm.sqhstl[10] = (unsigned int  )101;
            sqlstm.sqhsts[10] = (         int  )0;
            sqlstm.sqindv[10] = (         void  *)0;
            sqlstm.sqinds[10] = (         int  )0;
            ...
            sqlstm.sqadto[10] = (unsigned short )0;
            sqlstm.sqtdso[10] = (unsigned short )0;
            sqlstm.sqhstv[11] = (         void  *)(MBATPRCHIS_N.PROC_KEY_2);
            sqlstm.sqhstl[11] = (unsigned int  )101;
            sqlstm.sqhsts[11] = (         int  )0;
            sqlstm.sqindv[11] = (         void  *)0;
            sqlstm.sqinds[11] = (         int  )0;
            ...
            sqlstm.sqadto[11] = (unsigned short )0;
            sqlstm.sqtdso[11] = (unsigned short )0;
            sqlstm.sqhstv[12] = (         void  *)(MBATPRCHIS_N.PROC_KEY_3);
            sqlstm.sqhstl[12] = (unsigned int  )101;
            sqlstm.sqhsts[12] = (         int  )0;
            sqlstm.sqindv[12] = (         void  *)0;
            sqlstm.sqinds[12] = (         int  )0;
            ...
            sqlstm.sqadto[12] = (unsigned short )0;
            sqlstm.sqtdso[12] = (unsigned short )0;
            sqlstm.sqhstv[13] = (         void  *)(MBATPRCHIS_N.PROC_KEY_4);
            sqlstm.sqhstl[13] = (unsigned int  )101;
            sqlstm.sqhsts[13] = (         int  )0;
            sqlstm.sqindv[13] = (         void  *)0;
            sqlstm.sqinds[13] = (         int  )0;
            ...
            sqlstm.sqadto[13] = (unsigned short )0;
            sqlstm.sqtdso[13] = (unsigned short )0;
            sqlstm.sqhstv[14] = (         void  *)(MBATPRCHIS_N.PROC_KEY_5);
    ...
    DB_stop_query_timer("DBC_fetch_mbatprchis", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_mbatprchis(int sel_type)
{
    DB_start_query_timer();
    DB_error_code = 0;
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MBATPRCHIS_CUR_1; */ 

{
        ...
        case 2:
            /* EXEC SQL CLOSE DBC_MBATPRCHIS_CUR_2; */ 

{
    ...
    DB_stop_query_timer("DBC_close_mbatprchis", sel_type);
}


/* Initialize Function */
void DBC_init_mbatprchis(struct MBATPRCHIS_TAG *MBATPRCHIS)
{
    /* memset by Space */
    memset(MBATPRCHIS, ' ', sizeof(struct MBATPRCHIS_TAG));
    
    MBATPRCHIS->HIST_SEQ = 0;
    MBATPRCHIS->ELAPSED_TIME = 0;
}
...
{
    /* memset by NULL */
    memset(MBATPRCHIS_N, '\0', sizeof(struct MBATPRCHIS_N_TAG));
    
    MEMCPY_AN(MBATPRCHIS_N->JOB_PROC_ID, MBATPRCHIS->JOB_PROC_ID, sizeof(MBATPRCHIS->JOB_PROC_ID));
    MEMCPY_AN(MBATPRCHIS_N->PROC_RUN_SUBNO, MBATPRCHIS->PROC_RUN_SUBNO, sizeof(MBATPRCHIS->PROC_RUN_SUBNO));
    MBATPRCHIS_N->HIST_SEQ = MBATPRCHIS->HIST_SEQ;
    MEMCPY_AN(MBATPRCHIS_N->START_TIME, MBATPRCHIS->START_TIME, sizeof(MBATPRCHIS->START_TIME));
    MEMCPY_AN(MBATPRCHIS_N->END_TIME, MBATPRCHIS->END_TIME, sizeof(MBATPRCHIS->END_TIME));
    MBATPRCHIS_N->ELAPSED_TIME = MBATPRCHIS->ELAPSED_TIME;
    MBATPRCHIS_N->STATUS_FLAG[0] = MBATPRCHIS->STATUS_FLAG;
    MEMCPY_AN(MBATPRCHIS_N->ERROR_MSG, MBATPRCHIS->ERROR_MSG, sizeof(MBATPRCHIS->ERROR_MSG));
    MEMCPY_AN(MBATPRCHIS_N->DB_ERROR_MSG, MBATPRCHIS->DB_ERROR_MSG, sizeof(MBATPRCHIS->DB_ERROR_MSG));
    MEMCPY_AN(MBATPRCHIS_N->PROC_KEY_1, MBATPRCHIS->PROC_KEY_1, sizeof(MBATPRCHIS->PROC_KEY_1));
    MEMCPY_AN(MBATPRCHIS_N->PROC_KEY_2, MBATPRCHIS->PROC_KEY_2, sizeof(MBATPRCHIS->PROC_KEY_2));
    MEMCPY_AN(MBATPRCHIS_N->PROC_KEY_3, MBATPRCHIS->PROC_KEY_3, sizeof(MBATPRCHIS->PROC_KEY_3));
    MEMCPY_AN(MBATPRCHIS_N->PROC_KEY_4, MBATPRCHIS->PROC_KEY_4, sizeof(MBATPRCHIS->PROC_KEY_4));
    MEMCPY_AN(MBATPRCHIS_N->PROC_KEY_5, MBATPRCHIS->PROC_KEY_5, sizeof(MBATPRCHIS->PROC_KEY_5));
}
...
void DBC_del_null_mbatprchis(struct MBATPRCHIS_N_TAG *MBATPRCHIS_N, struct MBATPRCHIS_TAG *MBATPRCHIS)
{
    MEMCPY_DN(MBATPRCHIS->JOB_PROC_ID, MBATPRCHIS_N->JOB_PROC_ID, sizeof(MBATPRCHIS->JOB_PROC_ID));
    MEMCPY_DN(MBATPRCHIS->PROC_RUN_SUBNO, MBATPRCHIS_N->PROC_RUN_SUBNO, sizeof(MBATPRCHIS->PROC_RUN_SUBNO));
    MBATPRCHIS->HIST_SEQ = MBATPRCHIS_N->HIST_SEQ;
    MEMCPY_DN(MBATPRCHIS->START_TIME, MBATPRCHIS_N->START_TIME, sizeof(MBATPRCHIS->START_TIME));
    MEMCPY_DN(MBATPRCHIS->END_TIME, MBATPRCHIS_N->END_TIME, sizeof(MBATPRCHIS->END_TIME));
    MBATPRCHIS->ELAPSED_TIME = MBATPRCHIS_N->ELAPSED_TIME;
    MBATPRCHIS->STATUS_FLAG = MBATPRCHIS_N->STATUS_FLAG[0];
    MEMCPY_DN(MBATPRCHIS->ERROR_MSG, MBATPRCHIS_N->ERROR_MSG, sizeof(MBATPRCHIS->ERROR_MSG));
    MEMCPY_DN(MBATPRCHIS->DB_ERROR_MSG, MBATPRCHIS_N->DB_ERROR_MSG, sizeof(MBATPRCHIS->DB_ERROR_MSG));
    MEMCPY_DN(MBATPRCHIS->PROC_KEY_1, MBATPRCHIS_N->PROC_KEY_1, sizeof(MBATPRCHIS->PROC_KEY_1));
    MEMCPY_DN(MBATPRCHIS->PROC_KEY_2, MBATPRCHIS_N->PROC_KEY_2, sizeof(MBATPRCHIS->PROC_KEY_2));
    MEMCPY_DN(MBATPRCHIS->PROC_KEY_3, MBATPRCHIS_N->PROC_KEY_3, sizeof(MBATPRCHIS->PROC_KEY_3));
    MEMCPY_DN(MBATPRCHIS->PROC_KEY_4, MBATPRCHIS_N->PROC_KEY_4, sizeof(MBATPRCHIS->PROC_KEY_4));
    MEMCPY_DN(MBATPRCHIS->PROC_KEY_5, MBATPRCHIS_N->PROC_KEY_5, sizeof(MBATPRCHIS->PROC_KEY_5));
}
