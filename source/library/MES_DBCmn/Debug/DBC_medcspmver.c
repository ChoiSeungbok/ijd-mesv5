...
static unsigned int sqlctx = 9097083;
...
"select FACTORY ,OBJ_ID ,OBJ_HIST_SEQ ,COL_SET_ID ,COL_SET_VER ,COL_SEQ ,SPE\
C_REL_ID ,SPEC_REL_VER ,CHAR_ID ,CREATE_USER_ID ,CREATE_TIME ,UPDATE_USER_ID \
,UPDATE_TIME  from MEDCSPMVER  order by FACTORY asc ,OBJ_ID asc ,OBJ_HIST_SEQ\
 asc ,COL_SET_ID asc ,COL_SET_VER asc ,COL_SEQ asc ,SPEC_REL_ID asc ,SPEC_REL\
_VER asc ,CHAR_ID asc             ";
...
{13,4130,846,0,0,
5,0,0,1,423,0,4,45,0,0,22,9,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,0,2,
3,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,
97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,1,3,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
108,0,0,2,435,0,4,117,0,0,22,9,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,
0,2,3,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,
0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,1,3,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
211,0,0,3,224,0,4,192,0,0,10,9,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,
0,1,3,0,0,1,3,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
266,0,0,4,206,0,2,234,0,0,9,9,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,
1,3,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
317,0,0,5,234,0,3,269,0,0,13,13,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,
0,1,3,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
384,0,0,6,277,0,5,318,0,0,13,13,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,
0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,1,3,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
451,0,0,7,340,0,9,385,0,0,0,0,0,1,0,
466,0,0,7,0,0,13,413,0,0,13,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,0,
2,3,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
533,0,0,7,0,0,15,456,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_medcspmver.pc
**    DB Type     : Unix Oracle
...
void DBC_add_null_medcspmver(struct MEDCSPMVER_N_TAG *MEDCSPMVER_N, struct MEDCSPMVER_TAG *MEDCSPMVER);
void DBC_del_null_medcspmver(struct MEDCSPMVER_N_TAG *MEDCSPMVER_N, struct MEDCSPMVER_TAG *MEDCSPMVER);


/* SQL SELECT Function */
void DBC_select_medcspmver(int sel_type, struct MEDCSPMVER_TAG *MEDCSPMVER)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MEDCSPMVER_N_TAG MEDCSPMVER_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_medcspmver(&MEDCSPMVER_N, MEDCSPMVER);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                    ...
                    UPDATE_TIME
                INTO 
                    :MEDCSPMVER_N.FACTORY,
                    :MEDCSPMVER_N.OBJ_ID,
                    :MEDCSPMVER_N.OBJ_HIST_SEQ,
                    :MEDCSPMVER_N.COL_SET_ID,
                    :MEDCSPMVER_N.COL_SET_VER,
                    :MEDCSPMVER_N.COL_SEQ,
                    :MEDCSPMVER_N.SPEC_REL_ID,
                    :MEDCSPMVER_N.SPEC_REL_VER,
                    :MEDCSPMVER_N.CHAR_ID,
                    :MEDCSPMVER_N.CREATE_USER_ID,
                    :MEDCSPMVER_N.CREATE_TIME,
                    :MEDCSPMVER_N.UPDATE_USER_ID,
                    :MEDCSPMVER_N.UPDATE_TIME
                FROM MEDCSPMVER
                WHERE FACTORY = :MEDCSPMVER_N.FACTORY
                    AND OBJ_ID = :MEDCSPMVER_N.OBJ_ID
                    AND OBJ_HIST_SEQ = :MEDCSPMVER_N.OBJ_HIST_SEQ
                    AND COL_SET_ID = :MEDCSPMVER_N.COL_SET_ID
                    AND COL_SET_VER = :MEDCSPMVER_N.COL_SET_VER
                    AND COL_SEQ = :MEDCSPMVER_N.COL_SEQ
                    AND SPEC_REL_ID = :MEDCSPMVER_N.SPEC_REL_ID
                    AND SPEC_REL_VER = :MEDCSPMVER_N.SPEC_REL_VER
                    AND CHAR_ID = :MEDCSPMVER_N.CHAR_ID; */ 

{
            ...
            sqlstm.stmt = "select FACTORY ,OBJ_ID ,OBJ_HIST_SEQ ,COL_SET_ID\
 ,COL_SET_VER ,COL_SEQ ,SPEC_REL_ID ,SPEC_REL_VER ,CHAR_ID ,CREATE_USER_ID ,C\
REATE_TIME ,UPDATE_USER_ID ,UPDATE_TIME into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,\
:b8,:b9,:b10,:b11,:b12  from MEDCSPMVER where ((((((((FACTORY=:b0 and OBJ_ID=\
:b1) and OBJ_HIST_SEQ=:b2) and COL_SET_ID=:b3) and COL_SET_VER=:b4) and COL_S\
EQ=:b5) and SPEC_REL_ID=:b6) and SPEC_REL_VER=:b7) and CHAR_ID=:b8)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MEDCSPMVER_N.FACTORY);
            ...
            sqlstm.sqhstv[1] = (         void  *)(MEDCSPMVER_N.OBJ_ID);
            ...
            sqlstm.sqhstv[2] = (         void  *)&(MEDCSPMVER_N.OBJ_HIST_SEQ);
            ...
            sqlstm.sqhstv[3] = (         void  *)(MEDCSPMVER_N.COL_SET_ID);
            ...
            sqlstm.sqhstv[4] = (         void  *)&(MEDCSPMVER_N.COL_SET_VER);
            ...
            sqlstm.sqhstv[5] = (         void  *)&(MEDCSPMVER_N.COL_SEQ);
            ...
            sqlstm.sqhstv[6] = (         void  *)(MEDCSPMVER_N.SPEC_REL_ID);
            ...
            sqlstm.sqhstv[7] = (         void  *)&(MEDCSPMVER_N.SPEC_REL_VER);
            ...
            sqlstm.sqhstv[8] = (         void  *)(MEDCSPMVER_N.CHAR_ID);
            ...
            sqlstm.sqhstv[9] = (         void  *)(MEDCSPMVER_N.CREATE_USER_ID);
            ...
            sqlstm.sqhstv[10] = (         void  *)(MEDCSPMVER_N.CREATE_TIME);
            ...
            sqlstm.sqhstv[11] = (         void  *)(MEDCSPMVER_N.UPDATE_USER_ID);
            ...
            sqlstm.sqhstv[12] = (         void  *)(MEDCSPMVER_N.UPDATE_TIME);
            ...
            sqlstm.sqhstv[13] = (         void  *)(MEDCSPMVER_N.FACTORY);
            ...
            sqlstm.sqhstv[14] = (         void  *)(MEDCSPMVER_N.OBJ_ID);
            ...
            sqlstm.sqhstv[15] = (         void  *)&(MEDCSPMVER_N.OBJ_HIST_SEQ);
            ...
            sqlstm.sqhstv[16] = (         void  *)(MEDCSPMVER_N.COL_SET_ID);
            ...
            sqlstm.sqhstv[17] = (         void  *)&(MEDCSPMVER_N.COL_SET_VER);
            ...
            sqlstm.sqhstv[18] = (         void  *)&(MEDCSPMVER_N.COL_SEQ);
            ...
            sqlstm.sqhstv[19] = (         void  *)(MEDCSPMVER_N.SPEC_REL_ID);
            ...
            sqlstm.sqhstv[20] = (         void  *)&(MEDCSPMVER_N.SPEC_REL_VER);
            ...
            sqlstm.sqhstv[21] = (         void  *)(MEDCSPMVER_N.CHAR_ID);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_medcspmver(&MEDCSPMVER_N, MEDCSPMVER);
    }
    DB_stop_query_timer("DBC_select_medcspmver", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_medcspmver_for_update(int sel_type, struct MEDCSPMVER_TAG *MEDCSPMVER)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
:b8,:b9,:b10,:b11,:b12  from MEDCSPMVER where ((((((((FACTORY=:b0 and OBJ_ID=\
:b1) and OBJ_HIST_SEQ=:b2) and COL_SET_ID=:b3) and COL_SET_VER=:b4) and COL_S\
EQ=:b5) and SPEC_REL_ID=:b6) and SPEC_REL_VER=:b7) and CHAR_ID=:b8) for updat\
e ";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_select_medcspmver_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_medcspmver_scalar(int sel_type, struct MEDCSPMVER_TAG *MEDCSPMVER)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MEDCSPMVER where\
 ((((((((FACTORY=:b1 and OBJ_ID=:b2) and OBJ_HIST_SEQ=:b3) and COL_SET_ID=:b4\
) and COL_SET_VER=:b5) and COL_SEQ=:b6) and SPEC_REL_ID=:b7) and SPEC_REL_VER\
=:b8) and CHAR_ID=:b9)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MEDCSPMVER_N.FACTORY);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MEDCSPMVER_N.OBJ_ID);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)&(MEDCSPMVER_N.OBJ_HIST_SEQ);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MEDCSPMVER_N.COL_SET_ID);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)&(MEDCSPMVER_N.COL_SET_VER);
            sqlstm.sqhstl[5] = (unsigned int  )sizeof(int);
            sqlstm.sqhsts[5] = (         int  )0;
            sqlstm.sqindv[5] = (         void  *)0;
            sqlstm.sqinds[5] = (         int  )0;
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)&(MEDCSPMVER_N.COL_SEQ);
            ...
            sqlstm.sqadto[6] = (unsigned short )0;
            sqlstm.sqtdso[6] = (unsigned short )0;
            sqlstm.sqhstv[7] = (         void  *)(MEDCSPMVER_N.SPEC_REL_ID);
            ...
            sqlstm.sqadto[7] = (unsigned short )0;
            sqlstm.sqtdso[7] = (unsigned short )0;
            sqlstm.sqhstv[8] = (         void  *)&(MEDCSPMVER_N.SPEC_REL_VER);
            ...
            sqlstm.sqadto[8] = (unsigned short )0;
            sqlstm.sqtdso[8] = (unsigned short )0;
            sqlstm.sqhstv[9] = (         void  *)(MEDCSPMVER_N.CHAR_ID);
    ...
    DB_stop_query_timer("DBC_select_medcspmver_scalar", sel_type);
    return d_value;
}


/* SQL DELETE Function */
void DBC_delete_medcspmver(int sel_type, struct MEDCSPMVER_TAG *MEDCSPMVER)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MEDCSPMVER
                WHERE FACTORY = :MEDCSPMVER_N.FACTORY
                    AND OBJ_ID = :MEDCSPMVER_N.OBJ_ID
                    AND OBJ_HIST_SEQ = :MEDCSPMVER_N.OBJ_HIST_SEQ
                    AND COL_SET_ID = :MEDCSPMVER_N.COL_SET_ID
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MEDCSPMVER  where ((((((((FACTORY=:\
b0 and OBJ_ID=:b1) and OBJ_HIST_SEQ=:b2) and COL_SET_ID=:b3) and COL_SET_VER=\
:b4) and COL_SEQ=:b5) and SPEC_REL_ID=:b6) and SPEC_REL_VER=:b7) and CHAR_ID=\
:b8)";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_delete_medcspmver", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_medcspmver(struct MEDCSPMVER_TAG *MEDCSPMVER)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MEDCSPMVER( 
                    FACTORY, 
                    OBJ_ID, 
                    OBJ_HIST_SEQ, 
                    COL_SET_ID, 
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MEDCSPMVER (FACTORY,OBJ_ID,OBJ_HIST_SEQ,COL_\
SET_ID,COL_SET_VER,COL_SEQ,SPEC_REL_ID,SPEC_REL_VER,CHAR_ID,CREATE_USER_ID,CR\
EATE_TIME,UPDATE_USER_ID,UPDATE_TIME) values (:b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7\
,:b8,:b9,:b10,:b11,:b12)";
    sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_insert_medcspmver", 0);
}


/* SQL UPDATE Function */
void DBC_update_medcspmver(int sel_type, struct MEDCSPMVER_TAG *MEDCSPMVER)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MEDCSPMVER SET
                    CREATE_USER_ID = :MEDCSPMVER_N.CREATE_USER_ID,
                    CREATE_TIME = :MEDCSPMVER_N.CREATE_TIME,
                    UPDATE_USER_ID = :MEDCSPMVER_N.UPDATE_USER_ID,
                    UPDATE_TIME = :MEDCSPMVER_N.UPDATE_TIME
                WHERE FACTORY = :MEDCSPMVER_N.FACTORY
                    AND OBJ_ID = :MEDCSPMVER_N.OBJ_ID
                    AND OBJ_HIST_SEQ = :MEDCSPMVER_N.OBJ_HIST_SEQ
                    AND COL_SET_ID = :MEDCSPMVER_N.COL_SET_ID
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MEDCSPMVER  set CREATE_USER_ID=:b0,CREATE\
_TIME=:b1,UPDATE_USER_ID=:b2,UPDATE_TIME=:b3 where ((((((((FACTORY=:b4 and OB\
J_ID=:b5) and OBJ_HIST_SEQ=:b6) and COL_SET_ID=:b7) and COL_SET_VER=:b8) and \
COL_SEQ=:b9) and SPEC_REL_ID=:b10) and SPEC_REL_VER=:b11) and CHAR_ID=:b12)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MEDCSPMVER_N.CREATE_USER_ID);
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MEDCSPMVER_N.CREATE_TIME);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MEDCSPMVER_N.UPDATE_USER_ID);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MEDCSPMVER_N.UPDATE_TIME);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MEDCSPMVER_N.FACTORY);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MEDCSPMVER_N.OBJ_ID);
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)&(MEDCSPMVER_N.OBJ_HIST_SEQ);
            sqlstm.sqhstl[6] = (unsigned int  )sizeof(int);
            sqlstm.sqhsts[6] = (         int  )0;
            sqlstm.sqindv[6] = (         void  *)0;
            sqlstm.sqinds[6] = (         int  )0;
            ...
            sqlstm.sqadto[6] = (unsigned short )0;
            sqlstm.sqtdso[6] = (unsigned short )0;
            sqlstm.sqhstv[7] = (         void  *)(MEDCSPMVER_N.COL_SET_ID);
            sqlstm.sqhstl[7] = (unsigned int  )31;
            sqlstm.sqhsts[7] = (         int  )0;
            sqlstm.sqindv[7] = (         void  *)0;
            sqlstm.sqinds[7] = (         int  )0;
            ...
            sqlstm.sqadto[7] = (unsigned short )0;
            sqlstm.sqtdso[7] = (unsigned short )0;
            sqlstm.sqhstv[8] = (         void  *)&(MEDCSPMVER_N.COL_SET_VER);
            sqlstm.sqhstl[8] = (unsigned int  )sizeof(int);
            sqlstm.sqhsts[8] = (         int  )0;
            sqlstm.sqindv[8] = (         void  *)0;
            sqlstm.sqinds[8] = (         int  )0;
            ...
            sqlstm.sqadto[8] = (unsigned short )0;
            sqlstm.sqtdso[8] = (unsigned short )0;
            sqlstm.sqhstv[9] = (         void  *)&(MEDCSPMVER_N.COL_SEQ);
            ...
            sqlstm.sqadto[9] = (unsigned short )0;
            sqlstm.sqtdso[9] = (unsigned short )0;
            sqlstm.sqhstv[10] = (         void  *)(MEDCSPMVER_N.SPEC_REL_ID);
            ...
            sqlstm.sqadto[10] = (unsigned short )0;
            sqlstm.sqtdso[10] = (unsigned short )0;
            sqlstm.sqhstv[11] = (         void  *)&(MEDCSPMVER_N.SPEC_REL_VER);
            ...
            sqlstm.sqadto[11] = (unsigned short )0;
            sqlstm.sqtdso[11] = (unsigned short )0;
            sqlstm.sqhstv[12] = (         void  *)(MEDCSPMVER_N.CHAR_ID);
    ...
    DB_stop_query_timer("DBC_update_medcspmver", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_medcspmver(int sel_type, struct MEDCSPMVER_TAG *MEDCSPMVER)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MEDCSPMVER_CUR_1 CURSOR FOR
                SELECT 
                    FACTORY,
                    OBJ_ID,
                    OBJ_HIST_SEQ,
            ...
            /* EXEC SQL OPEN DBC_MEDCSPMVER_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_open_medcspmver", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_medcspmver(int sel_type, struct MEDCSPMVER_TAG *MEDCSPMVER)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MEDCSPMVER_CUR_1 INTO
                :MEDCSPMVER_N.FACTORY,
                :MEDCSPMVER_N.OBJ_ID,
                :MEDCSPMVER_N.OBJ_HIST_SEQ,
                :MEDCSPMVER_N.COL_SET_ID,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_medcspmver", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_medcspmver(int sel_type)
{
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MEDCSPMVER_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_close_medcspmver", sel_type);
}


/* Initialize Function */
void DBC_init_medcspmver(struct MEDCSPMVER_TAG *MEDCSPMVER)
{
    /* memset by Space */
    memset(MEDCSPMVER, ' ', sizeof(struct MEDCSPMVER_TAG));
    
    MEDCSPMVER->OBJ_HIST_SEQ = 0;
    MEDCSPMVER->COL_SET_VER = 0;
    MEDCSPMVER->COL_SEQ = 0;
    MEDCSPMVER->SPEC_REL_VER = 0;
}
...
{
    /* memset by NULL */
    memset(MEDCSPMVER_N, '\0', sizeof(struct MEDCSPMVER_N_TAG));
    
    MEMCPY_AN(MEDCSPMVER_N->FACTORY, MEDCSPMVER->FACTORY, sizeof(MEDCSPMVER->FACTORY));
    MEMCPY_AN(MEDCSPMVER_N->OBJ_ID, MEDCSPMVER->OBJ_ID, sizeof(MEDCSPMVER->OBJ_ID));
    MEDCSPMVER_N->OBJ_HIST_SEQ = MEDCSPMVER->OBJ_HIST_SEQ;
    MEMCPY_AN(MEDCSPMVER_N->COL_SET_ID, MEDCSPMVER->COL_SET_ID, sizeof(MEDCSPMVER->COL_SET_ID));
    MEDCSPMVER_N->COL_SET_VER = MEDCSPMVER->COL_SET_VER;
    MEDCSPMVER_N->COL_SEQ = MEDCSPMVER->COL_SEQ;
    MEMCPY_AN(MEDCSPMVER_N->SPEC_REL_ID, MEDCSPMVER->SPEC_REL_ID, sizeof(MEDCSPMVER->SPEC_REL_ID));
    MEDCSPMVER_N->SPEC_REL_VER = MEDCSPMVER->SPEC_REL_VER;
    MEMCPY_AN(MEDCSPMVER_N->CHAR_ID, MEDCSPMVER->CHAR_ID, sizeof(MEDCSPMVER->CHAR_ID));
    MEMCPY_AN(MEDCSPMVER_N->CREATE_USER_ID, MEDCSPMVER->CREATE_USER_ID, sizeof(MEDCSPMVER->CREATE_USER_ID));
    MEMCPY_AN(MEDCSPMVER_N->CREATE_TIME, MEDCSPMVER->CREATE_TIME, sizeof(MEDCSPMVER->CREATE_TIME));
    MEMCPY_AN(MEDCSPMVER_N->UPDATE_USER_ID, MEDCSPMVER->UPDATE_USER_ID, sizeof(MEDCSPMVER->UPDATE_USER_ID));
    MEMCPY_AN(MEDCSPMVER_N->UPDATE_TIME, MEDCSPMVER->UPDATE_TIME, sizeof(MEDCSPMVER->UPDATE_TIME));
}
...
void DBC_del_null_medcspmver(struct MEDCSPMVER_N_TAG *MEDCSPMVER_N, struct MEDCSPMVER_TAG *MEDCSPMVER)
{
    MEMCPY_DN(MEDCSPMVER->FACTORY, MEDCSPMVER_N->FACTORY, sizeof(MEDCSPMVER->FACTORY));
    MEMCPY_DN(MEDCSPMVER->OBJ_ID, MEDCSPMVER_N->OBJ_ID, sizeof(MEDCSPMVER->OBJ_ID));
    MEDCSPMVER->OBJ_HIST_SEQ = MEDCSPMVER_N->OBJ_HIST_SEQ;
    MEMCPY_DN(MEDCSPMVER->COL_SET_ID, MEDCSPMVER_N->COL_SET_ID, sizeof(MEDCSPMVER->COL_SET_ID));
    MEDCSPMVER->COL_SET_VER = MEDCSPMVER_N->COL_SET_VER;
    MEDCSPMVER->COL_SEQ = MEDCSPMVER_N->COL_SEQ;
    MEMCPY_DN(MEDCSPMVER->SPEC_REL_ID, MEDCSPMVER_N->SPEC_REL_ID, sizeof(MEDCSPMVER->SPEC_REL_ID));
    MEDCSPMVER->SPEC_REL_VER = MEDCSPMVER_N->SPEC_REL_VER;
    MEMCPY_DN(MEDCSPMVER->CHAR_ID, MEDCSPMVER_N->CHAR_ID, sizeof(MEDCSPMVER->CHAR_ID));
    MEMCPY_DN(MEDCSPMVER->CREATE_USER_ID, MEDCSPMVER_N->CREATE_USER_ID, sizeof(MEDCSPMVER->CREATE_USER_ID));
    MEMCPY_DN(MEDCSPMVER->CREATE_TIME, MEDCSPMVER_N->CREATE_TIME, sizeof(MEDCSPMVER->CREATE_TIME));
    MEMCPY_DN(MEDCSPMVER->UPDATE_USER_ID, MEDCSPMVER_N->UPDATE_USER_ID, sizeof(MEDCSPMVER->UPDATE_USER_ID));
    MEMCPY_DN(MEDCSPMVER->UPDATE_TIME, MEDCSPMVER_N->UPDATE_TIME, sizeof(MEDCSPMVER->UPDATE_TIME));
}
