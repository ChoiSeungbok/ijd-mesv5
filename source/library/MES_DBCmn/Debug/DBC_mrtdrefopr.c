...
static unsigned int sqlctx = 9138443;
...
"select FACTORY ,RELATION_LEVEL ,MAT_ID ,MAT_VER ,FLOW ,OPER ,REFERENCE_OPER\
 ,CREATE_USER_ID ,CREATE_TIME ,UPDATE_USER_ID ,UPDATE_TIME  from MRTDREFOPR  \
order by FACTORY asc ,RELATION_LEVEL asc ,MAT_ID asc ,MAT_VER asc ,FLOW asc ,\
OPER asc             ";
...
{13,4130,873,0,0,
5,0,0,1,308,0,4,44,0,0,17,6,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,0,1,97,0,
0,1,3,0,0,1,97,0,0,1,97,0,0,
88,0,0,2,320,0,4,109,0,0,17,6,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,
0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,0,1,97,
0,0,1,3,0,0,1,97,0,0,1,97,0,0,
171,0,0,3,150,0,4,177,0,0,7,6,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
1,97,0,0,1,97,0,0,
214,0,0,4,132,0,2,216,0,0,6,6,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,
0,1,97,0,0,
253,0,0,5,195,0,3,248,0,0,11,11,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,
0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
312,0,0,6,220,0,5,293,0,0,11,11,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,
0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,
371,0,0,7,250,0,9,353,0,0,0,0,0,1,0,
386,0,0,7,0,0,13,381,0,0,11,0,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,
0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
445,0,0,7,0,0,15,422,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_mrtdrefopr.pc
**    DB Type     : Unix Oracle
...
void DBC_add_null_mrtdrefopr(struct MRTDREFOPR_N_TAG *MRTDREFOPR_N, struct MRTDREFOPR_TAG *MRTDREFOPR);
void DBC_del_null_mrtdrefopr(struct MRTDREFOPR_N_TAG *MRTDREFOPR_N, struct MRTDREFOPR_TAG *MRTDREFOPR);


/* SQL SELECT Function */
void DBC_select_mrtdrefopr(int sel_type, struct MRTDREFOPR_TAG *MRTDREFOPR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MRTDREFOPR_N_TAG MRTDREFOPR_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_mrtdrefopr(&MRTDREFOPR_N, MRTDREFOPR);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                         ...
                         UPDATE_TIME
                INTO 
                    :MRTDREFOPR_N.FACTORY,
                    :MRTDREFOPR_N.RELATION_LEVEL,
                    :MRTDREFOPR_N.MAT_ID,
                    :MRTDREFOPR_N.MAT_VER,
                    :MRTDREFOPR_N.FLOW,
                    :MRTDREFOPR_N.OPER,
                    :MRTDREFOPR_N.REFERENCE_OPER,
                    :MRTDREFOPR_N.CREATE_USER_ID,
                    :MRTDREFOPR_N.CREATE_TIME,
                    :MRTDREFOPR_N.UPDATE_USER_ID,
                    :MRTDREFOPR_N.UPDATE_TIME
                FROM MRTDREFOPR
                WHERE FACTORY = :MRTDREFOPR_N.FACTORY
                    AND RELATION_LEVEL = :MRTDREFOPR_N.RELATION_LEVEL
                    AND MAT_ID = :MRTDREFOPR_N.MAT_ID
                    AND MAT_VER = :MRTDREFOPR_N.MAT_VER
                    AND FLOW = :MRTDREFOPR_N.FLOW
                    AND OPER = :MRTDREFOPR_N.OPER; */ 

{
            ...
            sqlstm.stmt = "select FACTORY ,RELATION_LEVEL ,MAT_ID ,MAT_VER \
,FLOW ,OPER ,REFERENCE_OPER ,CREATE_USER_ID ,CREATE_TIME ,UPDATE_USER_ID ,UPD\
ATE_TIME into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10  from MRTDREFOPR w\
here (((((FACTORY=:b0 and RELATION_LEVEL=:b1) and MAT_ID=:b2) and MAT_VER=:b3\
) and FLOW=:b4) and OPER=:b5)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MRTDREFOPR_N.FACTORY);
            ...
            sqlstm.sqhstv[1] = (         void  *)(MRTDREFOPR_N.RELATION_LEVEL);
            ...
            sqlstm.sqhstv[2] = (         void  *)(MRTDREFOPR_N.MAT_ID);
            ...
            sqlstm.sqhstv[3] = (         void  *)&(MRTDREFOPR_N.MAT_VER);
            ...
            sqlstm.sqhstv[4] = (         void  *)(MRTDREFOPR_N.FLOW);
            ...
            sqlstm.sqhstv[5] = (         void  *)(MRTDREFOPR_N.OPER);
            ...
            sqlstm.sqhstv[6] = (         void  *)(MRTDREFOPR_N.REFERENCE_OPER);
            ...
            sqlstm.sqhstv[7] = (         void  *)(MRTDREFOPR_N.CREATE_USER_ID);
            ...
            sqlstm.sqhstv[8] = (         void  *)(MRTDREFOPR_N.CREATE_TIME);
            ...
            sqlstm.sqhstv[9] = (         void  *)(MRTDREFOPR_N.UPDATE_USER_ID);
            ...
            sqlstm.sqhstv[10] = (         void  *)(MRTDREFOPR_N.UPDATE_TIME);
            ...
            sqlstm.sqhstv[11] = (         void  *)(MRTDREFOPR_N.FACTORY);
            ...
            sqlstm.sqhstv[12] = (         void  *)(MRTDREFOPR_N.RELATION_LEVEL);
            ...
            sqlstm.sqhstv[13] = (         void  *)(MRTDREFOPR_N.MAT_ID);
            ...
            sqlstm.sqhstv[14] = (         void  *)&(MRTDREFOPR_N.MAT_VER);
            ...
            sqlstm.sqhstv[15] = (         void  *)(MRTDREFOPR_N.FLOW);
            ...
            sqlstm.sqhstv[16] = (         void  *)(MRTDREFOPR_N.OPER);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_mrtdrefopr(&MRTDREFOPR_N, MRTDREFOPR);
    }
    DB_stop_query_timer("DBC_select_mrtdrefopr", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_mrtdrefopr_for_update(int sel_type, struct MRTDREFOPR_TAG *MRTDREFOPR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
ATE_TIME into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10  from MRTDREFOPR w\
here (((((FACTORY=:b0 and RELATION_LEVEL=:b1) and MAT_ID=:b2) and MAT_VER=:b3\
) and FLOW=:b4) and OPER=:b5) for update ";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_select_mrtdrefopr_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_mrtdrefopr_scalar(int sel_type, struct MRTDREFOPR_TAG *MRTDREFOPR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MRTDREFOPR where\
 (((((FACTORY=:b1 and RELATION_LEVEL=:b2) and MAT_ID=:b3) and MAT_VER=:b4) an\
d FLOW=:b5) and OPER=:b6)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MRTDREFOPR_N.FACTORY);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MRTDREFOPR_N.RELATION_LEVEL);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MRTDREFOPR_N.MAT_ID);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)&(MRTDREFOPR_N.MAT_VER);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MRTDREFOPR_N.FLOW);
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)(MRTDREFOPR_N.OPER);
            sqlstm.sqhstl[6] = (unsigned int  )11;
            sqlstm.sqhsts[6] = (         int  )0;
            sqlstm.sqindv[6] = (         void  *)0;
            sqlstm.sqinds[6] = (         int  )0;
    ...
    DB_stop_query_timer("DBC_select_mrtdrefopr_scalar", sel_type);
    return d_value;
}


/* SQL DELETE Function */
void DBC_delete_mrtdrefopr(int sel_type, struct MRTDREFOPR_TAG *MRTDREFOPR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MRTDREFOPR
                WHERE FACTORY = :MRTDREFOPR_N.FACTORY
                    AND RELATION_LEVEL = :MRTDREFOPR_N.RELATION_LEVEL
                    AND MAT_ID = :MRTDREFOPR_N.MAT_ID
                    AND MAT_VER = :MRTDREFOPR_N.MAT_VER
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MRTDREFOPR  where (((((FACTORY=:b0 \
and RELATION_LEVEL=:b1) and MAT_ID=:b2) and MAT_VER=:b3) and FLOW=:b4) and OP\
ER=:b5)";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_delete_mrtdrefopr", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_mrtdrefopr(struct MRTDREFOPR_TAG *MRTDREFOPR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MRTDREFOPR (
                    FACTORY,
                    RELATION_LEVEL,
                    MAT_ID,
                    MAT_VER,
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MRTDREFOPR (FACTORY,RELATION_LEVEL,MAT_ID,MA\
T_VER,FLOW,OPER,REFERENCE_OPER,CREATE_USER_ID,CREATE_TIME,UPDATE_USER_ID,UPDA\
TE_TIME) values (:b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10)";
    sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_insert_mrtdrefopr", 0);
}


/* SQL UPDATE Function */
void DBC_update_mrtdrefopr(int sel_type, struct MRTDREFOPR_TAG *MRTDREFOPR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MRTDREFOPR SET
                    REFERENCE_OPER = :MRTDREFOPR_N.REFERENCE_OPER,
                    CREATE_USER_ID = :MRTDREFOPR_N.CREATE_USER_ID,
                    CREATE_TIME = :MRTDREFOPR_N.CREATE_TIME,
                    UPDATE_USER_ID = :MRTDREFOPR_N.UPDATE_USER_ID,
                    UPDATE_TIME = :MRTDREFOPR_N.UPDATE_TIME
                WHERE FACTORY = :MRTDREFOPR_N.FACTORY
                    AND RELATION_LEVEL = :MRTDREFOPR_N.RELATION_LEVEL
                    AND MAT_ID = :MRTDREFOPR_N.MAT_ID
                    AND MAT_VER = :MRTDREFOPR_N.MAT_VER
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MRTDREFOPR  set REFERENCE_OPER=:b0,CREATE\
_USER_ID=:b1,CREATE_TIME=:b2,UPDATE_USER_ID=:b3,UPDATE_TIME=:b4 where (((((FA\
CTORY=:b5 and RELATION_LEVEL=:b6) and MAT_ID=:b7) and MAT_VER=:b8) and FLOW=:\
b9) and OPER=:b10)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MRTDREFOPR_N.REFERENCE_OPER);
            sqlstm.sqhstl[0] = (unsigned int  )11;
            sqlstm.sqhsts[0] = (         int  )0;
            sqlstm.sqindv[0] = (         void  *)0;
            sqlstm.sqinds[0] = (         int  )0;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MRTDREFOPR_N.CREATE_USER_ID);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MRTDREFOPR_N.CREATE_TIME);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MRTDREFOPR_N.UPDATE_USER_ID);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MRTDREFOPR_N.UPDATE_TIME);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MRTDREFOPR_N.FACTORY);
            sqlstm.sqhstl[5] = (unsigned int  )11;
            sqlstm.sqhsts[5] = (         int  )0;
            sqlstm.sqindv[5] = (         void  *)0;
            sqlstm.sqinds[5] = (         int  )0;
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)(MRTDREFOPR_N.RELATION_LEVEL);
            ...
            sqlstm.sqadto[6] = (unsigned short )0;
            sqlstm.sqtdso[6] = (unsigned short )0;
            sqlstm.sqhstv[7] = (         void  *)(MRTDREFOPR_N.MAT_ID);
            ...
            sqlstm.sqadto[7] = (unsigned short )0;
            sqlstm.sqtdso[7] = (unsigned short )0;
            sqlstm.sqhstv[8] = (         void  *)&(MRTDREFOPR_N.MAT_VER);
            ...
            sqlstm.sqadto[8] = (unsigned short )0;
            sqlstm.sqtdso[8] = (unsigned short )0;
            sqlstm.sqhstv[9] = (         void  *)(MRTDREFOPR_N.FLOW);
            sqlstm.sqhstl[9] = (unsigned int  )21;
            sqlstm.sqhsts[9] = (         int  )0;
            sqlstm.sqindv[9] = (         void  *)0;
            sqlstm.sqinds[9] = (         int  )0;
            ...
            sqlstm.sqadto[9] = (unsigned short )0;
            sqlstm.sqtdso[9] = (unsigned short )0;
            sqlstm.sqhstv[10] = (         void  *)(MRTDREFOPR_N.OPER);
    ...
    DB_stop_query_timer("DBC_update_mrtdrefopr", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_mrtdrefopr(int sel_type, struct MRTDREFOPR_TAG *MRTDREFOPR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MRTDREFOPR_CUR_1 CURSOR FOR
                SELECT 
                    FACTORY,
                    RELATION_LEVEL,
                    MAT_ID,
            ...
            /* EXEC SQL OPEN DBC_MRTDREFOPR_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_open_mrtdrefopr", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_mrtdrefopr(int sel_type, struct MRTDREFOPR_TAG *MRTDREFOPR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MRTDREFOPR_CUR_1 INTO 
                                                    :MRTDREFOPR_N.FACTORY,
                                                    :MRTDREFOPR_N.RELATION_LEVEL,
                                                    :MRTDREFOPR_N.MAT_ID,
                                                    :MRTDREFOPR_N.MAT_VER,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_mrtdrefopr", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_mrtdrefopr(int sel_type)
{
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MRTDREFOPR_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_close_mrtdrefopr", sel_type);
}


/* Initialize Function */
void DBC_init_mrtdrefopr(struct MRTDREFOPR_TAG *MRTDREFOPR)
{
    /* memset by Space */
    memset(MRTDREFOPR, ' ', sizeof(struct MRTDREFOPR_TAG));
    
    MRTDREFOPR->MAT_VER = 0;
}
...
{
    /* memset by NULL */
    memset(MRTDREFOPR_N, '\0', sizeof(struct MRTDREFOPR_N_TAG));
    
    MEMCPY_AN(MRTDREFOPR_N->FACTORY, MRTDREFOPR->FACTORY, sizeof(MRTDREFOPR->FACTORY));
    MRTDREFOPR_N->RELATION_LEVEL[0] = MRTDREFOPR->RELATION_LEVEL;
    MEMCPY_AN(MRTDREFOPR_N->MAT_ID, MRTDREFOPR->MAT_ID, sizeof(MRTDREFOPR->MAT_ID));
    MRTDREFOPR_N->MAT_VER = MRTDREFOPR->MAT_VER;
    MEMCPY_AN(MRTDREFOPR_N->FLOW, MRTDREFOPR->FLOW, sizeof(MRTDREFOPR->FLOW));
    MEMCPY_AN(MRTDREFOPR_N->OPER, MRTDREFOPR->OPER, sizeof(MRTDREFOPR->OPER));
    MEMCPY_AN(MRTDREFOPR_N->REFERENCE_OPER, MRTDREFOPR->REFERENCE_OPER, sizeof(MRTDREFOPR->REFERENCE_OPER));
    MEMCPY_AN(MRTDREFOPR_N->CREATE_USER_ID, MRTDREFOPR->CREATE_USER_ID, sizeof(MRTDREFOPR->CREATE_USER_ID));
    MEMCPY_AN(MRTDREFOPR_N->CREATE_TIME, MRTDREFOPR->CREATE_TIME, sizeof(MRTDREFOPR->CREATE_TIME));
    MEMCPY_AN(MRTDREFOPR_N->UPDATE_USER_ID, MRTDREFOPR->UPDATE_USER_ID, sizeof(MRTDREFOPR->UPDATE_USER_ID));
    MEMCPY_AN(MRTDREFOPR_N->UPDATE_TIME, MRTDREFOPR->UPDATE_TIME, sizeof(MRTDREFOPR->UPDATE_TIME));
}
...
void DBC_del_null_mrtdrefopr(struct MRTDREFOPR_N_TAG *MRTDREFOPR_N, struct MRTDREFOPR_TAG *MRTDREFOPR)
{
    MEMCPY_DN(MRTDREFOPR->FACTORY, MRTDREFOPR_N->FACTORY, sizeof(MRTDREFOPR->FACTORY));
    MRTDREFOPR->RELATION_LEVEL = MRTDREFOPR_N->RELATION_LEVEL[0];
    MEMCPY_DN(MRTDREFOPR->MAT_ID, MRTDREFOPR_N->MAT_ID, sizeof(MRTDREFOPR->MAT_ID));
    MRTDREFOPR->MAT_VER = MRTDREFOPR_N->MAT_VER;
    MEMCPY_DN(MRTDREFOPR->FLOW, MRTDREFOPR_N->FLOW, sizeof(MRTDREFOPR->FLOW));
    MEMCPY_DN(MRTDREFOPR->OPER, MRTDREFOPR_N->OPER, sizeof(MRTDREFOPR->OPER));
    MEMCPY_DN(MRTDREFOPR->REFERENCE_OPER, MRTDREFOPR_N->REFERENCE_OPER, sizeof(MRTDREFOPR->REFERENCE_OPER));
    MEMCPY_DN(MRTDREFOPR->CREATE_USER_ID, MRTDREFOPR_N->CREATE_USER_ID, sizeof(MRTDREFOPR->CREATE_USER_ID));
    MEMCPY_DN(MRTDREFOPR->CREATE_TIME, MRTDREFOPR_N->CREATE_TIME, sizeof(MRTDREFOPR->CREATE_TIME));
    MEMCPY_DN(MRTDREFOPR->UPDATE_USER_ID, MRTDREFOPR_N->UPDATE_USER_ID, sizeof(MRTDREFOPR->UPDATE_USER_ID));
    MEMCPY_DN(MRTDREFOPR->UPDATE_TIME, MRTDREFOPR_N->UPDATE_TIME, sizeof(MRTDREFOPR->UPDATE_TIME));
}
