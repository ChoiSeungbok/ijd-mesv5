...
static unsigned int sqlctx = 9092235;
...
SER_ID ,CREATE_TIME ,UPDATE_USER_ID ,UPDATE_TIME ,NO_USE_SPM_VALUE_FLAG  from\
 MEDCCOLCHR where FACTORY=:b0 order by COL_SET_ID asc             ";
...
M ,WARN_OUT_ALARM ,DERIVED_PARAM_FLAG ,DERIVED_PARAMETER ,DATA_TYPE ,CREATE_U\
SER_ID ,CREATE_TIME ,UPDATE_USER_ID ,UPDATE_TIME ,NO_USE_SPM_VALUE_FLAG  from\
 MEDCCOLCHR where (FACTORY=:b0 and COL_SET_ID=:b1) order by COL_SET_VERSION a\
sc             ";
...
M ,WARN_OUT_ALARM ,DERIVED_PARAM_FLAG ,DERIVED_PARAMETER ,DATA_TYPE ,CREATE_U\
SER_ID ,CREATE_TIME ,UPDATE_USER_ID ,UPDATE_TIME ,NO_USE_SPM_VALUE_FLAG  from\
 MEDCCOLCHR where ((FACTORY=:b0 and COL_SET_ID=:b1) and COL_SET_VERSION=:b2) \
...
SER_ID ,CREATE_TIME ,UPDATE_USER_ID ,UPDATE_TIME ,NO_USE_SPM_VALUE_FLAG  from\
 MEDCCOLCHR where (((FACTORY=:b0 and COL_SET_ID=:b1) and COL_SET_VERSION=:b2)\
 and CHAR_ID>=:b3) order by SEQ_NUM asc             ";

 static const char *sq0020 = 
"select distinct CHAR_ID ,FACTORY  from MEDCCOLCHR where (FACTORY=:b0 and CO\
L_SET_ID=:b1) order by CHAR_ID asc             ";
...
SER_ID ,CREATE_TIME ,UPDATE_USER_ID ,UPDATE_TIME ,NO_USE_SPM_VALUE_FLAG  from\
 MEDCCOLCHR where (((FACTORY=:b0 and COL_SET_ID=:b1) and COL_SET_VERSION=:b2)\
 and DERIVED_PARAM_FLAG=:b3) order by CHAR_ID asc             ";

 static const char *sq0022 = 
"select A.FACTORY ,A.COL_SET_ID ,A.COL_SET_VERSION ,A.CHAR_ID ,A.SEQ_NUM ,A.\
UNIT_COUNT ,A.VALUE_COUNT ,A.OPT_INPUT_FLAG ,A.BLANK_REC_SAVE_FLAG ,A.DISPLAY\
_PRECISION ,A.DEF_UNIT_FLAG ,A.DEF_UNIT_OVR_FLAG ,A.DEF_VALUE ,A.UNIT_TBL ,A.\
VALUE_TBL ,A.SPEC_OUT_COUNT ,A.SPEC_TYPE ,A.TARGET_VALUE ,A.UPPER_SPEC_LIMIT \
,A.LOWER_SPEC_LIMIT ,A.UPPER_WARN_LIMIT ,A.LOWER_WARN_LIMIT ,A.UPPER_CUST_LIM\
IT ,A.LOWER_CUST_LIMIT ,A.SPEC_INFO ,A.SPEC_OUT_ALARM ,A.WARN_OUT_ALARM ,A.DE\
RIVED_PARAM_FLAG ,A.DERIVED_PARAMETER ,A.DATA_TYPE ,A.CREATE_USER_ID ,A.CREAT\
E_TIME ,A.UPDATE_USER_ID ,A.UPDATE_TIME ,A.NO_USE_SPM_VALUE_FLAG  from MEDCCO\
LCHR A ,MEDCCHRDEF B where (((((A.FACTORY=:b0 and A.FACTORY=B.FACTORY) and A.\
COL_SET_ID=:b1) and A.COL_SET_VERSION=:b2) and A.CHAR_ID=B.CHAR_ID) and B.VAL\
UE_TYPE='N') order by A.SEQ_NUM asc             ";
...
LCHR A ,MEDCCHRDEF B where (((((A.FACTORY=:b0 and A.FACTORY=B.FACTORY) and A.\
COL_SET_ID=:b1) and A.COL_SET_VERSION=:b2) and A.CHAR_ID=B.CHAR_ID) and B.VAL\
UE_TYPE='A') order by A.SEQ_NUM asc             ";
...
{13,4130,873,0,0,
5,0,0,1,801,0,4,43,0,0,39,4,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,0,2,
...
176,0,0,2,819,0,4,123,0,0,40,5,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,
...
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,
351,0,0,3,801,0,4,204,0,0,39,4,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,
0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,
0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,3,0,0,
522,0,0,4,775,0,4,284,0,0,38,3,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,
0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,
0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
689,0,0,5,813,0,4,394,0,0,39,4,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,
0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,
0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
860,0,0,6,125,0,4,508,0,0,5,4,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
895,0,0,7,78,0,4,517,0,0,3,2,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,
922,0,0,8,117,0,4,525,0,0,4,3,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
953,0,0,9,99,0,4,534,0,0,4,3,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
984,0,0,10,107,0,2,570,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
1015,0,0,11,89,0,2,578,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,
1042,0,0,12,689,0,3,607,0,0,35,35,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,
0,0,1,3,0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,
...
1197,0,0,13,702,0,5,700,0,0,35,35,0,1,0,1,3,0,0,1,3,0,0,1,3,0,0,1,97,0,0,1,97,
0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,
0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,
97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
1352,0,0,14,702,0,5,739,0,0,35,35,0,1,0,1,97,0,0,1,3,0,0,1,3,0,0,1,97,0,0,1,97,
0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,
0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,
97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
1,97,0,0,1,97,0,0,1,3,0,0,1,3,0,0,
1507,0,0,15,125,0,5,779,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,3,0,0,
1538,0,0,16,603,0,9,853,0,0,1,1,0,1,0,1,97,0,0,
1557,0,0,17,629,0,9,899,0,0,2,2,0,1,0,1,97,0,0,1,97,0,0,
1580,0,0,18,647,0,9,945,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,
1607,0,0,19,666,0,9,992,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
1638,0,0,20,122,0,9,1002,0,0,2,2,0,1,0,1,97,0,0,1,97,0,0,
1661,0,0,21,676,0,9,1049,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
1692,0,0,22,816,0,9,1098,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,
1719,0,0,23,816,0,9,1147,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,
1746,0,0,16,0,0,13,1175,0,0,35,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,
0,0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
...
1901,0,0,17,0,0,13,1214,0,0,35,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,
0,0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2056,0,0,18,0,0,13,1253,0,0,35,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,
0,0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2211,0,0,19,0,0,13,1292,0,0,35,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,
0,0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2366,0,0,20,0,0,13,1331,0,0,2,0,0,1,0,2,97,0,0,2,97,0,0,
2389,0,0,21,0,0,13,1337,0,0,35,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,
0,0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2544,0,0,22,0,0,13,1376,0,0,35,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,
0,0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2699,0,0,23,0,0,13,1415,0,0,35,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,
0,0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2854,0,0,16,0,0,15,1480,0,0,0,0,0,1,0,
2869,0,0,17,0,0,15,1484,0,0,0,0,0,1,0,
2884,0,0,18,0,0,15,1488,0,0,0,0,0,1,0,
2899,0,0,19,0,0,15,1492,0,0,0,0,0,1,0,
2914,0,0,20,0,0,15,1496,0,0,0,0,0,1,0,
2929,0,0,21,0,0,15,1500,0,0,0,0,0,1,0,
2944,0,0,22,0,0,15,1504,0,0,0,0,0,1,0,
2959,0,0,23,0,0,15,1508,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_medccolchr.pc
**    Description : Table Access Function Source File
**    Create date : 2004/12/03 18:09:38
**
...
void DBC_add_null_medccolchr(struct MEDCCOLCHR_N_TAG *MEDCCOLCHR_N, struct MEDCCOLCHR_TAG *MEDCCOLCHR);
void DBC_del_null_medccolchr(struct MEDCCOLCHR_N_TAG *MEDCCOLCHR_N, struct MEDCCOLCHR_TAG *MEDCCOLCHR);


/* SQL SELECT Function */
void DBC_select_medccolchr(int sel_type, struct MEDCCOLCHR_TAG *MEDCCOLCHR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    DBC_add_null_medccolchr(&MEDCCOLCHR_N, MEDCCOLCHR);
    DB_error_code = 0;
        ...
        case 2:
            /* EXEC SQL SELECT 
                ...
                WHERE FACTORY = :MEDCCOLCHR_N.FACTORY
                    ...
                    AND COL_SET_VERSION = :MEDCCOLCHR_N.COL_SET_VERSION
                    AND CHAR_ID = :MEDCCOLCHR_N.CHAR_ID
                    AND SEQ_NUM = :MEDCCOLCHR_N.SEQ_NUM; */ 
...
NO_USE_SPM_VALUE_FLAG into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,\
:b12,:b13,:b14,:b15,:b16,:b17,:b18,:b19,:b20,:b21,:b22,:b23,:b24,:b25,:b26,:b\
27,:b28,:b29,:b30,:b31,:b32,:b33,:b34  from MEDCCOLCHR where ((((FACTORY=:b0 \
and COL_SET_ID=:b1) and COL_SET_VERSION=:b2) and CHAR_ID=:b3) and SEQ_NUM=:b4\
)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[38] = (unsigned short )0;
            sqlstm.sqtdso[38] = (unsigned short )0;
            sqlstm.sqhstv[39] = (         void  *)&(MEDCCOLCHR_N.SEQ_NUM);
...
:b12,:b13,:b14,:b15,:b16,:b17,:b18,:b19,:b20,:b21,:b22,:b23,:b24,:b25,:b26,:b\
27,:b28,:b29,:b30,:b31,:b32,:b33,:b34  from MEDCCOLCHR where (((FACTORY=:b0 a\
nd COL_SET_ID=:b1) and COL_SET_VERSION=:b2) and SEQ_NUM=:b4)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[37] = (unsigned short )0;
            sqlstm.sqtdso[37] = (unsigned short )0;
            sqlstm.sqhstv[38] = (         void  *)&(MEDCCOLCHR_N.SEQ_NUM);
...
NO_USE_SPM_VALUE_FLAG into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,\
:b12,:b13,:b14,:b15,:b16,:b17,:b18,:b19,:b20,:b21,:b22,:b23,:b24,:b25,:b26,:b\
27,:b28,:b29,:b30,:b31,:b32,:b33,:b34  from MEDCCOLCHR where ((FACTORY=:b0 an\
d COL_SET_ID=:b1) and CHAR_ID=:b3)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[36] = (unsigned short )0;
            sqlstm.sqtdso[36] = (unsigned short )0;
            sqlstm.sqhstv[37] = (         void  *)(MEDCCOLCHR_N.CHAR_ID);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_medccolchr(&MEDCCOLCHR_N, MEDCCOLCHR);
    }
    DB_stop_query_timer("DBC_select_medccolchr", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_medccolchr_for_update(int sel_type, struct MEDCCOLCHR_TAG *MEDCCOLCHR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
nd COL_SET_ID=:b1) and COL_SET_VERSION=:b2) and CHAR_ID=:b3) for update ";
    ...
    DB_stop_query_timer("DBC_select_medccolchr_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_medccolchr_scalar(int sel_type, struct MEDCCOLCHR_TAG *MEDCCOLCHR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
 ...
 (FACTORY=:b1 and CHAR_ID=:b2)";
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MEDCCOLCHR_N.CHAR_ID);
            sqlstm.sqhstl[2] = (unsigned int  )26;
            sqlstm.sqhsts[2] = (         int  )0;
            sqlstm.sqindv[2] = (         void  *)0;
            sqlstm.sqinds[2] = (         int  )0;
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select NVL(max(SEQ_NUM),0) into :b0  from MEDCCO\
LCHR where ((FACTORY=:b1 and COL_SET_ID=:b2) and COL_SET_VERSION=:b3)";
            sqlstm.iters = (unsigned int  )1;
...

{
            ...
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MEDCCOLCHR where\
 ((FACTORY=:b1 and COL_SET_ID=:b2) and CHAR_ID=:b3)";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_select_medccolchr_scalar", sel_type);
    return d_value;
}


/* SQL DELETE Function */
void DBC_delete_medccolchr(int sel_type, struct MEDCCOLCHR_TAG *MEDCCOLCHR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MEDCCOLCHR  where ((FACTORY=:b0 and\
 COL_SET_ID=:b1) and COL_SET_VERSION=:b2)";
    ...
    DB_stop_query_timer("DBC_delete_medccolchr", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_medccolchr(struct MEDCCOLCHR_TAG *MEDCCOLCHR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
1,:b32,:b33,:b34)";
    ...
    DB_stop_query_timer("DBC_insert_medccolchr", 0);
}


/* SQL UPDATE Function */
void DBC_update_medccolchr(int sel_type, struct MEDCCOLCHR_TAG *MEDCCOLCHR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MEDCCOLCHR  set CHAR_ID=:b0,UNIT_COUNT=:b\
1,VALUE_COUNT=:b2,OPT_INPUT_FLAG=:b3,BLANK_REC_SAVE_FLAG=:b4,DISPLAY_PRECISIO\
N=:b5,DEF_UNIT_FLAG=:b6,DEF_UNIT_OVR_FLAG=:b7,DEF_VALUE=:b8,UNIT_TBL=:b9,VALU\
E_TBL=:b10,SPEC_OUT_COUNT=:b11,SPEC_TYPE=:b12,TARGET_VALUE=:b13,UPPER_SPEC_LI\
MIT=:b14,LOWER_SPEC_LIMIT=:b15,UPPER_WARN_LIMIT=:b16,LOWER_WARN_LIMIT=:b17,UP\
...
:b25,CREATE_USER_ID=:b26,CREATE_TIME=:b27,UPDATE_USER_ID=:b28,UPDATE_TIME=:b2\
9,NO_USE_SPM_VALUE_FLAG=:b30 where (((FACTORY=:b31 and COL_SET_ID=:b32) and C\
OL_SET_VERSION=:b33) and SEQ_NUM=:b34)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MEDCCOLCHR_N.CHAR_ID);
            ...
            sqlstm.sqadto[33] = (unsigned short )0;
            sqlstm.sqtdso[33] = (unsigned short )0;
            sqlstm.sqhstv[34] = (         void  *)&(MEDCCOLCHR_N.SEQ_NUM);
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MEDCCOLCHR  set SEQ_NUM=(SEQ_NUM-1) where\
 (((FACTORY=:b0 and COL_SET_ID=:b1) and COL_SET_VERSION=:b2) and SEQ_NUM>:b3)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)&(MEDCCOLCHR_N.SEQ_NUM);
            sqlstm.sqhstl[3] = (unsigned int  )sizeof(int);
            sqlstm.sqhsts[3] = (         int  )0;
            sqlstm.sqindv[3] = (         void  *)0;
            sqlstm.sqinds[3] = (         int  )0;
    ...
    DB_stop_query_timer("DBC_update_medccolchr", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_medccolchr(int sel_type, struct MEDCCOLCHR_TAG *MEDCCOLCHR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MEDCCOLCHR_CUR_1 CURSOR FOR
                SELECT 
                    FACTORY,
                    COL_SET_ID,
                    COL_SET_VERSION,
                ...
                FROM MEDCCOLCHR
                WHERE FACTORY = :MEDCCOLCHR_N.FACTORY
                ORDER BY COL_SET_ID ASC; */ 

            /* EXEC SQL OPEN DBC_MEDCCOLCHR_CUR_1; */ 

{
        ...
        case 2:
            /* EXEC SQL DECLARE DBC_MEDCCOLCHR_CUR_2 CURSOR FOR
                SELECT 
                    FACTORY,
                    COL_SET_ID,
                    COL_SET_VERSION,
                ...
                WHERE FACTORY = :MEDCCOLCHR_N.FACTORY
                    AND COL_SET_ID = :MEDCCOLCHR_N.COL_SET_ID
                ORDER BY COL_SET_VERSION ASC; */ 

            /* EXEC SQL OPEN DBC_MEDCCOLCHR_CUR_2; */ 

{
        ...
        case 3:
            /* EXEC SQL DECLARE DBC_MEDCCOLCHR_CUR_3 CURSOR FOR
                SELECT 
                    FACTORY,
                    COL_SET_ID,
                    COL_SET_VERSION,
            ...
            /* EXEC SQL OPEN DBC_MEDCCOLCHR_CUR_3; */ 

{
        ...
        case 4:
            /* EXEC SQL DECLARE DBC_MEDCCOLCHR_CUR_4 CURSOR FOR
                SELECT 
                    FACTORY,
                    COL_SET_ID,
                    COL_SET_VERSION,
            ...
            /* EXEC SQL OPEN DBC_MEDCCOLCHR_CUR_4; */ 

{
        ...
        case 5:
            /* EXEC SQL DECLARE DBC_MEDCCOLCHR_CUR_5 CURSOR FOR
                SELECT DISTINCT CHAR_ID, FACTORY
                FROM MEDCCOLCHR
                WHERE FACTORY = :MEDCCOLCHR_N.FACTORY
                    AND COL_SET_ID = :MEDCCOLCHR_N.COL_SET_ID
                ORDER BY CHAR_ID ASC; */ 

            /* EXEC SQL OPEN DBC_MEDCCOLCHR_CUR_5; */ 

{
        ...
        case 6:
            /* EXEC SQL DECLARE DBC_MEDCCOLCHR_CUR_6 CURSOR FOR
                SELECT 
                    FACTORY,
                    COL_SET_ID,
                    COL_SET_VERSION,
                ...
                WHERE FACTORY = :MEDCCOLCHR_N.FACTORY
                    AND COL_SET_ID = :MEDCCOLCHR_N.COL_SET_ID
                    AND COL_SET_VERSION = :MEDCCOLCHR_N.COL_SET_VERSION
                    AND DERIVED_PARAM_FLAG = :MEDCCOLCHR_N.DERIVED_PARAM_FLAG
                ORDER BY CHAR_ID ASC; */ 

            /* EXEC SQL OPEN DBC_MEDCCOLCHR_CUR_6; */ 

{
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MEDCCOLCHR_N.DERIVED_PARAM_FLAG);
            sqlstm.sqhstl[3] = (unsigned int  )2;
            sqlstm.sqhsts[3] = (         int  )0;
            sqlstm.sqindv[3] = (         void  *)0;
            sqlstm.sqinds[3] = (         int  )0;
        ...
        case 7:
            /* EXEC SQL DECLARE DBC_MEDCCOLCHR_CUR_7 CURSOR FOR
                SELECT
                           A.FACTORY,
                           A.COL_SET_ID,
                           A.COL_SET_VERSION,
                           ...
                           A.UPDATE_USER_ID,
                           A.UPDATE_TIME,
                           A.NO_USE_SPM_VALUE_FLAG
                FROM MEDCCOLCHR A, MEDCCHRDEF B
                WHERE A.FACTORY = :MEDCCOLCHR_N.FACTORY
                    AND A.FACTORY = B.FACTORY
                    AND A.COL_SET_ID = :MEDCCOLCHR_N.COL_SET_ID
                    AND A.COL_SET_VERSION = :MEDCCOLCHR_N.COL_SET_VERSION
                    AND A.CHAR_ID = B.CHAR_ID
                    AND B.VALUE_TYPE = 'N'
                ORDER BY A.SEQ_NUM ASC; */ 

            /* EXEC SQL OPEN DBC_MEDCCOLCHR_CUR_7; */ 

{
        ...
        case 8:
            /* EXEC SQL DECLARE DBC_MEDCCOLCHR_CUR_8 CURSOR FOR
                SELECT
                           A.FACTORY,
                           A.COL_SET_ID,
                           A.COL_SET_VERSION,
            ...
            /* EXEC SQL OPEN DBC_MEDCCOLCHR_CUR_8; */ 

{
    ...
    DB_stop_query_timer("DBC_open_medccolchr", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_medccolchr(int sel_type, struct MEDCCOLCHR_TAG *MEDCCOLCHR)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MEDCCOLCHR_CUR_1 INTO 
                                                    :MEDCCOLCHR_N.FACTORY,
                                                    :MEDCCOLCHR_N.COL_SET_ID,
                                                    :MEDCCOLCHR_N.COL_SET_VERSION,
                                                    :MEDCCOLCHR_N.CHAR_ID,
...

{
        ...
        case 2:
            /* EXEC SQL FETCH DBC_MEDCCOLCHR_CUR_2 INTO 
                                                    :MEDCCOLCHR_N.FACTORY,
                                                    :MEDCCOLCHR_N.COL_SET_ID,
                                                    :MEDCCOLCHR_N.COL_SET_VERSION,
                                                    :MEDCCOLCHR_N.CHAR_ID,
...

{
        ...
        case 3:
            /* EXEC SQL FETCH DBC_MEDCCOLCHR_CUR_3 INTO 
                                                    :MEDCCOLCHR_N.FACTORY,
                                                    :MEDCCOLCHR_N.COL_SET_ID,
                                                    :MEDCCOLCHR_N.COL_SET_VERSION,
                                                    :MEDCCOLCHR_N.CHAR_ID,
...

{
        ...
        case 4:
            /* EXEC SQL FETCH DBC_MEDCCOLCHR_CUR_4 INTO 
                                                    :MEDCCOLCHR_N.FACTORY,
                                                    :MEDCCOLCHR_N.COL_SET_ID,
                                                    :MEDCCOLCHR_N.COL_SET_VERSION,
                                                    :MEDCCOLCHR_N.CHAR_ID,
...

{
        ...
        case 5:
            /* EXEC SQL FETCH DBC_MEDCCOLCHR_CUR_5 INTO 
                                                    :MEDCCOLCHR_N.CHAR_ID,
                                                    :MEDCCOLCHR_N.FACTORY; */ 

{
        ...
        case 6:
            /* EXEC SQL FETCH DBC_MEDCCOLCHR_CUR_6 INTO 
                                                    :MEDCCOLCHR_N.FACTORY,
                                                    :MEDCCOLCHR_N.COL_SET_ID,
                                                    :MEDCCOLCHR_N.COL_SET_VERSION,
                                                    :MEDCCOLCHR_N.CHAR_ID,
...

{
            ...
            sqlstm.sqltdsp = &sqltds;
            sqlstm.iters = (unsigned int  )1;
            sqlstm.offset = (unsigned int  )2389;
            sqlstm.selerr = (unsigned short)1;
            sqlstm.sqlpfmem = (unsigned int  )0;
            sqlstm.cud = sqlcud0;
            sqlstm.sqlest = (unsigned char  *)&sqlca;
        ...
        case 7:
            /* EXEC SQL FETCH DBC_MEDCCOLCHR_CUR_7 INTO 
                                                    :MEDCCOLCHR_N.FACTORY,
                                                    :MEDCCOLCHR_N.COL_SET_ID,
                                                    :MEDCCOLCHR_N.COL_SET_VERSION,
                                                    :MEDCCOLCHR_N.CHAR_ID,
...

{
        ...
        case 8:
            /* EXEC SQL FETCH DBC_MEDCCOLCHR_CUR_8 INTO 
                                                    :MEDCCOLCHR_N.FACTORY,
                                                    :MEDCCOLCHR_N.COL_SET_ID,
                                                    :MEDCCOLCHR_N.COL_SET_VERSION,
                                                    :MEDCCOLCHR_N.CHAR_ID,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_medccolchr", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_medccolchr(int sel_type)
{
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MEDCCOLCHR_CUR_1; */ 

{
        ...
        case 2:
            /* EXEC SQL CLOSE DBC_MEDCCOLCHR_CUR_2; */ 

{
        ...
        case 3:
            /* EXEC SQL CLOSE DBC_MEDCCOLCHR_CUR_3; */ 

{
        ...
        case 4:
            /* EXEC SQL CLOSE DBC_MEDCCOLCHR_CUR_4; */ 

{
        ...
        case 5:
            /* EXEC SQL CLOSE DBC_MEDCCOLCHR_CUR_5; */ 

{
        ...
        case 6:
            /* EXEC SQL CLOSE DBC_MEDCCOLCHR_CUR_6; */ 

{
        ...
        case 7:
            /* EXEC SQL CLOSE DBC_MEDCCOLCHR_CUR_7; */ 

{
        ...
        case 8:
            /* EXEC SQL CLOSE DBC_MEDCCOLCHR_CUR_8; */ 

{
    ...
    DB_stop_query_timer("DBC_close_medccolchr", sel_type);
}


/* Initialize Function */
void DBC_init_medccolchr(struct MEDCCOLCHR_TAG *MEDCCOLCHR)
{
    /* memset by Space */
