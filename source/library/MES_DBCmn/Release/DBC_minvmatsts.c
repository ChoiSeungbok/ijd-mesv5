...
static unsigned int sqlctx = 9122387;
...
"select FACTORY ,MAT_ID ,MAT_VER ,OPER ,QTY_1 ,QTY_2 ,QTY_3 ,ALLOC_QTY ,LAST\
_TRAN_CODE ,LAST_TRAN_TIME ,LAST_HIST_SEQ  from MINVMATSTS where ((FACTORY=:b\
0 and MAT_ID=:b1) and MAT_VER=:b2) order by OPER asc             ";
...
{13,4130,873,0,0,
5,0,0,1,251,0,4,43,0,0,15,4,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,4,0,0,2,
4,0,0,2,4,0,0,2,4,0,0,2,97,0,0,2,97,0,0,2,3,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,
0,0,
80,0,0,2,263,0,4,106,0,0,15,4,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,4,0,0,
2,4,0,0,2,4,0,0,2,4,0,0,2,97,0,0,2,97,0,0,2,3,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,
97,0,0,
155,0,0,3,110,0,4,173,0,0,5,4,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
190,0,0,4,92,0,2,210,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
221,0,0,5,178,0,3,240,0,0,11,11,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,4,0,
0,1,4,0,0,1,4,0,0,1,4,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
280,0,0,6,191,0,5,285,0,0,11,11,0,1,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,97,0,0,
1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
339,0,0,7,217,0,9,343,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,
366,0,0,7,0,0,13,371,0,0,11,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,4,0,0,
2,4,0,0,2,4,0,0,2,4,0,0,2,97,0,0,2,97,0,0,2,3,0,0,
425,0,0,7,0,0,15,412,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_minvmatsts.pc
**    Description : Table Access Function Source File
**    Create date : 2004/12/10 12:11:40
**
...
void DBC_add_null_minvmatsts(struct MINVMATSTS_N_TAG *MINVMATSTS_N, struct MINVMATSTS_TAG *MINVMATSTS);
void DBC_del_null_minvmatsts(struct MINVMATSTS_N_TAG *MINVMATSTS_N, struct MINVMATSTS_TAG *MINVMATSTS);


/* SQL SELECT Function */
void DBC_select_minvmatsts(int sel_type, struct MINVMATSTS_TAG *MINVMATSTS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MINVMATSTS_N_TAG MINVMATSTS_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_minvmatsts(&MINVMATSTS_N, MINVMATSTS);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                         ...
                         LAST_HIST_SEQ
                INTO 
                    :MINVMATSTS_N.FACTORY,
                    :MINVMATSTS_N.MAT_ID,
                    :MINVMATSTS_N.MAT_VER,
                    :MINVMATSTS_N.OPER,
                    :MINVMATSTS_N.QTY_1,
                    :MINVMATSTS_N.QTY_2,
                    :MINVMATSTS_N.QTY_3,
                    :MINVMATSTS_N.ALLOC_QTY,
                    :MINVMATSTS_N.LAST_TRAN_CODE,
                    :MINVMATSTS_N.LAST_TRAN_TIME,
                    :MINVMATSTS_N.LAST_HIST_SEQ
                FROM MINVMATSTS
                WHERE FACTORY = :MINVMATSTS_N.FACTORY
                    AND MAT_ID = :MINVMATSTS_N.MAT_ID
                    AND MAT_VER = :MINVMATSTS_N.MAT_VER
                    AND OPER = :MINVMATSTS_N.OPER; */ 

{
            ...
            sqlstm.stmt = "select FACTORY ,MAT_ID ,MAT_VER ,OPER ,QTY_1 ,QT\
Y_2 ,QTY_3 ,ALLOC_QTY ,LAST_TRAN_CODE ,LAST_TRAN_TIME ,LAST_HIST_SEQ into :b0\
,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10  from MINVMATSTS where (((FACTORY=:\
b0 and MAT_ID=:b1) and MAT_VER=:b2) and OPER=:b3)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MINVMATSTS_N.FACTORY);
            ...
            sqlstm.sqhstv[1] = (         void  *)(MINVMATSTS_N.MAT_ID);
            ...
            sqlstm.sqhstv[2] = (         void  *)&(MINVMATSTS_N.MAT_VER);
            ...
            sqlstm.sqhstv[3] = (         void  *)(MINVMATSTS_N.OPER);
            ...
            sqlstm.sqhstv[4] = (         void  *)&(MINVMATSTS_N.QTY_1);
            ...
            sqlstm.sqhstv[5] = (         void  *)&(MINVMATSTS_N.QTY_2);
            ...
            sqlstm.sqhstv[6] = (         void  *)&(MINVMATSTS_N.QTY_3);
            ...
            sqlstm.sqhstv[7] = (         void  *)&(MINVMATSTS_N.ALLOC_QTY);
            ...
            sqlstm.sqhstv[8] = (         void  *)(MINVMATSTS_N.LAST_TRAN_CODE);
            ...
            sqlstm.sqhstv[9] = (         void  *)(MINVMATSTS_N.LAST_TRAN_TIME);
            ...
            sqlstm.sqhstv[10] = (         void  *)&(MINVMATSTS_N.LAST_HIST_SEQ);
            ...
            sqlstm.sqhstv[11] = (         void  *)(MINVMATSTS_N.FACTORY);
            ...
            sqlstm.sqhstv[12] = (         void  *)(MINVMATSTS_N.MAT_ID);
            ...
            sqlstm.sqhstv[13] = (         void  *)&(MINVMATSTS_N.MAT_VER);
            ...
            sqlstm.sqhstv[14] = (         void  *)(MINVMATSTS_N.OPER);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_minvmatsts(&MINVMATSTS_N, MINVMATSTS);
    }
    DB_stop_query_timer("DBC_select_minvmatsts", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_minvmatsts_for_update(int sel_type, struct MINVMATSTS_TAG *MINVMATSTS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
Y_2 ,QTY_3 ,ALLOC_QTY ,LAST_TRAN_CODE ,LAST_TRAN_TIME ,LAST_HIST_SEQ into :b0\
,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10  from MINVMATSTS where (((FACTORY=:\
b0 and MAT_ID=:b1) and MAT_VER=:b2) and OPER=:b3) for update ";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_select_minvmatsts_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_minvmatsts_scalar(int sel_type, struct MINVMATSTS_TAG *MINVMATSTS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MINVMATSTS where\
 (((FACTORY=:b1 and MAT_ID=:b2) and MAT_VER=:b3) and OPER=:b4)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MINVMATSTS_N.FACTORY);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MINVMATSTS_N.MAT_ID);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)&(MINVMATSTS_N.MAT_VER);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MINVMATSTS_N.OPER);
    ...
    DB_stop_query_timer("DBC_select_minvmatsts_scalar", sel_type);
    return d_value;
}


/* SQL DELETE Function */
void DBC_delete_minvmatsts(int sel_type, struct MINVMATSTS_TAG *MINVMATSTS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MINVMATSTS
                WHERE FACTORY = :MINVMATSTS_N.FACTORY
                    AND MAT_ID = :MINVMATSTS_N.MAT_ID
                    AND MAT_VER = :MINVMATSTS_N.MAT_VER
                    AND OPER = :MINVMATSTS_N.OPER; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MINVMATSTS  where (((FACTORY=:b0 an\
d MAT_ID=:b1) and MAT_VER=:b2) and OPER=:b3)";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_delete_minvmatsts", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_minvmatsts(struct MINVMATSTS_TAG *MINVMATSTS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MINVMATSTS (
                    FACTORY,
                    MAT_ID,
                    MAT_VER,
                    OPER,
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MINVMATSTS (FACTORY,MAT_ID,MAT_VER,OPER,QTY_\
1,QTY_2,QTY_3,ALLOC_QTY,LAST_TRAN_CODE,LAST_TRAN_TIME,LAST_HIST_SEQ) values (\
:b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10)";
    ...
    DB_stop_query_timer("DBC_insert_minvmatsts", 0);
}


/* SQL UPDATE Function */
void DBC_update_minvmatsts(int sel_type, struct MINVMATSTS_TAG *MINVMATSTS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MINVMATSTS SET
                    QTY_1 = :MINVMATSTS_N.QTY_1,
                    QTY_2 = :MINVMATSTS_N.QTY_2,
                    QTY_3 = :MINVMATSTS_N.QTY_3,
                    ALLOC_QTY = :MINVMATSTS_N.ALLOC_QTY,
                    LAST_TRAN_CODE = :MINVMATSTS_N.LAST_TRAN_CODE,
                    LAST_TRAN_TIME = :MINVMATSTS_N.LAST_TRAN_TIME,
                    LAST_HIST_SEQ = :MINVMATSTS_N.LAST_HIST_SEQ
                WHERE FACTORY = :MINVMATSTS_N.FACTORY
                    AND MAT_ID = :MINVMATSTS_N.MAT_ID
                    AND MAT_VER = :MINVMATSTS_N.MAT_VER
                    AND OPER = :MINVMATSTS_N.OPER; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MINVMATSTS  set QTY_1=:b0,QTY_2=:b1,QTY_3\
=:b2,ALLOC_QTY=:b3,LAST_TRAN_CODE=:b4,LAST_TRAN_TIME=:b5,LAST_HIST_SEQ=:b6 wh\
ere (((FACTORY=:b7 and MAT_ID=:b8) and MAT_VER=:b9) and OPER=:b10)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)&(MINVMATSTS_N.QTY_1);
            sqlstm.sqhstl[0] = (unsigned int  )sizeof(double);
            sqlstm.sqhsts[0] = (         int  )0;
            sqlstm.sqindv[0] = (         void  *)0;
            sqlstm.sqinds[0] = (         int  )0;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)&(MINVMATSTS_N.QTY_2);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)&(MINVMATSTS_N.QTY_3);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)&(MINVMATSTS_N.ALLOC_QTY);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MINVMATSTS_N.LAST_TRAN_CODE);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MINVMATSTS_N.LAST_TRAN_TIME);
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)&(MINVMATSTS_N.LAST_HIST_SEQ);
            ...
            sqlstm.sqadto[6] = (unsigned short )0;
            sqlstm.sqtdso[6] = (unsigned short )0;
            sqlstm.sqhstv[7] = (         void  *)(MINVMATSTS_N.FACTORY);
            ...
            sqlstm.sqadto[7] = (unsigned short )0;
            sqlstm.sqtdso[7] = (unsigned short )0;
            sqlstm.sqhstv[8] = (         void  *)(MINVMATSTS_N.MAT_ID);
            ...
            sqlstm.sqadto[8] = (unsigned short )0;
            sqlstm.sqtdso[8] = (unsigned short )0;
            sqlstm.sqhstv[9] = (         void  *)&(MINVMATSTS_N.MAT_VER);
            ...
            sqlstm.sqadto[9] = (unsigned short )0;
            sqlstm.sqtdso[9] = (unsigned short )0;
            sqlstm.sqhstv[10] = (         void  *)(MINVMATSTS_N.OPER);
    ...
    DB_stop_query_timer("DBC_update_minvmatsts", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_minvmatsts(int sel_type, struct MINVMATSTS_TAG *MINVMATSTS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MINVMATSTS_CUR_1 CURSOR FOR
                SELECT 
                    FACTORY,
                    MAT_ID,
                    MAT_VER,
            ...
            /* EXEC SQL OPEN DBC_MINVMATSTS_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_open_minvmatsts", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_minvmatsts(int sel_type, struct MINVMATSTS_TAG *MINVMATSTS)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MINVMATSTS_CUR_1 INTO 
                                                    :MINVMATSTS_N.FACTORY,
                                                    :MINVMATSTS_N.MAT_ID,
                                                    :MINVMATSTS_N.MAT_VER,
                                                    :MINVMATSTS_N.OPER,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_minvmatsts", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_minvmatsts(int sel_type)
{
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MINVMATSTS_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_close_minvmatsts", sel_type);
}


/* Initialize Function */
void DBC_init_minvmatsts(struct MINVMATSTS_TAG *MINVMATSTS)
{
    /* memset by Space */
    memset(MINVMATSTS, ' ', sizeof(struct MINVMATSTS_TAG));
    
    MINVMATSTS->MAT_VER = 0;
    MINVMATSTS->QTY_1 = 0;
    MINVMATSTS->QTY_2 = 0;
    MINVMATSTS->QTY_3 = 0;
    MINVMATSTS->ALLOC_QTY = 0;
    MINVMATSTS->LAST_HIST_SEQ = 0;
}
...
{
    /* memset by NULL */
    memset(MINVMATSTS_N, '\0', sizeof(struct MINVMATSTS_N_TAG));
    
    MEMCPY_AN(MINVMATSTS_N->FACTORY, MINVMATSTS->FACTORY, sizeof(MINVMATSTS->FACTORY));
    MEMCPY_AN(MINVMATSTS_N->MAT_ID, MINVMATSTS->MAT_ID, sizeof(MINVMATSTS->MAT_ID));
    MINVMATSTS_N->MAT_VER = MINVMATSTS->MAT_VER;
    MEMCPY_AN(MINVMATSTS_N->OPER, MINVMATSTS->OPER, sizeof(MINVMATSTS->OPER));
    MINVMATSTS_N->QTY_1 = MINVMATSTS->QTY_1;
    MINVMATSTS_N->QTY_2 = MINVMATSTS->QTY_2;
    MINVMATSTS_N->QTY_3 = MINVMATSTS->QTY_3;
    MINVMATSTS_N->ALLOC_QTY = MINVMATSTS->ALLOC_QTY;
    MEMCPY_AN(MINVMATSTS_N->LAST_TRAN_CODE, MINVMATSTS->LAST_TRAN_CODE, sizeof(MINVMATSTS->LAST_TRAN_CODE));
    MEMCPY_AN(MINVMATSTS_N->LAST_TRAN_TIME, MINVMATSTS->LAST_TRAN_TIME, sizeof(MINVMATSTS->LAST_TRAN_TIME));
    MINVMATSTS_N->LAST_HIST_SEQ = MINVMATSTS->LAST_HIST_SEQ;
}
...
void DBC_del_null_minvmatsts(struct MINVMATSTS_N_TAG *MINVMATSTS_N, struct MINVMATSTS_TAG *MINVMATSTS)
{
    MEMCPY_DN(MINVMATSTS->FACTORY, MINVMATSTS_N->FACTORY, sizeof(MINVMATSTS->FACTORY));
    MEMCPY_DN(MINVMATSTS->MAT_ID, MINVMATSTS_N->MAT_ID, sizeof(MINVMATSTS->MAT_ID));
    MINVMATSTS->MAT_VER = MINVMATSTS_N->MAT_VER;
    MEMCPY_DN(MINVMATSTS->OPER, MINVMATSTS_N->OPER, sizeof(MINVMATSTS->OPER));
    MINVMATSTS->QTY_1 = MINVMATSTS_N->QTY_1;
    MINVMATSTS->QTY_2 = MINVMATSTS_N->QTY_2;
    MINVMATSTS->QTY_3 = MINVMATSTS_N->QTY_3;
    MINVMATSTS->ALLOC_QTY = MINVMATSTS_N->ALLOC_QTY;
    MEMCPY_DN(MINVMATSTS->LAST_TRAN_CODE, MINVMATSTS_N->LAST_TRAN_CODE, sizeof(MINVMATSTS->LAST_TRAN_CODE));
    MEMCPY_DN(MINVMATSTS->LAST_TRAN_TIME, MINVMATSTS_N->LAST_TRAN_TIME, sizeof(MINVMATSTS->LAST_TRAN_TIME));
    MINVMATSTS->LAST_HIST_SEQ = MINVMATSTS_N->LAST_HIST_SEQ;
}
