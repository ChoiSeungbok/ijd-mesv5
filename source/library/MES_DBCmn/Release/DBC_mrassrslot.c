...
static unsigned int sqlctx = 9129323;
...
"select FACTORY ,RES_ID ,SUBRES_ID ,LOT_ID ,SUBLOT_ID ,PARENTS_SUBRES_ID ,EV\
ENT_ID ,TRAN_TIME ,CREATE_USER_ID ,CREATE_TIME ,UPDATE_USER_ID ,UPDATE_TIME  \
from MRASSRSLOT  order by FACTORY asc ,RES_ID asc ,SUBRES_ID asc ,LOT_ID asc \
,SUBLOT_ID asc             ";
...
{13,4130,873,0,0,
5,0,0,1,314,0,4,44,0,0,17,5,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,
0,1,97,0,0,1,97,0,0,1,97,0,0,
88,0,0,2,326,0,4,110,0,0,17,5,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,
0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,
0,0,1,97,0,0,1,97,0,0,1,97,0,0,
171,0,0,3,134,0,4,179,0,0,6,5,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,
0,1,97,0,0,
210,0,0,4,116,0,2,217,0,0,5,5,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,
0,
245,0,0,5,216,0,3,248,0,0,12,12,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,
0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
308,0,0,6,235,0,5,295,0,0,12,12,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,
0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
371,0,0,7,256,0,9,356,0,0,0,0,0,1,0,
386,0,0,7,0,0,13,390,0,0,12,0,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,
0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
449,0,0,7,0,0,15,432,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_mrassrslot.pc
**    DB Type     : SUN Oracle
...
void DBC_add_null_mrassrslot(struct MRASSRSLOT_N_TAG *MRASSRSLOT_N, struct MRASSRSLOT_TAG *MRASSRSLOT);
void DBC_del_null_mrassrslot(struct MRASSRSLOT_N_TAG *MRASSRSLOT_N, struct MRASSRSLOT_TAG *MRASSRSLOT);


/* SQL SELECT Function */
void DBC_select_mrassrslot(int sel_type, struct MRASSRSLOT_TAG *MRASSRSLOT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MRASSRSLOT_N_TAG MRASSRSLOT_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_mrassrslot(&MRASSRSLOT_N, MRASSRSLOT);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                         ...
                         UPDATE_TIME
                INTO 
                    :MRASSRSLOT_N.FACTORY,
                    :MRASSRSLOT_N.RES_ID,
                    :MRASSRSLOT_N.SUBRES_ID,
                    :MRASSRSLOT_N.LOT_ID,
                    :MRASSRSLOT_N.SUBLOT_ID,
                    :MRASSRSLOT_N.PARENTS_SUBRES_ID,
                    :MRASSRSLOT_N.EVENT_ID,
                    :MRASSRSLOT_N.TRAN_TIME,
                    :MRASSRSLOT_N.CREATE_USER_ID,
                    :MRASSRSLOT_N.CREATE_TIME,
                    :MRASSRSLOT_N.UPDATE_USER_ID,
                    :MRASSRSLOT_N.UPDATE_TIME
                FROM MRASSRSLOT
                WHERE FACTORY = :MRASSRSLOT_N.FACTORY
                    AND RES_ID = :MRASSRSLOT_N.RES_ID
                    AND SUBRES_ID = :MRASSRSLOT_N.SUBRES_ID
                    AND LOT_ID = :MRASSRSLOT_N.LOT_ID
                    AND SUBLOT_ID = :MRASSRSLOT_N.SUBLOT_ID; */ 

{
            ...
            sqlstm.stmt = "select FACTORY ,RES_ID ,SUBRES_ID ,LOT_ID ,SUBLO\
T_ID ,PARENTS_SUBRES_ID ,EVENT_ID ,TRAN_TIME ,CREATE_USER_ID ,CREATE_TIME ,UP\
DATE_USER_ID ,UPDATE_TIME into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:\
b11  from MRASSRSLOT where ((((FACTORY=:b0 and RES_ID=:b1) and SUBRES_ID=:b2)\
 and LOT_ID=:b3) and SUBLOT_ID=:b4)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MRASSRSLOT_N.FACTORY);
            ...
            sqlstm.sqhstv[1] = (         void  *)(MRASSRSLOT_N.RES_ID);
            ...
            sqlstm.sqhstv[2] = (         void  *)(MRASSRSLOT_N.SUBRES_ID);
            ...
            sqlstm.sqhstv[3] = (         void  *)(MRASSRSLOT_N.LOT_ID);
            ...
            sqlstm.sqhstv[4] = (         void  *)(MRASSRSLOT_N.SUBLOT_ID);
            ...
            sqlstm.sqhstv[5] = (         void  *)(MRASSRSLOT_N.PARENTS_SUBRES_ID);
            ...
            sqlstm.sqhstv[6] = (         void  *)(MRASSRSLOT_N.EVENT_ID);
            ...
            sqlstm.sqhstv[7] = (         void  *)(MRASSRSLOT_N.TRAN_TIME);
            ...
            sqlstm.sqhstv[8] = (         void  *)(MRASSRSLOT_N.CREATE_USER_ID);
            ...
            sqlstm.sqhstv[9] = (         void  *)(MRASSRSLOT_N.CREATE_TIME);
            ...
            sqlstm.sqhstv[10] = (         void  *)(MRASSRSLOT_N.UPDATE_USER_ID);
            ...
            sqlstm.sqhstv[11] = (         void  *)(MRASSRSLOT_N.UPDATE_TIME);
            ...
            sqlstm.sqhstv[12] = (         void  *)(MRASSRSLOT_N.FACTORY);
            ...
            sqlstm.sqhstv[13] = (         void  *)(MRASSRSLOT_N.RES_ID);
            ...
            sqlstm.sqhstv[14] = (         void  *)(MRASSRSLOT_N.SUBRES_ID);
            ...
            sqlstm.sqhstv[15] = (         void  *)(MRASSRSLOT_N.LOT_ID);
            ...
            sqlstm.sqhstv[16] = (         void  *)(MRASSRSLOT_N.SUBLOT_ID);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_mrassrslot(&MRASSRSLOT_N, MRASSRSLOT);
    }
    DB_stop_query_timer("DBC_select_mrassrslot", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_mrassrslot_for_update(int sel_type, struct MRASSRSLOT_TAG *MRASSRSLOT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
DATE_USER_ID ,UPDATE_TIME into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:\
b11  from MRASSRSLOT where ((((FACTORY=:b0 and RES_ID=:b1) and SUBRES_ID=:b2)\
 and LOT_ID=:b3) and SUBLOT_ID=:b4) for update ";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_select_mrassrslot_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_mrassrslot_scalar(int sel_type, struct MRASSRSLOT_TAG *MRASSRSLOT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MRASSRSLOT where\
 ((((FACTORY=:b1 and RES_ID=:b2) and SUBRES_ID=:b3) and LOT_ID=:b4) and SUBLO\
T_ID=:b5)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MRASSRSLOT_N.FACTORY);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MRASSRSLOT_N.RES_ID);
            sqlstm.sqhstl[2] = (unsigned int  )21;
            sqlstm.sqhsts[2] = (         int  )0;
            sqlstm.sqindv[2] = (         void  *)0;
            sqlstm.sqinds[2] = (         int  )0;
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MRASSRSLOT_N.SUBRES_ID);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MRASSRSLOT_N.LOT_ID);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MRASSRSLOT_N.SUBLOT_ID);
    ...
    DB_stop_query_timer("DBC_select_mrassrslot_scalar", sel_type);
    return d_value;
}


/* SQL DELETE Function */
void DBC_delete_mrassrslot(int sel_type, struct MRASSRSLOT_TAG *MRASSRSLOT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MRASSRSLOT
                WHERE FACTORY = :MRASSRSLOT_N.FACTORY
                    AND RES_ID = :MRASSRSLOT_N.RES_ID
                    AND SUBRES_ID = :MRASSRSLOT_N.SUBRES_ID
                    AND LOT_ID = :MRASSRSLOT_N.LOT_ID
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MRASSRSLOT  where ((((FACTORY=:b0 a\
nd RES_ID=:b1) and SUBRES_ID=:b2) and LOT_ID=:b3) and SUBLOT_ID=:b4)";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_delete_mrassrslot", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_mrassrslot(struct MRASSRSLOT_TAG *MRASSRSLOT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MRASSRSLOT (
                    FACTORY,
                    RES_ID,
                    SUBRES_ID,
                    LOT_ID,
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MRASSRSLOT (FACTORY,RES_ID,SUBRES_ID,LOT_ID,\
SUBLOT_ID,PARENTS_SUBRES_ID,EVENT_ID,TRAN_TIME,CREATE_USER_ID,CREATE_TIME,UPD\
...
,:b11)";
    ...
    DB_stop_query_timer("DBC_insert_mrassrslot", 0);
}


/* SQL UPDATE Function */
void DBC_update_mrassrslot(int sel_type, struct MRASSRSLOT_TAG *MRASSRSLOT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MRASSRSLOT SET
                    PARENTS_SUBRES_ID = :MRASSRSLOT_N.PARENTS_SUBRES_ID,
                    EVENT_ID = :MRASSRSLOT_N.EVENT_ID,
                    TRAN_TIME = :MRASSRSLOT_N.TRAN_TIME,
                    CREATE_USER_ID = :MRASSRSLOT_N.CREATE_USER_ID,
                    CREATE_TIME = :MRASSRSLOT_N.CREATE_TIME,
                    UPDATE_USER_ID = :MRASSRSLOT_N.UPDATE_USER_ID,
                    UPDATE_TIME = :MRASSRSLOT_N.UPDATE_TIME
                WHERE FACTORY = :MRASSRSLOT_N.FACTORY
                    AND RES_ID = :MRASSRSLOT_N.RES_ID
                    AND SUBRES_ID = :MRASSRSLOT_N.SUBRES_ID
                    AND LOT_ID = :MRASSRSLOT_N.LOT_ID
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MRASSRSLOT  set PARENTS_SUBRES_ID=:b0,EVE\
NT_ID=:b1,TRAN_TIME=:b2,CREATE_USER_ID=:b3,CREATE_TIME=:b4,UPDATE_USER_ID=:b5\
,UPDATE_TIME=:b6 where ((((FACTORY=:b7 and RES_ID=:b8) and SUBRES_ID=:b9) and\
 LOT_ID=:b10) and SUBLOT_ID=:b11)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MRASSRSLOT_N.PARENTS_SUBRES_ID);
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MRASSRSLOT_N.EVENT_ID);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MRASSRSLOT_N.TRAN_TIME);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MRASSRSLOT_N.CREATE_USER_ID);
            sqlstm.sqhstl[3] = (unsigned int  )21;
            sqlstm.sqhsts[3] = (         int  )0;
            sqlstm.sqindv[3] = (         void  *)0;
            sqlstm.sqinds[3] = (         int  )0;
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MRASSRSLOT_N.CREATE_TIME);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MRASSRSLOT_N.UPDATE_USER_ID);
            sqlstm.sqhstl[5] = (unsigned int  )21;
            sqlstm.sqhsts[5] = (         int  )0;
            sqlstm.sqindv[5] = (         void  *)0;
            sqlstm.sqinds[5] = (         int  )0;
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)(MRASSRSLOT_N.UPDATE_TIME);
            ...
            sqlstm.sqadto[6] = (unsigned short )0;
            sqlstm.sqtdso[6] = (unsigned short )0;
            sqlstm.sqhstv[7] = (         void  *)(MRASSRSLOT_N.FACTORY);
            ...
            sqlstm.sqadto[7] = (unsigned short )0;
            sqlstm.sqtdso[7] = (unsigned short )0;
            sqlstm.sqhstv[8] = (         void  *)(MRASSRSLOT_N.RES_ID);
            sqlstm.sqhstl[8] = (unsigned int  )21;
            sqlstm.sqhsts[8] = (         int  )0;
            sqlstm.sqindv[8] = (         void  *)0;
            sqlstm.sqinds[8] = (         int  )0;
            ...
            sqlstm.sqadto[8] = (unsigned short )0;
            sqlstm.sqtdso[8] = (unsigned short )0;
            sqlstm.sqhstv[9] = (         void  *)(MRASSRSLOT_N.SUBRES_ID);
            ...
            sqlstm.sqadto[9] = (unsigned short )0;
            sqlstm.sqtdso[9] = (unsigned short )0;
            sqlstm.sqhstv[10] = (         void  *)(MRASSRSLOT_N.LOT_ID);
            ...
            sqlstm.sqadto[10] = (unsigned short )0;
            sqlstm.sqtdso[10] = (unsigned short )0;
            sqlstm.sqhstv[11] = (         void  *)(MRASSRSLOT_N.SUBLOT_ID);
    ...
    DB_stop_query_timer("DBC_update_mrassrslot", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_mrassrslot(int sel_type, struct MRASSRSLOT_TAG *MRASSRSLOT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MRASSRSLOT_CUR_1 CURSOR FOR
                SELECT 
                    FACTORY,
                    RES_ID,
                    SUBRES_ID,
            ...
            /* EXEC SQL OPEN DBC_MRASSRSLOT_CUR_1; */ 

{
        ...
        case 51:
            DB_error_code = 9999;
            memset(DB_error_msg, ' ', sizeof(DB_error_msg));
            memcpy(DB_error_msg, "DBC_open_res_reslot_list Case 1 Used", 34);
            break;
    ...
    DB_stop_query_timer("DBC_open_mrassrslot", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_mrassrslot(int sel_type, struct MRASSRSLOT_TAG *MRASSRSLOT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MRASSRSLOT_CUR_1 INTO 
                                                    :MRASSRSLOT_N.FACTORY,
                                                    :MRASSRSLOT_N.RES_ID,
                                                    :MRASSRSLOT_N.SUBRES_ID,
                                                    :MRASSRSLOT_N.LOT_ID,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_mrassrslot", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_mrassrslot(int sel_type)
{
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MRASSRSLOT_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_close_mrassrslot", sel_type);
}


/* Initialize Function */
void DBC_init_mrassrslot(struct MRASSRSLOT_TAG *MRASSRSLOT)
{
    /* memset by Space */
    memset(MRASSRSLOT, ' ', sizeof(struct MRASSRSLOT_TAG));
...
{
    /* memset by NULL */
    memset(MRASSRSLOT_N, '\0', sizeof(struct MRASSRSLOT_N_TAG));
    
    MEMCPY_AN(MRASSRSLOT_N->FACTORY, MRASSRSLOT->FACTORY, sizeof(MRASSRSLOT->FACTORY));
    MEMCPY_AN(MRASSRSLOT_N->RES_ID, MRASSRSLOT->RES_ID, sizeof(MRASSRSLOT->RES_ID));
    MEMCPY_AN(MRASSRSLOT_N->SUBRES_ID, MRASSRSLOT->SUBRES_ID, sizeof(MRASSRSLOT->SUBRES_ID));
    MEMCPY_AN(MRASSRSLOT_N->LOT_ID, MRASSRSLOT->LOT_ID, sizeof(MRASSRSLOT->LOT_ID));
    MEMCPY_AN(MRASSRSLOT_N->SUBLOT_ID, MRASSRSLOT->SUBLOT_ID, sizeof(MRASSRSLOT->SUBLOT_ID));
    MEMCPY_AN(MRASSRSLOT_N->PARENTS_SUBRES_ID, MRASSRSLOT->PARENTS_SUBRES_ID, sizeof(MRASSRSLOT->PARENTS_SUBRES_ID));
    MEMCPY_AN(MRASSRSLOT_N->EVENT_ID, MRASSRSLOT->EVENT_ID, sizeof(MRASSRSLOT->EVENT_ID));
    MEMCPY_AN(MRASSRSLOT_N->TRAN_TIME, MRASSRSLOT->TRAN_TIME, sizeof(MRASSRSLOT->TRAN_TIME));
    MEMCPY_AN(MRASSRSLOT_N->CREATE_USER_ID, MRASSRSLOT->CREATE_USER_ID, sizeof(MRASSRSLOT->CREATE_USER_ID));
    MEMCPY_AN(MRASSRSLOT_N->CREATE_TIME, MRASSRSLOT->CREATE_TIME, sizeof(MRASSRSLOT->CREATE_TIME));
    MEMCPY_AN(MRASSRSLOT_N->UPDATE_USER_ID, MRASSRSLOT->UPDATE_USER_ID, sizeof(MRASSRSLOT->UPDATE_USER_ID));
    MEMCPY_AN(MRASSRSLOT_N->UPDATE_TIME, MRASSRSLOT->UPDATE_TIME, sizeof(MRASSRSLOT->UPDATE_TIME));
}
...
void DBC_del_null_mrassrslot(struct MRASSRSLOT_N_TAG *MRASSRSLOT_N, struct MRASSRSLOT_TAG *MRASSRSLOT)
{
    MEMCPY_DN(MRASSRSLOT->FACTORY, MRASSRSLOT_N->FACTORY, sizeof(MRASSRSLOT->FACTORY));
    MEMCPY_DN(MRASSRSLOT->RES_ID, MRASSRSLOT_N->RES_ID, sizeof(MRASSRSLOT->RES_ID));
    MEMCPY_DN(MRASSRSLOT->SUBRES_ID, MRASSRSLOT_N->SUBRES_ID, sizeof(MRASSRSLOT->SUBRES_ID));
    MEMCPY_DN(MRASSRSLOT->LOT_ID, MRASSRSLOT_N->LOT_ID, sizeof(MRASSRSLOT->LOT_ID));
    MEMCPY_DN(MRASSRSLOT->SUBLOT_ID, MRASSRSLOT_N->SUBLOT_ID, sizeof(MRASSRSLOT->SUBLOT_ID));
    MEMCPY_DN(MRASSRSLOT->PARENTS_SUBRES_ID, MRASSRSLOT_N->PARENTS_SUBRES_ID, sizeof(MRASSRSLOT->PARENTS_SUBRES_ID));
    MEMCPY_DN(MRASSRSLOT->EVENT_ID, MRASSRSLOT_N->EVENT_ID, sizeof(MRASSRSLOT->EVENT_ID));
    MEMCPY_DN(MRASSRSLOT->TRAN_TIME, MRASSRSLOT_N->TRAN_TIME, sizeof(MRASSRSLOT->TRAN_TIME));
    MEMCPY_DN(MRASSRSLOT->CREATE_USER_ID, MRASSRSLOT_N->CREATE_USER_ID, sizeof(MRASSRSLOT->CREATE_USER_ID));
    MEMCPY_DN(MRASSRSLOT->CREATE_TIME, MRASSRSLOT_N->CREATE_TIME, sizeof(MRASSRSLOT->CREATE_TIME));
    MEMCPY_DN(MRASSRSLOT->UPDATE_USER_ID, MRASSRSLOT_N->UPDATE_USER_ID, sizeof(MRASSRSLOT->UPDATE_USER_ID));
    MEMCPY_DN(MRASSRSLOT->UPDATE_TIME, MRASSRSLOT_N->UPDATE_TIME, sizeof(MRASSRSLOT->UPDATE_TIME));
}
