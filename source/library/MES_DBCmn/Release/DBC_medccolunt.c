...
static unsigned int sqlctx = 9092923;
...
"select FACTORY ,COL_SET_ID ,COL_SET_VERSION ,CHAR_ID ,UNIT_SEQ_NUM ,NULL_FL\
AG ,DEF_UNIT_ID ,CREATE_USER_ID ,CREATE_TIME  from MEDCCOLUNT where (((FACTOR\
Y=:b0 and COL_SET_ID=:b1) and COL_SET_VERSION=:b2) and CHAR_ID=:b3) order by \
UNIT_SEQ_NUM asc             ";
...
{13,4130,873,0,0,
5,0,0,1,283,0,4,43,0,0,14,5,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,0,2,
97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,
76,0,0,2,295,0,4,103,0,0,14,5,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,
147,0,0,3,148,0,4,166,0,0,6,5,0,1,0,2,4,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
1,3,0,0,
186,0,0,4,130,0,2,204,0,0,5,5,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,
221,0,0,5,107,0,2,213,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
252,0,0,6,89,0,2,221,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,
279,0,0,7,174,0,3,250,0,0,9,9,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,
1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
330,0,0,8,193,0,5,291,0,0,9,9,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,0,1,97,0,
0,1,97,0,0,1,3,0,0,1,97,0,0,1,3,0,0,
381,0,0,9,258,0,9,346,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,
412,0,0,9,0,0,13,374,0,0,9,0,0,1,0,2,97,0,0,2,97,0,0,2,3,0,0,2,97,0,0,2,3,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
463,0,0,9,0,0,15,413,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_medccolunt.pc
...
void DBC_add_null_medccolunt(struct MEDCCOLUNT_N_TAG *MEDCCOLUNT_N, struct MEDCCOLUNT_TAG *MEDCCOLUNT);
void DBC_del_null_medccolunt(struct MEDCCOLUNT_N_TAG *MEDCCOLUNT_N, struct MEDCCOLUNT_TAG *MEDCCOLUNT);


/* SQL SELECT Function */
void DBC_select_medccolunt(int sel_type, struct MEDCCOLUNT_TAG *MEDCCOLUNT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MEDCCOLUNT_N_TAG MEDCCOLUNT_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_medccolunt(&MEDCCOLUNT_N, MEDCCOLUNT);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                         ...
                         CREATE_TIME
                INTO 
                    :MEDCCOLUNT_N.FACTORY,
                    :MEDCCOLUNT_N.COL_SET_ID,
                    :MEDCCOLUNT_N.COL_SET_VERSION,
                    :MEDCCOLUNT_N.CHAR_ID,
                    :MEDCCOLUNT_N.UNIT_SEQ_NUM,
                    :MEDCCOLUNT_N.NULL_FLAG,
                    :MEDCCOLUNT_N.DEF_UNIT_ID,
                    :MEDCCOLUNT_N.CREATE_USER_ID,
                    :MEDCCOLUNT_N.CREATE_TIME
                FROM MEDCCOLUNT
                WHERE FACTORY = :MEDCCOLUNT_N.FACTORY
                    AND COL_SET_ID = :MEDCCOLUNT_N.COL_SET_ID
                    AND COL_SET_VERSION = :MEDCCOLUNT_N.COL_SET_VERSION
                    AND CHAR_ID = :MEDCCOLUNT_N.CHAR_ID
                    AND UNIT_SEQ_NUM = :MEDCCOLUNT_N.UNIT_SEQ_NUM; */ 
...
R_ID ,UNIT_SEQ_NUM ,NULL_FLAG ,DEF_UNIT_ID ,CREATE_USER_ID ,CREATE_TIME into \
:b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8  from MEDCCOLUNT where ((((FACTORY=:b0 an\
d COL_SET_ID=:b1) and COL_SET_VERSION=:b2) and CHAR_ID=:b3) and UNIT_SEQ_NUM=\
:b4)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MEDCCOLUNT_N.FACTORY);
            ...
            sqlstm.sqhstv[1] = (         void  *)(MEDCCOLUNT_N.COL_SET_ID);
            ...
            sqlstm.sqhstv[2] = (         void  *)&(MEDCCOLUNT_N.COL_SET_VERSION);
            ...
            sqlstm.sqhstv[3] = (         void  *)(MEDCCOLUNT_N.CHAR_ID);
            ...
            sqlstm.sqhstv[4] = (         void  *)&(MEDCCOLUNT_N.UNIT_SEQ_NUM);
            ...
            sqlstm.sqhstv[5] = (         void  *)(MEDCCOLUNT_N.NULL_FLAG);
            ...
            sqlstm.sqhstv[6] = (         void  *)(MEDCCOLUNT_N.DEF_UNIT_ID);
            ...
            sqlstm.sqhstv[7] = (         void  *)(MEDCCOLUNT_N.CREATE_USER_ID);
            ...
            sqlstm.sqhstv[8] = (         void  *)(MEDCCOLUNT_N.CREATE_TIME);
            ...
            sqlstm.sqhstv[9] = (         void  *)(MEDCCOLUNT_N.FACTORY);
            ...
            sqlstm.sqhstv[10] = (         void  *)(MEDCCOLUNT_N.COL_SET_ID);
            ...
            sqlstm.sqhstv[11] = (         void  *)&(MEDCCOLUNT_N.COL_SET_VERSION);
            ...
            sqlstm.sqhstv[12] = (         void  *)(MEDCCOLUNT_N.CHAR_ID);
            ...
            sqlstm.sqhstv[13] = (         void  *)&(MEDCCOLUNT_N.UNIT_SEQ_NUM);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_medccolunt(&MEDCCOLUNT_N, MEDCCOLUNT);
    }
    DB_stop_query_timer("DBC_select_medccolunt", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_medccolunt_for_update(int sel_type, struct MEDCCOLUNT_TAG *MEDCCOLUNT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
:b4) for update ";
    ...
    DB_stop_query_timer("DBC_select_medccolunt_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_medccolunt_scalar(int sel_type, struct MEDCCOLUNT_TAG *MEDCCOLUNT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MEDCCOLUNT where\
 ((((FACTORY=:b1 and COL_SET_ID=:b2) and COL_SET_VERSION=:b3) and CHAR_ID=:b4\
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MEDCCOLUNT_N.FACTORY);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MEDCCOLUNT_N.COL_SET_ID);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)&(MEDCCOLUNT_N.COL_SET_VERSION);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MEDCCOLUNT_N.CHAR_ID);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)&(MEDCCOLUNT_N.UNIT_SEQ_NUM);
    ...
    DB_stop_query_timer("DBC_select_medccolunt_scalar", sel_type);
    return d_value;
}


/* SQL DELETE Function */
void DBC_delete_medccolunt(int sel_type, struct MEDCCOLUNT_TAG *MEDCCOLUNT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MEDCCOLUNT
                WHERE FACTORY = :MEDCCOLUNT_N.FACTORY
                    AND COL_SET_ID = :MEDCCOLUNT_N.COL_SET_ID
                    AND COL_SET_VERSION = :MEDCCOLUNT_N.COL_SET_VERSION
                    AND CHAR_ID = :MEDCCOLUNT_N.CHAR_ID
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MEDCCOLUNT  where ((((FACTORY=:b0 a\
nd COL_SET_ID=:b1) and COL_SET_VERSION=:b2) and CHAR_ID=:b3) and UNIT_SEQ_NUM\
=:b4)";
            sqlstm.iters = (unsigned int  )1;
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MEDCCOLUNT  where (((FACTORY=:b0 an\
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MEDCCOLUNT  where ((FACTORY=:b0 and\
 COL_SET_ID=:b1) and COL_SET_VERSION=:b2)";
    ...
    DB_stop_query_timer("DBC_delete_medccolunt", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_medccolunt(struct MEDCCOLUNT_TAG *MEDCCOLUNT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MEDCCOLUNT (
                    FACTORY,
                    COL_SET_ID,
                    COL_SET_VERSION,
                    CHAR_ID,
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MEDCCOLUNT (FACTORY,COL_SET_ID,COL_SET_VERSI\
ON,CHAR_ID,UNIT_SEQ_NUM,NULL_FLAG,DEF_UNIT_ID,CREATE_USER_ID,CREATE_TIME) val\
ues (:b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8)";
    sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_insert_medccolunt", 0);
}


/* SQL UPDATE Function */
void DBC_update_medccolunt(int sel_type, struct MEDCCOLUNT_TAG *MEDCCOLUNT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MEDCCOLUNT SET
                    NULL_FLAG = :MEDCCOLUNT_N.NULL_FLAG,
                    DEF_UNIT_ID = :MEDCCOLUNT_N.DEF_UNIT_ID,
                    CREATE_USER_ID = :MEDCCOLUNT_N.CREATE_USER_ID,
                    CREATE_TIME = :MEDCCOLUNT_N.CREATE_TIME
                WHERE FACTORY = :MEDCCOLUNT_N.FACTORY
                    AND COL_SET_ID = :MEDCCOLUNT_N.COL_SET_ID
                    AND COL_SET_VERSION = :MEDCCOLUNT_N.COL_SET_VERSION
                    AND CHAR_ID = :MEDCCOLUNT_N.CHAR_ID
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MEDCCOLUNT  set NULL_FLAG=:b0,DEF_UNIT_ID\
=:b1,CREATE_USER_ID=:b2,CREATE_TIME=:b3 where ((((FACTORY=:b4 and COL_SET_ID=\
:b5) and COL_SET_VERSION=:b6) and CHAR_ID=:b7) and UNIT_SEQ_NUM=:b8)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MEDCCOLUNT_N.NULL_FLAG);
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MEDCCOLUNT_N.DEF_UNIT_ID);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MEDCCOLUNT_N.CREATE_USER_ID);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MEDCCOLUNT_N.CREATE_TIME);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MEDCCOLUNT_N.FACTORY);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MEDCCOLUNT_N.COL_SET_ID);
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)&(MEDCCOLUNT_N.COL_SET_VERSION);
            ...
            sqlstm.sqadto[6] = (unsigned short )0;
            sqlstm.sqtdso[6] = (unsigned short )0;
            sqlstm.sqhstv[7] = (         void  *)(MEDCCOLUNT_N.CHAR_ID);
            ...
            sqlstm.sqadto[7] = (unsigned short )0;
            sqlstm.sqtdso[7] = (unsigned short )0;
            sqlstm.sqhstv[8] = (         void  *)&(MEDCCOLUNT_N.UNIT_SEQ_NUM);
    ...
    DB_stop_query_timer("DBC_update_medccolunt", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_medccolunt(int sel_type, struct MEDCCOLUNT_TAG *MEDCCOLUNT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MEDCCOLUNT_CUR_1 CURSOR FOR
                SELECT 
                    FACTORY,
                    COL_SET_ID,
                    COL_SET_VERSION,
                ...
                WHERE FACTORY = :MEDCCOLUNT_N.FACTORY
                    ...
                    AND COL_SET_VERSION = :MEDCCOLUNT_N.COL_SET_VERSION
                    AND CHAR_ID = :MEDCCOLUNT_N.CHAR_ID
                ORDER BY UNIT_SEQ_NUM ASC; */ 

            /* EXEC SQL OPEN DBC_MEDCCOLUNT_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_open_medccolunt", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_medccolunt(int sel_type, struct MEDCCOLUNT_TAG *MEDCCOLUNT)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MEDCCOLUNT_CUR_1 INTO 
                                                    :MEDCCOLUNT_N.FACTORY,
                                                    :MEDCCOLUNT_N.COL_SET_ID,
                                                    :MEDCCOLUNT_N.COL_SET_VERSION,
                                                    :MEDCCOLUNT_N.CHAR_ID,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_medccolunt", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_medccolunt(int sel_type)
{
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MEDCCOLUNT_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_close_medccolunt", sel_type);
}


/* Initialize Function */
void DBC_init_medccolunt(struct MEDCCOLUNT_TAG *MEDCCOLUNT)
{
    /* memset by Space */
    memset(MEDCCOLUNT, ' ', sizeof(struct MEDCCOLUNT_TAG));
    
    MEDCCOLUNT->COL_SET_VERSION = 0;
    MEDCCOLUNT->UNIT_SEQ_NUM = 0;
}
...
{
    /* memset by NULL */
    memset(MEDCCOLUNT_N, '\0', sizeof(struct MEDCCOLUNT_N_TAG));
    
    MEMCPY_AN(MEDCCOLUNT_N->FACTORY, MEDCCOLUNT->FACTORY, sizeof(MEDCCOLUNT->FACTORY));
    MEMCPY_AN(MEDCCOLUNT_N->COL_SET_ID, MEDCCOLUNT->COL_SET_ID, sizeof(MEDCCOLUNT->COL_SET_ID));
    MEDCCOLUNT_N->COL_SET_VERSION = MEDCCOLUNT->COL_SET_VERSION;
    MEMCPY_AN(MEDCCOLUNT_N->CHAR_ID, MEDCCOLUNT->CHAR_ID, sizeof(MEDCCOLUNT->CHAR_ID));
    MEDCCOLUNT_N->UNIT_SEQ_NUM = MEDCCOLUNT->UNIT_SEQ_NUM;
    MEDCCOLUNT_N->NULL_FLAG[0] = MEDCCOLUNT->NULL_FLAG;
    MEMCPY_AN(MEDCCOLUNT_N->DEF_UNIT_ID, MEDCCOLUNT->DEF_UNIT_ID, sizeof(MEDCCOLUNT->DEF_UNIT_ID));
    MEMCPY_AN(MEDCCOLUNT_N->CREATE_USER_ID, MEDCCOLUNT->CREATE_USER_ID, sizeof(MEDCCOLUNT->CREATE_USER_ID));
    MEMCPY_AN(MEDCCOLUNT_N->CREATE_TIME, MEDCCOLUNT->CREATE_TIME, sizeof(MEDCCOLUNT->CREATE_TIME));
}
...
void DBC_del_null_medccolunt(struct MEDCCOLUNT_N_TAG *MEDCCOLUNT_N, struct MEDCCOLUNT_TAG *MEDCCOLUNT)
{
    MEMCPY_DN(MEDCCOLUNT->FACTORY, MEDCCOLUNT_N->FACTORY, sizeof(MEDCCOLUNT->FACTORY));
    MEMCPY_DN(MEDCCOLUNT->COL_SET_ID, MEDCCOLUNT_N->COL_SET_ID, sizeof(MEDCCOLUNT->COL_SET_ID));
    MEDCCOLUNT->COL_SET_VERSION = MEDCCOLUNT_N->COL_SET_VERSION;
    MEMCPY_DN(MEDCCOLUNT->CHAR_ID, MEDCCOLUNT_N->CHAR_ID, sizeof(MEDCCOLUNT->CHAR_ID));
    MEDCCOLUNT->UNIT_SEQ_NUM = MEDCCOLUNT_N->UNIT_SEQ_NUM;
    MEDCCOLUNT->NULL_FLAG = MEDCCOLUNT_N->NULL_FLAG[0];
    MEMCPY_DN(MEDCCOLUNT->DEF_UNIT_ID, MEDCCOLUNT_N->DEF_UNIT_ID, sizeof(MEDCCOLUNT->DEF_UNIT_ID));
    MEMCPY_DN(MEDCCOLUNT->CREATE_USER_ID, MEDCCOLUNT_N->CREATE_USER_ID, sizeof(MEDCCOLUNT->CREATE_USER_ID));
    MEMCPY_DN(MEDCCOLUNT->CREATE_TIME, MEDCCOLUNT_N->CREATE_TIME, sizeof(MEDCCOLUNT->CREATE_TIME));
}
