...
"select LOT_ID ,HIST_SEQ ,HIST_DEL_FLAG ,FACTORY ,TOOL_ID ,TOOL_HIST_SEQ ,TO\
OL_HIST_DEL_FLAG  from MWIPTOLLTH where ((LOT_ID=:b0 and HIST_SEQ=:b1) and HI\
ST_DEL_FLAG=:b2) order by TOOL_ID asc ,TOOL_HIST_SEQ asc             ";
...
{13,4130,873,0,0,
5,0,0,1,237,0,4,45,0,0,12,5,0,1,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,3,0,0,2,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
68,0,0,2,249,0,4,101,0,0,12,5,0,1,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,
0,2,3,0,0,2,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
131,0,0,3,138,0,4,160,0,0,6,5,0,1,0,2,4,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,
1,3,0,0,
170,0,0,4,120,0,2,198,0,0,5,5,0,1,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
205,0,0,5,140,0,3,229,0,0,7,7,0,1,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,1,97,0,
0,1,3,0,0,1,97,0,0,
248,0,0,6,159,0,5,266,0,0,7,7,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,
0,1,97,0,0,1,3,0,0,
291,0,0,7,76,0,5,277,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,
318,0,0,8,105,0,5,284,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,3,0,0,
349,0,0,9,221,0,9,332,0,0,3,3,0,1,0,1,97,0,0,1,3,0,0,1,97,0,0,
376,0,0,9,0,0,13,360,0,0,7,0,0,1,0,2,97,0,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
2,3,0,0,2,97,0,0,
419,0,0,9,0,0,15,397,0,0,0,0,0,1,0,
};


/*********************************************************************
**
**    File Name   : DBC_mwiptollth.pc
**    DB Type     : Unix Oracle
...
void DBC_add_null_mwiptollth(struct MWIPTOLLTH_N_TAG *MWIPTOLLTH_N, struct MWIPTOLLTH_TAG *MWIPTOLLTH);
void DBC_del_null_mwiptollth(struct MWIPTOLLTH_N_TAG *MWIPTOLLTH_N, struct MWIPTOLLTH_TAG *MWIPTOLLTH);


/* SQL SELECT Function */
void DBC_select_mwiptollth(int sel_type, struct MWIPTOLLTH_TAG *MWIPTOLLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 

        struct MWIPTOLLTH_N_TAG MWIPTOLLTH_N;
    /* EXEC SQL END DECLARE SECTION; */ 


    DB_start_query_timer();

    DBC_add_null_mwiptollth(&MWIPTOLLTH_N, MWIPTOLLTH);
    DB_error_code = 0;
    ...
    switch(sel_type)
    {
        case 1:
            /* EXEC SQL SELECT 
                ...
                INTO 
                    :MWIPTOLLTH_N.LOT_ID,
                    :MWIPTOLLTH_N.HIST_SEQ,
                    :MWIPTOLLTH_N.HIST_DEL_FLAG,
                    :MWIPTOLLTH_N.FACTORY,
                    :MWIPTOLLTH_N.TOOL_ID,
                    :MWIPTOLLTH_N.TOOL_HIST_SEQ,
                    :MWIPTOLLTH_N.TOOL_HIST_DEL_FLAG
                FROM MWIPTOLLTH
                WHERE LOT_ID = :MWIPTOLLTH_N.LOT_ID
                    AND HIST_SEQ = :MWIPTOLLTH_N.HIST_SEQ
                    AND FACTORY = :MWIPTOLLTH_N.FACTORY
                    AND TOOL_ID = :MWIPTOLLTH_N.TOOL_ID
                    AND TOOL_HIST_SEQ = :MWIPTOLLTH_N.TOOL_HIST_SEQ; */ 

{
            ...
            sqlstm.stmt = "select LOT_ID ,HIST_SEQ ,HIST_DEL_FLAG ,FACTORY \
,TOOL_ID ,TOOL_HIST_SEQ ,TOOL_HIST_DEL_FLAG into :b0,:b1,:b2,:b3,:b4,:b5,:b6 \
 from MWIPTOLLTH where ((((LOT_ID=:b0 and HIST_SEQ=:b1) and FACTORY=:b3) and \
TOOL_ID=:b4) and TOOL_HIST_SEQ=:b5)";
            ...
            sqlstm.sqhstv[0] = (         void  *)(MWIPTOLLTH_N.LOT_ID);
            ...
            sqlstm.sqhstv[1] = (         void  *)&(MWIPTOLLTH_N.HIST_SEQ);
            ...
            sqlstm.sqhstv[2] = (         void  *)(MWIPTOLLTH_N.HIST_DEL_FLAG);
            ...
            sqlstm.sqhstv[3] = (         void  *)(MWIPTOLLTH_N.FACTORY);
            ...
            sqlstm.sqhstv[4] = (         void  *)(MWIPTOLLTH_N.TOOL_ID);
            ...
            sqlstm.sqhstv[5] = (         void  *)&(MWIPTOLLTH_N.TOOL_HIST_SEQ);
            ...
            sqlstm.sqhstv[6] = (         void  *)(MWIPTOLLTH_N.TOOL_HIST_DEL_FLAG);
            ...
            sqlstm.sqhstv[7] = (         void  *)(MWIPTOLLTH_N.LOT_ID);
            ...
            sqlstm.sqhstv[8] = (         void  *)&(MWIPTOLLTH_N.HIST_SEQ);
            ...
            sqlstm.sqhstv[9] = (         void  *)(MWIPTOLLTH_N.FACTORY);
            ...
            sqlstm.sqhstv[10] = (         void  *)(MWIPTOLLTH_N.TOOL_ID);
            ...
            sqlstm.sqhstv[11] = (         void  *)&(MWIPTOLLTH_N.TOOL_HIST_SEQ);
    ...
    if(DB_error_code == 0)
    {
        DBC_del_null_mwiptollth(&MWIPTOLLTH_N, MWIPTOLLTH);
    }
    DB_stop_query_timer("DBC_select_mwiptollth", sel_type);
}


/* SQL SELECT_FOR_UPDATE Function */
void DBC_select_mwiptollth_for_update(int sel_type, struct MWIPTOLLTH_TAG *MWIPTOLLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...
,TOOL_ID ,TOOL_HIST_SEQ ,TOOL_HIST_DEL_FLAG into :b0,:b1,:b2,:b3,:b4,:b5,:b6 \
 from MWIPTOLLTH where ((((LOT_ID=:b0 and HIST_SEQ=:b1) and FACTORY=:b3) and \
TOOL_ID=:b4) and TOOL_HIST_SEQ=:b5) for update ";
            sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_select_mwiptollth_for_update", sel_type);
}


/* SQL SELECT_SCALAR Function */
double DBC_select_mwiptollth_scalar(int sel_type, struct MWIPTOLLTH_TAG *MWIPTOLLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "select count(*)  into :b0  from MWIPTOLLTH where\
 ((((LOT_ID=:b1 and HIST_SEQ=:b2) and FACTORY=:b3) and TOOL_ID=:b4) and TOOL_\
HIST_SEQ=:b5)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MWIPTOLLTH_N.LOT_ID);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)&(MWIPTOLLTH_N.HIST_SEQ);
    ...
    DB_stop_query_timer("DBC_select_mwiptollth_scalar", sel_type);
    return d_value;
}


/* SQL DELETE Function */
void DBC_delete_mwiptollth(int sel_type, struct MWIPTOLLTH_TAG *MWIPTOLLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DELETE FROM MWIPTOLLTH
                WHERE LOT_ID = :MWIPTOLLTH_N.LOT_ID
                    AND HIST_SEQ = :MWIPTOLLTH_N.HIST_SEQ
                    AND FACTORY = :MWIPTOLLTH_N.FACTORY
                    AND TOOL_ID = :MWIPTOLLTH_N.TOOL_ID
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "delete  from MWIPTOLLTH  where ((((LOT_ID=:b0 an\
d HIST_SEQ=:b1) and FACTORY=:b2) and TOOL_ID=:b3) and TOOL_HIST_SEQ=:b4)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MWIPTOLLTH_N.FACTORY);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)(MWIPTOLLTH_N.TOOL_ID);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)&(MWIPTOLLTH_N.TOOL_HIST_SEQ);
    ...
    DB_stop_query_timer("DBC_delete_mwiptollth", sel_type);
}


/* SQL INSERT Function */
void DBC_insert_mwiptollth(struct MWIPTOLLTH_TAG *MWIPTOLLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    /* EXEC SQL INSERT INTO MWIPTOLLTH (
                    LOT_ID,
                    HIST_SEQ,
                    HIST_DEL_FLAG,
                    FACTORY,
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into MWIPTOLLTH (LOT_ID,HIST_SEQ,HIST_DEL_FLAG,FA\
CTORY,TOOL_ID,TOOL_HIST_SEQ,TOOL_HIST_DEL_FLAG) values (:b0,:b1,:b2,:b3,:b4,:\
b5,:b6)";
    sqlstm.iters = (unsigned int  )1;
    ...
    DB_stop_query_timer("DBC_insert_mwiptollth", 0);
}


/* SQL UPDATE Function */
void DBC_update_mwiptollth(int sel_type, struct MWIPTOLLTH_TAG *MWIPTOLLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL UPDATE MWIPTOLLTH SET
                    HIST_DEL_FLAG = :MWIPTOLLTH_N.HIST_DEL_FLAG,
                    TOOL_HIST_DEL_FLAG = :MWIPTOLLTH_N.TOOL_HIST_DEL_FLAG
                WHERE LOT_ID = :MWIPTOLLTH_N.LOT_ID
                    AND HIST_SEQ = :MWIPTOLLTH_N.HIST_SEQ
                    AND FACTORY = :MWIPTOLLTH_N.FACTORY
                    AND TOOL_ID = :MWIPTOLLTH_N.TOOL_ID
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MWIPTOLLTH  set HIST_DEL_FLAG=:b0,TOOL_HI\
ST_DEL_FLAG=:b1 where ((((LOT_ID=:b2 and HIST_SEQ=:b3) and FACTORY=:b4) and T\
OOL_ID=:b5) and TOOL_HIST_SEQ=:b6)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MWIPTOLLTH_N.HIST_DEL_FLAG);
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MWIPTOLLTH_N.TOOL_HIST_DEL_FLAG);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MWIPTOLLTH_N.LOT_ID);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)&(MWIPTOLLTH_N.HIST_SEQ);
            ...
            sqlstm.sqadto[3] = (unsigned short )0;
            sqlstm.sqtdso[3] = (unsigned short )0;
            sqlstm.sqhstv[4] = (         void  *)(MWIPTOLLTH_N.FACTORY);
            ...
            sqlstm.sqadto[4] = (unsigned short )0;
            sqlstm.sqtdso[4] = (unsigned short )0;
            sqlstm.sqhstv[5] = (         void  *)(MWIPTOLLTH_N.TOOL_ID);
            ...
            sqlstm.sqadto[5] = (unsigned short )0;
            sqlstm.sqtdso[5] = (unsigned short )0;
            sqlstm.sqhstv[6] = (         void  *)&(MWIPTOLLTH_N.TOOL_HIST_SEQ);
...

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MWIPTOLLTH  set HIST_DEL_FLAG=:b0 where (\
LOT_ID=:b1 and HIST_SEQ=:b2)";
        ...
        case 3:
            /* EXEC SQL UPDATE MWIPTOLLTH SET
                    TOOL_HIST_DEL_FLAG = :MWIPTOLLTH_N.TOOL_HIST_DEL_FLAG
                WHERE FACTORY = :MWIPTOLLTH_N.FACTORY
                    AND TOOL_ID = :MWIPTOLLTH_N.TOOL_ID
                    AND TOOL_HIST_SEQ = :MWIPTOLLTH_N.TOOL_HIST_SEQ; */ 

{
            ...
            sqlstm.sqladtp = &sqladt;
            sqlstm.sqltdsp = &sqltds;
            sqlstm.stmt = "update MWIPTOLLTH  set TOOL_HIST_DEL_FLAG=:b0 wh\
ere ((FACTORY=:b1 and TOOL_ID=:b2) and TOOL_HIST_SEQ=:b3)";
            sqlstm.iters = (unsigned int  )1;
            ...
            sqlstm.sqlety = (unsigned short)4352;
            sqlstm.occurs = (unsigned int  )0;
            sqlstm.sqhstv[0] = (         void  *)(MWIPTOLLTH_N.TOOL_HIST_DEL_FLAG);
            sqlstm.sqhstl[0] = (unsigned int  )2;
            sqlstm.sqhsts[0] = (         int  )0;
            sqlstm.sqindv[0] = (         void  *)0;
            sqlstm.sqinds[0] = (         int  )0;
            ...
            sqlstm.sqadto[0] = (unsigned short )0;
            sqlstm.sqtdso[0] = (unsigned short )0;
            sqlstm.sqhstv[1] = (         void  *)(MWIPTOLLTH_N.FACTORY);
            ...
            sqlstm.sqadto[1] = (unsigned short )0;
            sqlstm.sqtdso[1] = (unsigned short )0;
            sqlstm.sqhstv[2] = (         void  *)(MWIPTOLLTH_N.TOOL_ID);
            ...
            sqlstm.sqadto[2] = (unsigned short )0;
            sqlstm.sqtdso[2] = (unsigned short )0;
            sqlstm.sqhstv[3] = (         void  *)&(MWIPTOLLTH_N.TOOL_HIST_SEQ);
            sqlstm.sqhstl[3] = (unsigned int  )sizeof(int);
            sqlstm.sqhsts[3] = (         int  )0;
            sqlstm.sqindv[3] = (         void  *)0;
            sqlstm.sqinds[3] = (         int  )0;
    ...
    DB_stop_query_timer("DBC_update_mwiptollth", sel_type);
}


/* SQL CURSOR DECLARE & OPEN Function */
void DBC_open_mwiptollth(int sel_type, struct MWIPTOLLTH_TAG *MWIPTOLLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL DECLARE DBC_MWIPTOLLTH_CUR_1 CURSOR FOR
                SELECT 
                    LOT_ID,
                    HIST_SEQ,
                    HIST_DEL_FLAG,
                ...
                WHERE LOT_ID = :MWIPTOLLTH_N.LOT_ID
                    AND HIST_SEQ = :MWIPTOLLTH_N.HIST_SEQ
                    AND HIST_DEL_FLAG = :MWIPTOLLTH_N.HIST_DEL_FLAG
                ORDER BY TOOL_ID ASC,
                    TOOL_HIST_SEQ ASC; */ 

            /* EXEC SQL OPEN DBC_MWIPTOLLTH_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_open_mwiptollth", sel_type);
}


/* SQL CURSOR FETCH Function */
void DBC_fetch_mwiptollth(int sel_type, struct MWIPTOLLTH_TAG *MWIPTOLLTH)
{
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
    ...
    {
        case 1:
            /* EXEC SQL FETCH DBC_MWIPTOLLTH_CUR_1 INTO 
                                                    :MWIPTOLLTH_N.LOT_ID,
                                                    :MWIPTOLLTH_N.HIST_SEQ,
                                                    :MWIPTOLLTH_N.HIST_DEL_FLAG,
                                                    :MWIPTOLLTH_N.FACTORY,
...

{
    ...
    DB_stop_query_timer("DBC_fetch_mwiptollth", sel_type);
}


/* SQL CURSOR CLOSE Function */
void DBC_close_mwiptollth(int sel_type)
{
    ...
    {
        case 1:
            /* EXEC SQL CLOSE DBC_MWIPTOLLTH_CUR_1; */ 

{
    ...
    DB_stop_query_timer("DBC_close_mwiptollth", sel_type);
}


/* Initialize Function */
void DBC_init_mwiptollth(struct MWIPTOLLTH_TAG *MWIPTOLLTH)
{
    /* memset by Space */
    memset(MWIPTOLLTH, ' ', sizeof(struct MWIPTOLLTH_TAG));
    
    MWIPTOLLTH->HIST_SEQ = 0;
    MWIPTOLLTH->TOOL_HIST_SEQ = 0;
}
...
{
    /* memset by NULL */
    memset(MWIPTOLLTH_N, '\0', sizeof(struct MWIPTOLLTH_N_TAG));
    
    MEMCPY_AN(MWIPTOLLTH_N->LOT_ID, MWIPTOLLTH->LOT_ID, sizeof(MWIPTOLLTH->LOT_ID));
    MWIPTOLLTH_N->HIST_SEQ = MWIPTOLLTH->HIST_SEQ;
    MWIPTOLLTH_N->HIST_DEL_FLAG[0] = MWIPTOLLTH->HIST_DEL_FLAG;
    MEMCPY_AN(MWIPTOLLTH_N->FACTORY, MWIPTOLLTH->FACTORY, sizeof(MWIPTOLLTH->FACTORY));
    MEMCPY_AN(MWIPTOLLTH_N->TOOL_ID, MWIPTOLLTH->TOOL_ID, sizeof(MWIPTOLLTH->TOOL_ID));
    MWIPTOLLTH_N->TOOL_HIST_SEQ = MWIPTOLLTH->TOOL_HIST_SEQ;
    MWIPTOLLTH_N->TOOL_HIST_DEL_FLAG[0] = MWIPTOLLTH->TOOL_HIST_DEL_FLAG;
}
...
void DBC_del_null_mwiptollth(struct MWIPTOLLTH_N_TAG *MWIPTOLLTH_N, struct MWIPTOLLTH_TAG *MWIPTOLLTH)
{
    MEMCPY_DN(MWIPTOLLTH->LOT_ID, MWIPTOLLTH_N->LOT_ID, sizeof(MWIPTOLLTH->LOT_ID));
    MWIPTOLLTH->HIST_SEQ = MWIPTOLLTH_N->HIST_SEQ;
    MWIPTOLLTH->HIST_DEL_FLAG = MWIPTOLLTH_N->HIST_DEL_FLAG[0];
    MEMCPY_DN(MWIPTOLLTH->FACTORY, MWIPTOLLTH_N->FACTORY, sizeof(MWIPTOLLTH->FACTORY));
    MEMCPY_DN(MWIPTOLLTH->TOOL_ID, MWIPTOLLTH_N->TOOL_ID, sizeof(MWIPTOLLTH->TOOL_ID));
    MWIPTOLLTH->TOOL_HIST_SEQ = MWIPTOLLTH_N->TOOL_HIST_SEQ;
    MWIPTOLLTH->TOOL_HIST_DEL_FLAG = MWIPTOLLTH_N->TOOL_HIST_DEL_FLAG[0];
}
