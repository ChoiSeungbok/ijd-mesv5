...
void SEC_UserRoutine_add_service()
{
	...
	COM_add_service("MES_UserSEC", "SEC_Update_Favorites_Before", REPLY, SEC_Update_Favorites_Before_1);
	COM_add_service("MES_UserSEC", "SEC_Update_Favorites_After", REPLY, SEC_Update_Favorites_After_1);
