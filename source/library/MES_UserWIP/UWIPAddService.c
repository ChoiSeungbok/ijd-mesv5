...
void WIP_UserRoutine_add_service()
{
    ...
    COM_add_service("MES_UserWIP", "WIP_Delete_Lot_History_After", REPLY, WIP_Delete_Lot_History_After_1);
    COM_add_service("MES_UserWIP", "WIP_Delete_Lot_History_Before", REPLY, WIP_Delete_Lot_History_Before_1);
}
