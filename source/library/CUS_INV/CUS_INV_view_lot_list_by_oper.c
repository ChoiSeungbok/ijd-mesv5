...
System      : MESplus
Module      : CUS_INV
File Name   : CUS_INV_view_lot_list_by_oper.c
Description : View Inv Lot List By Oper

MES Version : 4.0.0

Function List
- CUS_INV_View_Lot_List_By_Oper()
+ View Inv Lot List By Oper
- CUS_INV_VIEW_LOT_LIST_BY_OPER()
+ Main sub function of "CUS_INV_View_Lot_List_By_Oper" function
+ Unload Lot definition
- CUS_INV_View_Lot_List_By_Oper_Validation()
+ Validation Check sub function of "CUS_INV_VIEW_LOT_LIST_BY_OPER" function
...
int CUS_INV_View_Lot_List_By_Oper_Validation(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
int CUS_INV_VIEW_LOT_LIST_BY_OPER(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
...
*******************************************************************************/
int CUS_INV_View_Lot_List_By_Oper(TRSNode *in_node, TRSNode *out_node)
{
	...
	i_ret = CUS_INV_VIEW_LOT_LIST_BY_OPER(s_msg_code, in_node, out_node);
...
int CUS_INV_VIEW_LOT_LIST_BY_OPER(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{
    ...
    LOG_head("CUS_INV_View_Lot_List_By_Oper");
    TRS.log_add_all_members(in_node);
    COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_LOGIC, MP_LOG_CATE_VIEW);

    /* Validation Check */
    if (CUS_INV_View_Lot_List_By_Oper_Validation(s_msg_code, in_node, out_node) == MP_FALSE)
    {
        COM_set_result(out_node, MP_FAIL_C, s_msg_code, MP_MSG_CATE_ERROR, TRS.get_language(in_node));
        return MP_FALSE;
    }
    ...
    if (DB_error_code != DB_SUCCESS)
    {
        ...
        TRS.add_fieldmsg(out_node, "SUB_AREA_ID", MP_STR, sizeof(MINVLOTSTS.SUB_AREA_ID), MINVLOTSTS.SUB_AREA_ID);
    ...
    while (1)
    {
		...
		TRS.add_string(list_item, "RECV_DATE", MINVLOTSTS.UNIT, sizeof(MINVLOTSTS.RECV_DATE));
		...
		TRS.add_string(list_item, "INV_CMF_8", MINVLOTSTS.INV_CMF_8, sizeof(MINVLOTSTS.INV_CMF_8));
		TRS.add_string(list_item, "INV_CMF_9", MINVLOTSTS.INV_CMF_9, sizeof(MINVLOTSTS.INV_CMF_9));
		

		DBU_init_mwipoprdef(&MWIPOPRDEF_LOAD);
		TRS.copy(MWIPOPRDEF_LOAD.FACTORY, sizeof(MWIPOPRDEF_LOAD.FACTORY), in_node, IN_FACTORY);
		memcpy(MWIPOPRDEF_LOAD.OPER, MINVLOTSTS.INV_CMF_9, sizeof(MINVLOTSTS.INV_CMF_9));
		...
		if (DB_error_code != DB_SUCCESS && DB_error_code != DB_NOT_FOUND)
		{
			strcpy(s_msg_code, "WIP-0010");
			TRS.add_fieldmsg(out_node, "MWIPOPRDEF SELECT(1) ", DT_NOVALUESTRING);
			TRS.add_fieldmsg(out_node, "FACTORY", MP_STR, sizeof(MWIPOPRDEF_LOAD.FACTORY), MWIPOPRDEF_LOAD.FACTORY);
			TRS.add_fieldmsg(out_node, "OPER", MP_STR, sizeof(MWIPOPRDEF_LOAD.OPER), MWIPOPRDEF_LOAD.OPER);
			TRS.add_dberrmsg(out_node, DB_error_msg);
		...
		if (DB_error_code == DB_NOT_FOUND)
		{
			TRS.add_string(list_item, "LOAD_OPER_DESC", " ", sizeof(" "));
		}
		else
		{
