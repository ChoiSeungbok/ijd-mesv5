...
System      : MESplus
Module      : CUS_WIP
File Name   : CUS_WIP_validation_etc_out_lot.c
Description : Validation Etc Out Lot

MES Version : 4.0.0

Function List
- CUS_WIP_Validation_Etc_Out_Lot()
+ Validation Etc Out Lot
- CUS_WIP_VALIDATION_ETC_OUT_LOT()
+ Main sub function of "CUS_WIP_Validation_Etc_Out_Lot" function
+ Etc Out Lot definition
- CUS_WIP_Validation_Etc_Out_Lot_Validation()
+ Validation Check sub function of "CUS_WIP_VALIDATION_ETC_OUT_LOT" function
...
int CUS_WIP_Validation_Etc_Out_Lot_Validation(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
int CUS_WIP_VALIDATION_ETC_OUT_LOT(char *s_msg_code, TRSNode *in_node, TRSNode *out_node);
...
*******************************************************************************/
int CUS_WIP_Validation_Etc_Out_Lot(TRSNode *in_node, TRSNode *out_node)
{
	...
	i_ret = CUS_WIP_VALIDATION_ETC_OUT_LOT(s_msg_code, in_node, out_node);

	COM_out_msg_log_write(s_msg_code, "CUS_WIP_VALIDATION_ETC_OUT_LOT", out_node);
...
int CUS_WIP_VALIDATION_ETC_OUT_LOT(char *s_msg_code, TRSNode *in_node, TRSNode *out_node)
{
    ...
    LOG_head("CUS_WIP_Validation_Etc_Out_Lot");
    TRS.log_add_all_members(in_node);
    COM_log_write(MP_LOG_INFORMATION, MP_LOG_E_LOGIC, MP_LOG_CATE_VIEW);

    /* Validation Check */
    if (CUS_WIP_Validation_Etc_Out_Lot_Validation(s_msg_code, in_node, out_node) == MP_FALSE)
    {
        COM_set_result(out_node, MP_FAIL_C, s_msg_code, MP_MSG_CATE_ERROR, TRS.get_language(in_node));
        return MP_FALSE;
    }
	...
	TRS.add_double(out_node, "QTY", MWIPLOTSTSX.QTY_1);
	TRS.add_string(out_node, "UNIT", MWIPMATDEF.UNIT_1, sizeof(MWIPMATDEF.UNIT_1));
