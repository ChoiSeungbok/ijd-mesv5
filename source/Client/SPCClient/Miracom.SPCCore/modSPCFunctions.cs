...
//       - FindListItem() : ListView?먯꽌 ?뱀젙 Item??李얜뒗??
...
//       - MakeDateFormat() : ?쇰컲 臾몄옄?댁쓣 Time Format?쇰줈 蹂??
//       - DestroyDateFormat() : ?좎쭨 ?뺤떇??臾몄옄?댁쓣 ?쇰컲 臾몄옄?대줈 蹂?섑븳??
//       - GetIndexedControl() : parentControl ?꾩뿉 ?덈뒗 ?숈씪??Prefix?대쫫??媛吏?control留뚯쓣 ?대쫫?쒖쑝濡??뺣젹?섏뿬 由ъ뒪?몃줈 留뚮뱺??
...
//       - GetChildForm() : Child Form???덈뒗吏 ?뺤씤?쒕떎
    ...
    public sealed class modSPCFunctions
    {
        ...
        public static bool CheckAvailableFunction(string FuncName)
        {
            ...
            try
            {
                ...
                //int i;
                /* Updated By YJJung 권한 Check 시 Performance 이슈로 인해, SEC_View_Function_Detail 로 변경 */
                MPCR.SetInMsg(in_node);
                in_node.ProcStep = '1';
