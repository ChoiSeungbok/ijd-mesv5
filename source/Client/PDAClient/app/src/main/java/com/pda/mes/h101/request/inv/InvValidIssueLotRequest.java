...
public class InvValidIssueLotRequest extends Request {

    public InvValidIssueLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_VALIDATION_ISSUE_REQUEST_LOT);
