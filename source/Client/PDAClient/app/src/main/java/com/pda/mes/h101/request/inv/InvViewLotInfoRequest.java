...
public class InvViewLotInfoRequest extends Request {

    public InvViewLotInfoRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_VIEW_LOT_INFO);
