...
public class InvRegistMoveLotRequest extends Request {

    public InvRegistMoveLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_MOVE_LOT_ORDER);
