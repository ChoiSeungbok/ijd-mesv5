...
public class InvViewIssueRequest extends Request {

    public InvViewIssueRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_VIEW_ISSUE_REQUEST);
