...
public class CPDA2015_PDA_TopAdapter extends BaseAdapter {
    ...
    public CPDA2015_PDA_TopAdapter(Context context) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(null == convertView) {
            convertView = mLayoutInflater.inflate(R.layout.cell_cpda2015_top, null);
