...
public class InvIssueLotRequest extends Request {

    public InvIssueLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_VIEW_ISSUE_REQUEST_LOT);
