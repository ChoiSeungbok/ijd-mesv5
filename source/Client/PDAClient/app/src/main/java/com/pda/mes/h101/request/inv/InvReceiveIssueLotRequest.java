...
public class InvReceiveIssueLotRequest extends Request {

    public InvReceiveIssueLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_RECEIVE_ISSUE_REQUEST_LOT);
