...
/**
 * Created by sjs on 2020. 10. 27
 */

public class ShpCheckShipLotRequest extends Request {

    public ShpCheckShipLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_SHP_CHECK_SHIP_LOT);
