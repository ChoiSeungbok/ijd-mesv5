...
public class WipViewWorkerListRequest extends Request {

    public WipViewWorkerListRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_WIP_VIEW_WORKER_LIST);
