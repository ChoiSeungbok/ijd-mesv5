...
public class CPDA2017_PDA_Adapter extends BaseAdapter {

    private Context mContext;

    private CPDA2017_PDA_Adapter.OnClickCellListener listener;

    private List<WIPModel> mModels = new ArrayList<>();

    private LayoutInflater mLayoutInflater;

    public CPDA2017_PDA_Adapter(Context context) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(null == convertView) {
            convertView = mLayoutInflater.inflate(R.layout.cell_cpda2001, null);
            ...
            viewHolder.operDesc = convertView.findViewById(R.id.cellOperDesc);
            viewHolder.operCode = convertView.findViewById(R.id.cellOperCode);
        ...
        viewHolder.operDesc.setText(model.getOperDesc());
        viewHolder.operCode.setText(model.getOper());
//        x
        //viewHolder.rootLayout.setSelected(falsle);
        viewHolder.rootLayout.isInEditMode();
        ...
        viewHolder.ordQty.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void setOnClickCellListener(CPDA2017_PDA_Adapter.OnClickCellListener $listener) {
        listener = $listener;
    }
    ...
    public static class ViewHolder {
        ...
        public TextView operDesc;
        public TextView operCode;
