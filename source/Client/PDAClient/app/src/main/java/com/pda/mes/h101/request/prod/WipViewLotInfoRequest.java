...
public class WipViewLotInfoRequest extends Request {

    public WipViewLotInfoRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_WIP_VIEW_LOT_INFO);
