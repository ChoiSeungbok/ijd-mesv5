...
public class CPDA2002_PDA_Adapter extends BaseAdapter {

    private Context mContext;

    private CPDA2002_PDA_Adapter.OnClickCellListener listener;

    private List<WIPModel> mModels = new ArrayList<>();

    private LayoutInflater mLayoutInflater;

    public CPDA2002_PDA_Adapter(Context context) {
        mContext = context;
...
//        x
    ...
    public void setOnClickCellListener(CPDA2002_PDA_Adapter.OnClickCellListener $listener) {
        listener = $listener;
    }
