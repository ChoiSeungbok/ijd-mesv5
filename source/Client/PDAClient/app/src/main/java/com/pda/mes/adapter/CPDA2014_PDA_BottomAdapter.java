...
public class CPDA2014_PDA_BottomAdapter extends BaseAdapter {
    ...
    public CPDA2014_PDA_BottomAdapter(Context context) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(null == convertView) {
            convertView = mLayoutInflater.inflate(R.layout.cell_cpda2014_bottom, null);
