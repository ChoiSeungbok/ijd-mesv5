...
public class CPDA2020_PDA_Adapter extends BaseAdapter {
    ...
    public CPDA2020_PDA_Adapter(Context context) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        CPDA2020_PDA_Adapter.ViewHolder viewHolder = new CPDA2020_PDA_Adapter.ViewHolder();

        if(null == convertView) {
            convertView = mLayoutInflater.inflate(R.layout.cell_cpda2020, null);
            ...
            viewHolder = (CPDA2020_PDA_Adapter.ViewHolder)convertView.getTag();
        }
