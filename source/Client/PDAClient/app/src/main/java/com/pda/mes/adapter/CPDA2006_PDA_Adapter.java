...
public class CPDA2006_PDA_Adapter extends BaseAdapter {
    ...
    public CPDA2006_PDA_Adapter(Context context) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(null == convertView) {
            convertView = mLayoutInflater.inflate(R.layout.cell_cpda2006, null);
            ...
            viewHolder.oper = convertView.findViewById(R.id.cellLotStock);
