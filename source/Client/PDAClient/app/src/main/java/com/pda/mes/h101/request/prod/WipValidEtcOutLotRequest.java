...
public class WipValidEtcOutLotRequest extends Request {

    public WipValidEtcOutLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_WIP_VALIDATION_ETC_OUT_LOT);
