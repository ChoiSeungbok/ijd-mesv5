...
public class InvConfirmIssueRequest extends Request {

    public InvConfirmIssueRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_CONFIRM_ISSUE_REQUEST);
