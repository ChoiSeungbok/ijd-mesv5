...
public class InvTerminateLotRequest extends Request {

    public InvTerminateLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_TERMINATE_LOT);
