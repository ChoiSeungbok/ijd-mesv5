...
public class InvCreateIssueLotRequest extends Request {

    public InvCreateIssueLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_CREATE_ISSUE_REQUEST_LOT);
