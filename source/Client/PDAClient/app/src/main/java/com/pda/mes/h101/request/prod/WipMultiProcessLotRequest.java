...
public class WipMultiProcessLotRequest extends Request {

    public WipMultiProcessLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_WIP_MULTI_PROCESS_LOT);
