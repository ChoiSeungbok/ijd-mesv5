...
public class CPDA2010_PDA_BottomAdapter extends BaseAdapter {
    ...
    public CPDA2010_PDA_BottomAdapter(Context context) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(null == convertView) {
            convertView = mLayoutInflater.inflate(R.layout.cell_cpda2010_bottom, null);
            ...
            viewHolder.lotStatus = convertView.findViewById(R.id.cellLotStatus);
        ...
        viewHolder.lotStatus.setText(model.getStatus());
