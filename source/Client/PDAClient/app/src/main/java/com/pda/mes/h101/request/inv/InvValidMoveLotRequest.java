...
public class InvValidMoveLotRequest extends Request {

    public InvValidMoveLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_VALIDATION_MOVE_LOT);
