...
public class WipViewOperListRequest extends Request {

    public WipViewOperListRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_WIP_VIEW_OPER_LIST);
