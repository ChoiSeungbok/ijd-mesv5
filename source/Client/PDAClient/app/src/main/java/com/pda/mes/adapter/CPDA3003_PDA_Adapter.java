...
public class CPDA3003_PDA_Adapter extends BaseAdapter {
    ...
    public CPDA3003_PDA_Adapter(Context context) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(null == convertView) {
            convertView = mLayoutInflater.inflate(R.layout.cell_cpda3003, null);
            ...
            viewHolder.lotStock = convertView.findViewById(R.id.cellLotStock);
        ...
        viewHolder.lotStock.setText(model.getOper());
