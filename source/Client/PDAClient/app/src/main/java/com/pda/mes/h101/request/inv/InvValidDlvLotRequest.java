...
public class InvValidDlvLotRequest extends Request {

    public InvValidDlvLotRequest(Context context) {
        super(context);
        addParam("_SERVICE_NAME", "S", H101Const.CUS_INV_VALIDATION_DLV_LOT);
