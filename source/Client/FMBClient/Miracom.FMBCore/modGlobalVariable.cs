...
namespace Miracom.FMBCore
{
    public sealed class modGlobalVariable
    {
        ...
        public static int giPortStatusColor = 0;
        public static int giToolStatusColor = 0;
...
//#endif
        ...
        public struct gEventColors
        {
            public string sResourceType;
            public string sEventMode;
            public string sEventStatus;
            public string sColor;
        }

        public static gEventColors [] gArrayEventColors = new gEventColors[1000];
