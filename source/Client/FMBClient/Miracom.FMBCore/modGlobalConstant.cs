...
namespace Miracom.FMBCore
{
    public sealed class modGlobalConstant
    {
        ...
        public const string FMB_CATEGORY_SUB_RESOURCE = "SUB_RESOURCE";
        public const string FMB_CATEGORY_PORT = "PORT";
        public const string FMB_CATEGORY_TOOL = "TOOL";
        ...
        public const char FMB_SUB_RESOURCE_TYPE = 'S';
        public const char FMB_PORT_TYPE = 'P';
        public const char FMB_TOOL_TYPE = 'L';
        public const char FMB_TAG_TYPE = 'T';

        public const string FMB_RESOURCE = "RES";
        public const string FMB_SUBRES = "SUB_RES";
        public const string FMB_PORT = "PORT";
        public const string FMB_TOOL = "TOOL";

        #endregion

        #region "FMB Envent Mode"

        public const string FMB_CTRL_MODE = "CTRL_MODE";
        public const string FMB_PROC_MODE = "PROC_MODE";
        public const string FMB_UP_DOWN = "UP_DOWN";
        public const string FMB_PRI_STS = "PRI_STS";
        public const string FMB_STATUS = "STATUS";
