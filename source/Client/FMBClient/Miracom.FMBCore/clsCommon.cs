...
// GetIndexedControl()?먯꽌??Control?ㅼ쓣 ?대쫫?쇰줈 ?뺣젹?섍린 ?꾪빐 留뚮뱺 class
namespace Miracom.FMBCore
{
    public class ControlNameSort : IComparer
    {
        ...
        public int Compare(object con1, object con2)
        {
            ...
            try
            {
                ...
                iCon1 = MPCF.ToInt(sConName.Substring(i + 1, sConName.Length - i - 1));
                ...
                iCon2 = MPCF.ToInt(sConName.Substring(i + 1, sConName.Length - i - 1));
    ...
    public class clsDesignListTag : object
    {
        ...
        private string m_sSubKey = "";
        private bool m_bResAttachFlag = false;
        private bool m_b_load_flag = false;
        ...
        public string SubKey
        {
            ...
            set
            {
                if (m_sSubKey.Equals(value) == false)
                {
                    m_sSubKey = value;
                }
            }
        ...
        public bool LoadFlag
        {
            get
            {
                return m_b_load_flag;
            }
            set
            {
                if (m_b_load_flag.Equals(value) == false)
                {
                    m_b_load_flag = value;
                }
            }
        ...
        public void SetTagData(string sKey, string sCategory, string sFactory, string sLayout, bool bResAttachFlag)
        {
            ...
            {
                MPCF.ShowMsgBox("clsDesignListTag.SetTagData()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
            }
            
        }
         public void SetTagData(string sKey, string sSubKey, string sCategory, string sFactory, string sLayout, bool bResAttachFlag)
        {
