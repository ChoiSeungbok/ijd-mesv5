...
namespace Miracom.FMBCore
{
    public class frmFMBArrangeLayout : System.Windows.Forms.Form
    {
        ...
        private bool CheckCondition()
        {
            ...
            try
            {
                ...
                foreach (Panel tempLoopVar_ctlPanel in this.grpSelectLayout.Controls)
                {
                    ...
                    if (MPCF.Trim(((LayoutInfo) ctlPanel.Tag).cdvLayout.Text) != "")
                    {
        ...
        private void InitControls()
        {
            ...
            {
                MPCF.ShowMsgBox("frmFMBArrangeLayout.InitControls()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
            }
        ...
        private void GetLayoutInfo()
        {
            ...
            try
            {
                ...
                string sLayout;
                Panel ctlPanel;
                iCount = MPCF.ToInt(MPCF.GetRegSetting(Application.ProductName, "ArrangeLayout", "Count", "0"));
                if (iCount == 2)
                {
                    rbn2.Checked = true;
                }
                ...
                {
                    sCategory = MPCF.GetRegSetting(Application.ProductName, "ArrangeLayout", "Category" + System.Convert.ToString(i + 1), "");
                    sFactory = MPCF.GetRegSetting(Application.ProductName, "ArrangeLayout", "Factory" + System.Convert.ToString(i + 1), "");
                    sLayout = MPCF.GetRegSetting(Application.ProductName, "ArrangeLayout", "Layout" + System.Convert.ToString(i + 1), "");
                    foreach (Panel tempLoopVar_ctlPanel in this.grpSelectLayout.Controls)
                    {
                        ctlPanel = tempLoopVar_ctlPanel;
        ...
        private void SetLayoutEnable(int iLayoutCount)
        {
            ...
            try
            {
                ...
                foreach (Panel tempLoopVar_ctlPanel in this.grpSelectLayout.Controls)
                {
                    ...
                    if (((LayoutInfo) ctlPanel.Tag).iSeq <= iLayoutCount)
                    {
                        ...
                        {
                            FMBCF.CheckAllFactoryOption(((LayoutInfo) ctlPanel.Tag).cdvFactory);
                        }
            ...
            {
                MPCF.ShowMsgBox("frmFMBArrangeLayout.SetLayoutEnable()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
            }
        ...
        private bool CheckLayoutID(Miracom.UI.Controls.MCCodeView.MCCodeView cdvTemp)
        {
            ...
            try
            {
                ...
                foreach (Panel tempLoopVar_ctlPanel in this.grpSelectLayout.Controls)
                {
                    ...
                    {
                        if (MPCF.Trim(((LayoutInfo) ctlPanel.Tag).cboCategory.Text) == MPCF.Trim(((LayoutInfo) cdvTemp.Parent.Tag).cboCategory.Text) && MPCF.Trim(((LayoutInfo) ctlPanel.Tag).cdvFactory.Text) == MPCF.Trim(((LayoutInfo) cdvTemp.Parent.Tag).cdvFactory.Text) && MPCF.Trim(((LayoutInfo) ctlPanel.Tag).cdvLayout.Text) == MPCF.Trim(((LayoutInfo) cdvTemp.Parent.Tag).cdvLayout.Text))
                        {
                            MPCF.ShowMsgBox(MPCF.GetMessage(34), Application.ProductName, MessageBoxButtons.OK, 1);
                            cdvTemp.Text = "";
                            cdvTemp.Focus();
                            return false;
                        }
            ...
            {
                MPCF.ShowMsgBox("frmFMBArrangeLayout.CheckLayoutID()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
                return false;
            }
        ...
        private void ArrangeLayout()
        {
            ...
            try
            {
                ...
                {
                    ctlPanel = tempLoopVar_ctlPanel;
                    if (MPCF.Trim(((LayoutInfo) ctlPanel.Tag).cboCategory.Text) != "" && MPCF.Trim(((LayoutInfo) ctlPanel.Tag).cdvFactory.Text) != "" && MPCF.Trim(((LayoutInfo) ctlPanel.Tag).cdvLayout.Text) != "")
                    {
                ...
                MPCF.SaveRegSetting(Application.ProductName, "ArrangeLayout", "Count", iCount.ToString());
                for (i = 0; i <= aArrList.Count - 1; i++)
                {
                    MPCF.SaveRegSetting(Application.ProductName, "ArrangeLayout", "Category" + System.Convert.ToString(i + 1), ((modGlobalVariable.gLayouts)aArrList[i]).sTag);
                    if (((modGlobalVariable.gLayouts) aArrList[i]).sTag == modGlobalConstant.FMB_CATEGORY_LAYOUT)
                    {
                        sFactory = FMBCF.GetStringBySeperator(((modGlobalVariable.gLayouts) aArrList[i]).sFormName, ":", 1);
                        sLayout = FMBCF.GetStringBySeperator(((modGlobalVariable.gLayouts) aArrList[i]).sFormName, ":", 2);
                    }
                    ...
                    MPCF.SaveRegSetting(Application.ProductName, "ArrangeLayout", "Factory" + System.Convert.ToString(i + 1), sFactory);
                    MPCF.SaveRegSetting(Application.ProductName, "ArrangeLayout", "Layout" + System.Convert.ToString(i + 1), sLayout);
                }
                
                FMBFI.gIMdiForm.ArrageLayouts(aArrList, iCount);
        ...
        private void btnClose_Click(System.Object sender, System.EventArgs e)
        {
            ...
            {
                MPCF.ShowMsgBox("frmFMBArrangeLayout.btnClose_Click()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
            }
        ...
        private void cdvFactory_ButtonPress(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                cdvTemp.SmallImageList = FMBFI.gIMdiForm.GetSmallIconList();
            ...
            {
                MPCF.ShowMsgBox("frmFMBArrangeLayout.cdvFactory_ButtonPress()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
            }
        ...
        private void cdvLayout_ButtonPress(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    modListRoutine.ViewLayOutList(cdvTemp.GetListView, '1', MPCF.Trim(((LayoutInfo)cdvTemp.Parent.Tag).cdvFactory.Text));
                }
            ...
            {
                MPCF.ShowMsgBox("frmFMBArrangeLayout.cdvLayout_ButtonPress()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
            }
        ...
        private void cboCategory_SelectionChanged(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    FMBCF.CheckAllFactoryOption(((LayoutInfo) cdvTemp.Parent.Tag).cdvFactory);
                }
                else if (cdvTemp.SelectedIndex == 1)
                {
                    ((LayoutInfo) cdvTemp.Parent.Tag).cdvFactory.Text = MPGV.gsFactory;
        ...
        private void rbnCount_CheckedChanged(System.Object sender, System.EventArgs e)
        {
            ...
            {
                MPCF.ShowMsgBox("frmFMBArrangeLayout.rbnCount_CheckedChanged()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
            }
        ...
        private void btnOK_Click(object sender, System.EventArgs e)
        {
            ...
            {
                MPCF.ShowMsgBox("frmFMBArrangeLayout.btnOK_Click()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
                this.DialogResult = DialogResult.None;
            }
        ...
        private void cdvFactory_SelectedItemChanged(object sender, UI.MCCodeViewSelChanged_EventArgs e)
        {
            ...
            {
                MPCF.ShowMsgBox("frmFMBArrangeLayout.cdvFactory_SelectedItemChanged()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
            }
            
        }
        
        private void cdvLayout_SelectedItemChanged(object sender, UI.MCCodeViewSelChanged_EventArgs e)
        {
            ...
            {
                MPCF.ShowMsgBox("frmFMBArrangeLayout.cdvLayout_SelectedItemChanged()" + "\r\n" + ex.Message, Application.ProductName, MessageBoxButtons.OK, 1);
            }
