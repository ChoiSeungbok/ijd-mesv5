...
namespace Miracom.FMBUI
{
    namespace Controls
    {
        ...
        public class udcCtrlPort : FMBUI.Controls.udcCtrlBase
        {
            ...
            public udcCtrlPort(ImageList imlRes)
            {
            ...
            [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
            {
                ...
                System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(udcCtrlPort));
            ...
            protected override void DrawControl(Graphics g)
            {
                ...
                {
                    MessageBox.Show(ex.Message, "udcCtrlPort.DrawControl()", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            ...
            private void DrawCtrlResource(Graphics g)
            {
                ...
                {
                    MessageBox.Show(ex.Message, "udcCtrlPort.DrawCtrlResource()", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
