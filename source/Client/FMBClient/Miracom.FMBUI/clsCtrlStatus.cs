...
namespace Miracom.FMBUI
{
    public class clsCtrlStatus : object
    {
        ...
        private string m_sMotherResourceID = string.Empty;
        private char m_cResShape = ' ';
        private double m_dWIPRate = 0;
        private char m_cSignalPos = ' ';
        ...
        [Description("Gets or sets MotherResourceID"), Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        public string MotherResourceID
        {
            get
            {
                return m_sMotherResourceID;
            }
            set
            {
                if (m_sMotherResourceID.Equals(value) == false)
                {
                    m_sMotherResourceID = value;
                    OnStyleChanged(Enums.eCtrlProperty.PROP_MOTHERESOURCEID, value);
                }
            }
        }
        ...
        [Description("Gets or sets Status"), DefaultValue(false), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public string Status
        {
            ...
            set
            {
                if (m_sStatus.Equals(value) == false)
                {
                    m_sStatus = value;
                    OnStyleChanged(Enums.eCtrlProperty.PROP_STATUS, value);
                }
            }
        }
        ...
        public char ResShape
        {
            ...
            set
            {
                if (m_cResShape.Equals(value) == false)
                {
                    m_cResShape = value;
                    OnStyleChanged(Enums.eCtrlProperty.PROP_RESSHAPE, value);
                }
            }
        }

        public double WIPRate
        {
            get
            {
                return m_dWIPRate;
            ...
            set
            {
                if (m_dWIPRate.Equals(value) == false)
                {
                    m_dWIPRate = value;
                    OnStyleChanged(Enums.eCtrlProperty.PROP_WIPRATE, value);
                }
            }
        }

        public char SignalPosition
        {
            get
            {
                return m_cSignalPos;
            ...
            set
            {
                if (m_cSignalPos.Equals(value) == false)
                {
                    m_cSignalPos = value;
                    OnStyleChanged(Enums.eCtrlProperty.PROP_SIGNALPOS, value);
                }
            }
        }

        [Description("Gets or sets Seq"), Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        public int Seq
        {
            get
            {
            ...
            try
            {
                switch (eSender)
                {
                    ...
                    case Enums.eCtrlProperty.PROP_MOTHERESOURCEID:
                        ...
                        break;
                    case Enums.eCtrlProperty.PROP_STATUS:
