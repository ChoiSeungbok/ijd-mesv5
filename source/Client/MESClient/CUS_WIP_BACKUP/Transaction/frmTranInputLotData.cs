...
namespace CUS_WIP
{
    public partial class frmTranInputLotData : CUS_COM.frmTranForm03
    {
        public frmTranInputLotData()
        {
            InitializeComponent();
        ...
        private void ViewLotInfo(string sLot_ID)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < out_node.GetList("LOT_TBL").Count; i++)
                {
                    ...
                    spdLotList.ActiveSheet.SetValue(iRow, (int)LOT_INFO.MAT_VER, out_node.GetList("LOT_TBL")[i].GetInt("MAT_VER"));
        ...
        private void FindColSetVersion(string s_Col_Set_id, string s_Lot_ID, string s_Mat_ID, int i_Mat_Ver, string s_Flow, string s_Oper)
        {
            ...
            try
            {
                ...
                bCheckData = ViewEdcCount();
                
                if (bCheckData == true)
                {
                    if (View_Lot_Data() == false)
                    {
        ...
        public bool Collect_Lot_Data()
        {
            ...
            try
            {
                ...
                in_node.AddString("MAT_ID", MPCF.Trim(spdLotList.ActiveSheet.Cells[0,(int)LOT_INFO.MAT_ID].Text));
                in_node.AddInt("MAT_VER", MPCF.ToInt(spdLotList.ActiveSheet.Cells[0, (int)LOT_INFO.MAT_VER].Text));
                in_node.AddString("FLOW", MPCF.Trim(spdLotList.ActiveSheet.Cells[0, (int)LOT_INFO.FLOW].Text));
                in_node.AddString("OPER", MPCF.Trim(cdvOper.Text));
                in_node.AddString("MEAS_RES_ID", MPCF.Trim(spdLotList.ActiveSheet.Cells[0, (int)LOT_INFO.RES_ID].Text));
                in_node.AddString("COL_SET_ID", MPCF.Trim(cdvColset.Text));
                in_node.AddString("PROC_FLOW", MPCF.Trim(spdLotList.ActiveSheet.Cells[0, (int)LOT_INFO.FLOW].Text));
        ...
        private void frmTranInputLotData_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void cdvColset_SelectedItemChanged(object sender, Miracom.UI.MCCodeViewSelChanged_EventArgs e)
        {
            ...
            try
            {
                s_Lot_id = spdLotList.ActiveSheet.Cells[0, (int)LOT_INFO.LOT_ID].Text;
                s_Oper = spdLotList.ActiveSheet.Cells[0, (int)LOT_INFO.OPER].Text;
                s_Flow = spdLotList.ActiveSheet.Cells[0, (int)LOT_INFO.FLOW].Text;
                s_Mat_id = spdLotList.ActiveSheet.Cells[0, (int)LOT_INFO.MAT_ID].Text;
                s_Mat_ver = MPCF.ToInt(spdLotList.ActiveSheet.Cells[0, (int)LOT_INFO.MAT_VER].Text);
