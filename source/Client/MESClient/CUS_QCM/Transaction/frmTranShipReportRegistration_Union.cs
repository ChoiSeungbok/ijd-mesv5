    ...
    public partial class frmTranShipReportRegistration_Union : frmTranForm05
    {
        ...
        private void spdPackingLotList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (spdPackingLotList.ActiveSheet.ActiveRowIndex >= 0)
            {
                ...
                string image = MPCF.Trim(spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 34].Value.ToString());
                string image2 = MPCF.Trim(spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 35].Value.ToString());
                ViewImageFile(image, image2);
                txtODMeterMIN.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 36].Text;
                txtODMeterMAX.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 37].Text;
                txtLengthSpecMIN.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 38].Text;
                txtLengthSpecMAX.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 39].Text;               
                txtSGMIN.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 40].Text;
                txtSGMAX.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 41].Text;
                txtMSMIN.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 42].Text;
                txtMSMAX.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 43].Text;
                txtHCMIN.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 44].Text;
                txtHCMAX.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 45].Text;
                txtHVMIN.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 46].Text;
                txtHVMAX.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 47].Text;
                txtTRSMIN.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 48].Text;
                txtTRSMAX.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 49].Text;
                ...
                txtRemark.Text = spdPackingLotList.ActiveSheet.Cells[activeRowIndex, 33].Text;
                iFocusRow = spdPackingLotList.ActiveSheet.ActiveRowIndex;
            }
        }
