...
namespace CUS_QCM
{
    public partial class frmTranInspectionRegistrationGRIT : CUS_COM.frmTranForm06
    {
        public frmTranInspectionRegistrationGRIT()
        {
            InitializeComponent();
        ...
        private void InitControl()
        {
            try
            {
                ...
                */
                ...
                btnGCM3.Anchor = AnchorStyles.Top | AnchorStyles.Left;
        ...
        public void ViewLotInfo(string sLot_ID)
        {
            ...
            try
            {
                ...
                */
                ...
                // spdLotList.ActiveSheet.SetValue(0, (int)LOT_INFO.RES_ID, out_node.GetString("RES_ID"));
                // spdLotList.ActiveSheet.SetValue(0, (int)LOT_INFO.RES_DESC, out_node.GetString("RES_DESC"));
                ...
                //SAMPLE 검사는 GRADE SIZE LOT별로 별도 관리
                if (cdvOper.Text == "OG05260")
                {
                    txtSizes.Text = out_node.GetString("INSP_SAMPLE_SIZE");
                    txtGrade.Text = out_node.GetString("INSP_SAMPLE_GRADE");
                }
                else
                {
                ...
                {
                    txtSizes.BackColor = Color.Red;
                }
                else
                {
                    txtSizes.BackColor = Color.White;
                }
                ...
                GetJudgeFlagByArea(cdvInspectionJudgeChange.GetListView, cdvInspOper.Text, cdvInspectionType.Text);
                cdvInspectionJudgeFlag.InsertEmptyRow(0, 1);

                if (cdvOper.Text != "G-IQC")
                {
                    cdvInspectionJudgeChange.Enabled = false;
                }
                else
                {
                    cdvInspectionJudgeChange.Enabled = true;
                }
        ...
        private void ViewInspectionFile(string inspID)
        {
            try
            {
                ...
                if (spdFileRegistration.ActiveSheet.RowCount > 0)
                {
        ...
        private bool Collect_Data_ASPECT()
        {
            ...
            try
            {
                ...
                for (iRow = 0; iRow < spdDataCollectionAspect.ActiveSheet.RowCount; iRow++)
                {
                    ...
                    data_list.AddString("SPEC_VAL", spdDataCollectionAspect.ActiveSheet.Cells[iRow, (int)COLLECTION_DATA_ASPECT.SPEC_VAL].Value);
        ...
        private bool Collect_Data_ISP()
        {
            ...
            try
            {
                ...
                for (iRow = 0; iRow < spdDataCollectionISP.ActiveSheet.RowCount; iRow++)
                {
                    ...
                    data_list.AddInt("INSP_SEQ", spdDataCollectionISP.ActiveSheet.Cells[iRow, (int)COLLECTION_DATA_ASPECT.INSP_SEQ].Value);
                    data_list.AddString("QC_NAME", spdDataCollectionISP.ActiveSheet.Cells[iRow, (int)COLLECTION_DATA_ASPECT.QC_NAME].Value);
                    data_list.AddString("SPEC_VAL", spdDataCollectionISP.ActiveSheet.Cells[iRow, (int)COLLECTION_DATA_ASPECT.SPEC_VAL].Value);
                    data_list.AddDouble("VAL_1", spdDataCollectionISP.ActiveSheet.Cells[iRow, (int)COLLECTION_DATA_ASPECT.VAL_1].Value);  //MEAN
                    data_list.AddDouble("VAL_2", spdDataCollectionISP.ActiveSheet.Cells[iRow, (int)COLLECTION_DATA_ASPECT.VAL_2].Value);  //D10
                    data_list.AddDouble("VAL_3", spdDataCollectionISP.ActiveSheet.Cells[iRow, (int)COLLECTION_DATA_ASPECT.VAL_3].Value);  //D25
                    data_list.AddDouble("VAL_4", spdDataCollectionISP.ActiveSheet.Cells[iRow, (int)COLLECTION_DATA_ASPECT.VAL_4].Value);  //D50
                    data_list.AddDouble("VAL_5", spdDataCollectionISP.ActiveSheet.Cells[iRow, (int)COLLECTION_DATA_ASPECT.VAL_5].Value);  //D75
                    data_list.AddDouble("VAL_6", spdDataCollectionISP.ActiveSheet.Cells[iRow, (int)COLLECTION_DATA_ASPECT.VAL_6].Value);  //D90
                }
        ...
        private void psdSpecChange()
        {
            //PSD 항목들은 이전 마지막 동일품목 검사값을 +-5 스팩으로 가져오도록 변경

            try
            {
                /*
                if(btnJudge.Enabled == false)
                {
                    return;
                }
                */
                ...
                if (TPDR.GetDataOne("", ref dt, "CQCM2004-010", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
                ...
                FarPoint.Win.Spread.SheetView oSheet = spdDataCollection.ActiveSheet;

                for (int iRow = 0; iRow < oSheet.RowCount; iRow++)
                {
                    for (int iRow2 = 0; iRow2 < dt.Rows.Count; iRow2++)
                    {
                        if (oSheet.Cells[iRow, (int)FILEUPLOAD.FILE_NO].Value.ToString() == dt.Rows[iRow2]["CHAR_ID"].ToString())
                        {

                            oSheet.SetValue(iRow, (int)COLLECTION_DATA.LOWER_SPEC_LIMIT, Convert.ToDouble(dt.Rows[iRow2]["LOWER_SPEC_LIMIT"].ToString()));
                            oSheet.SetValue(iRow, (int)COLLECTION_DATA.TARGET_VALUE, Convert.ToDouble(dt.Rows[iRow2]["TARGET_VALUE"].ToString()));
                            oSheet.SetValue(iRow, (int)COLLECTION_DATA.UPPER_SPEC_LIMIT, Convert.ToDouble(dt.Rows[iRow2]["UPPER_SPEC_LIMIT"].ToString()));

                            oSheet.SetValue(iRow, (int)COLLECTION_DATA.SPEC_COL, MPCF.GetSpecInfo(dt.Rows[iRow2]["LOWER_SPEC_LIMIT"].ToString(),
                                                               dt.Rows[iRow2]["LOWER_SPEC_LIMIT"].ToString(),
                                                               dt.Rows[iRow2]["LOWER_SPEC_LIMIT"].ToString()));
                        }
                    }
                }
        ...
        private void CountRest()
        {
            try
            {
                ...
                dvcArgu[3].sCondition_ID = "TABLE_NO";
                ...
                if (TPDR.GetDataOne("", ref dt, "CQCM2004-012", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
                ...
                pictureBox1.Image = ByteArrayToImage((byte[])dt.Rows[0]["MSG"]);
            ...
            try
            {
                ...
                if (MPCF.ToInt(dt.Rows[0]["COL_COUNT"].ToString()) >= 2)
                {
                    ...
                    if (Delete_MFO_ColSet_List(sMatId, sColSetId) != false)
                    {
                        ...
                        // 해당 LOT은 MP품목이십니까? 맞으면Yes 틀리면 No
                        if (MPCF.ShowMsgBox(MPCF.GetMessage(555), MessageBoxButtons.YesNo, 2) == System.Windows.Forms.DialogResult.Yes)
                        {
                            sInColSetId = "GOQ00002";  //MP품목

                        }
                        else
                        {
                            sInColSetId = "GOQ00001";   //일반품목
                        }

                        if (Update_MFO_ColSet_List(sMatId, sInColSetId) != false)
                        {
                ...
                else
                {
                    ...
                    {
                        if (dt.Rows[0]["COL_SET_ID"].ToString() == "GIQ10001" || dt.Rows[0]["COL_SET_ID"].ToString() == "GIQ10002")
                        {
                            bResult = true;
                        }
                        else
        ...
        private bool Update_MFO_ColSet_List(string sMatId, string sInColSetId)
        {
            ...
            try
            {
                ...
                list_item.AddString("COL_SET_ID", sInColSetId);
                ...
                cdvColSetID.Text = sInColSetId;
                cdvColSetID.DisplayText = sInColSetId;
        ...
        private void SaveIQcChange()
        {
            try
            {
                ...
                dvcArgu[4].sCondition_Value = "Judge Change";

                dvcArgu[5].sCondition_ID = "INSP_STATUS";
                dvcArgu[5].sCondition_Value = txtInspectionStatus.Text;

                dvcArgu[6].sCondition_ID = "INSP_RESULT_FLAG";
                dvcArgu[6].sCondition_Value = cdvInspectionJudgeChange.Text;


                if (TPDR.GetDataOne("", ref dt, "CQCM2001-006", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private void Img_copy()
        {

            if (tabControl1.SelectedIndex != 8) //파일등록탭
            {
                return;
            }
            // PictureBox에 이미지가 있는지 확인
            if (pictureBox1.Image != null)
            {
                // PictureBox의 이미지를 클립보드에 복사
                Clipboard.SetImage(pictureBox1.Image);
            }
            else
            {
                MPCF.ShowMsgBox("not imamge file.");
            }
        }
        private void Img_paste()
        {
            if (Clipboard.ContainsImage())
            {
                ...
                string imagePath = Path.Combine(Path.GetTempPath(), "tempImage.jpeg");
        ...
        private void btnProcess_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (tabControl1.SelectedTab.Name == "tpgIcp")
                {
                    // 검사판정 정보, Loss 정보 저장
                    if (Collect_Inspection_Common_Data() == false)
                    {
        ...
        private void txtGradeSizeChange_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (txtGrade.Text.Trim() != "")
                {
                    sGrade = txtGrade.Text.Trim();
                }

                if (txtSizes.Text.Trim() != "")
                {
                    sSize = txtSizes.Text.Trim();
                }
                //GRT 셈플검사경우 CQCMISPSTS 테이블의 CMF에 저장
                if (cdvOper.Text == "OG05260")
                {
                    ssql = "UPDATE CQCMISPSTS SET CMF_7 ='" + sGrade + "'  , CMF_8 = '" + sSize + "' WHERE FACTORY = '" + MPGV.gsFactory + "' AND LOT_ID = '" + txtLotID.Text.Trim() + "'";
                }
                else
                {
                    ssql = "UPDATE MWIPMATDEF SET MAT_CMF_3 ='" + sGrade + "'  , MAT_CMF_2 = '" + sSize + "' WHERE FACTORY = '" + MPGV.gsFactory + "' AND MAT_ID = '" + txtMatID.Text.Trim() + "'";
                }
        ...
        private void frmTranInspectionRegistrationGRIT_Load(object sender, EventArgs e)
        {
            ...
            if (g_PopYn == "Y")
            {
                ...
                tabControl1.SelectedIndex = g_SelectedTab;

                ViewLotInfo(txtLotID.Text);


                //현황에서 팝업으로 나온경우는 품질팀 뺴고는 판정안되도록.

                if (MPGV.gsUserGroup != "QLT_GRP")
                {
                    txtLotID.Enabled = false;
                    btnProcess.Enabled = false;
                    btnJudge.Enabled = false;
                    btnSpec.Enabled = false;
                    brnReturn.Enabled = false;
                    btnColSetId.Enabled = false;
                    btnGCM.Enabled = false;
                    btnGCM2.Enabled = false;
                    btnGCM3.Enabled = false;
                    btnGcmHlt.Enabled = false;
                    btnGcmPsd.Enabled = false;
                    btnGcmTi.Enabled = false;
                    btnGcmTti.Enabled = false;
                    btnCalcAspectRatio.Enabled = false;
                    btnComment.Enabled = false;
                    btnHold.Enabled = false;
                    btnPop.Enabled = false;
                    btnPsdReset.Enabled = false;
                    btnReceive.Enabled = false;
                    btnTiReset.Enabled = false;
                    btnTTIRest.Enabled = false;


                    //    spdFileRegistration.ActiveSheet.Columns[(int)FILEUPLOAD.REGIST].Visible = false;
                    //    spdFileRegistration.ActiveSheet.Columns[(int)FILEUPLOAD.DELETE].Visible = false;
        ...
        private void txtConvexity_Validated(object sender, EventArgs e)
        {
            ...
            txtRoughness.Text = (1 / MPCF.ToDbl(txtConvexity.Text)).ToString();
        ...
        private void txtShapeFactor_Validated(object sender, EventArgs e)
        {
            ...
            txtCirculrarity.Text = ((1 / MPCF.ToDbl(txtShapeFactor.Text)) * (1 / MPCF.ToDbl(txtShapeFactor.Text))).ToString();
        ...
        private void txtSurfaceB_Validated(object sender, EventArgs e)
        {
            ...
            if (spdDataCollectionISP.ActiveSheet.Rows.Count != 0)
            {


                FarPoint.Win.Spread.SheetView oSheet = spdDataCollectionISP.ActiveSheet;


                for (int IspRow = 0; IspRow < oSheet.Rows.Count; IspRow++)
                {
                    if (oSheet.Cells[IspRow, (int)COLLECTION_DATA_ISP.QC_NAME].Value.ToString() == "B")
                    {
                        oSheet.Cells[IspRow, (int)COLLECTION_DATA_ISP.VAL_1].Text = ((TextBox)sender).Text;
                    }
                }
        ...
        private bool Update_Inspection_Status(char procstep)
        {
            ...
            try
            {
                ...
                in_node.AddString("INSP_ID", MPCF.Trim(txtInspID.Text));   //검사 ID
                in_node.AddString("INSP_COMMENT", MPCF.Trim(txtComment.Text));   //비고
        ...
        private void btnPop_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    frmPopSampleRndInspectionLotList popup = new frmPopSampleRndInspectionLotList();
                    popup.StartPosition = FormStartPosition.CenterParent;
                    popup.sArea_id = cdvDept.Text;
                    popup.sArea_desc = cdvDept.DisplayText;
        ...
        private void spdFileRegistration_ButtonClicked_1(object sender, EditorNotifyEventArgs e)
        {
            try
            {
                ...
                else if (e.Column == (int)FILEUPLOAD.DOWNLOAD)
                {

                    FileSaveDelDown(3);
                    //210705 정기훈 과장님 요청 다운로드 기능 추가
        ...
        private void btnComment_Click(object sender, EventArgs e)
        {
            try
            {
                if (Update_Inspection_Status('3') == false)
                    return;
        ...
        private void btnGCM_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                popup.StartPosition = FormStartPosition.CenterParent;
                popup.sTable_name = "C_INSP_BEF_VAL_SPEC";

                popup.sTable_name_desc = "최근검사값을 스펙설정 기준";
                popup.sComment = "등록된 검사항목은 동일품목의 가장 최신 검사값의  등록된 PLUE(+) ,MINUTE(-) 값기준으로 SPEC이 표기됩니다.";
        ...
        private void spdDataCollectionISP_Change(object sender, ChangeEventArgs e)
        {
            try
            {
                ...
                int iActiveRow = spdDataCollectionISP.ActiveSheet.ActiveRowIndex;
                int iRow = e.Row;
                int iCol = e.Column;

                if (e.Column == (int)COLLECTION_DATA_ASPECT.VAL_1)
                {

                    if (spdDataCollectionISP.ActiveSheet.Cells[iActiveRow, (int)COLLECTION_DATA_ASPECT.QC_NAME].Text == "B")
                    {
                        txtSurfaceB.Text = spdDataCollectionISP.ActiveSheet.Cells[iActiveRow, (int)COLLECTION_DATA_ASPECT.VAL_1].Text;
                    }
        ...
        private void btnPsdReset_Click(object sender, EventArgs e)
        {

        }
        private void btnTiReset_Click(object sender, EventArgs e)
        {

        }
        private void btnTTIRest_Click(object sender, EventArgs e)
        {

        }
        private void btnHLTReset_Click(object sender, EventArgs e)
        {
        ...
        private void btnInspectionJudgeChange_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                switch (cdvInspectionJudgeFlag.Text)
                {
                    ...
                    case "F":
                    case "E":
                        if (cdvInspectionJudgeChange.Text == "F" || cdvInspectionJudgeChange.Text == "E")
                        {
                            if (MPCF.ShowMsgBox(MPCF.GetMessage(567), MessageBoxButtons.YesNo, 1) == System.Windows.Forms.DialogResult.Yes)
                            {
                                SaveIQcChange();
                            }
                        }
        ...
        private void FileSaveDelDown(int icase)
        {
            ...
            else if (icase == 3) //다운로드
            {
                ...
                dialog.FileName = Environment.GetFolderPath(Environment.SpecialFolder.Startup).ToString() + "\\" + txtLotID.Text + "_" + MPCF.Trim(spdFileRegistration.ActiveSheet.Cells[iActiveRow, (int)FILEUPLOAD.NAME].Value.ToString()) + ".jpg";
                dialog.Filter = "JPG (*.JPG, *.JPEG) | *.jpg; *.jpeg | 모든 파일 (*.*) | *.*";
        ...
        private void frmTranInspectionRegistrationGRIT_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btnGcmPsd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmPopGcmData popup = new frmPopGcmData();
                popup.StartPosition = FormStartPosition.CenterParent;
                popup.sTable_name = "C_INSP_PSD_MESH";

                popup.sTable_name_desc = "PSD Sieve Size";
                popup.sComment = "Size 별로 입력바랍니다.";
        ...
        private void btnGcmTi_MouseCaptureChanged(object sender, EventArgs e)
        {

        }
        private void btnGcmTi_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmPopGcmData popup = new frmPopGcmData();
                popup.StartPosition = FormStartPosition.CenterParent;
                popup.sTable_name = "C_INSP_BI_MESH";

                popup.sTable_name_desc = "TI/TTI Sieve Size";
                popup.sComment = "Size 별로 입력바랍니다.";
        ...
        private void btnGcmTti_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnGcmHlt_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmPopGcmData popup = new frmPopGcmData();
                popup.StartPosition = FormStartPosition.CenterParent;
                popup.sTable_name = "C_INSP_GRIT_SIZE";

                popup.sTable_name_desc = "Grit 더블 사이즈 체크 ";
                popup.sComment = "..";
        ...
        private void frmTranInspectionRegistrationGRIT_DragDrop(object sender, DragEventArgs e)
        {
        ...
        private void frmTranInspectionRegistrationGRIT_DragEnter(object sender, DragEventArgs e)
        {
