...
namespace CUS_QCM
{
    public partial class frmTranShipReportSpecRegistraionByGrade : CUS_COM.frmTranForm05
    {
        public frmTranShipReportSpecRegistraionByGrade()
        {
            InitializeComponent();
        ...
        private void btnRowAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                spdSpecList_Sheet1.Cells[iRow, (int)SPEC.DELIVERY_ID].Value = spdDeliveryList_Sheet1.Cells[spdDeliveryList_Sheet1.ActiveRowIndex, (int)DELIVERY.DELIVERY_ID].Value;
            }
            catch(Exception ex)
            {
                MPCF.ShowMsgBox(ex.Message);
