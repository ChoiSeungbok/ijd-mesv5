namespace CUS_QCM
{
    partial class frmTranShipReportRegistration_Union
    {
        ...
        private void InitializeComponent()
        {
            ...
            // lblDirectQuery
            // 
            this.lblDirectQuery.Location = new System.Drawing.Point(2596, 30);
            // 
            // pnlStsCond
            // 
            ...
            // lblFormName
            // 
            this.lblFormName.Size = new System.Drawing.Size(299, 30);
            ...
            namedStyle6.Renderer = columnHeaderRenderer1;
            ...
            namedStyle10.Renderer = columnHeaderRenderer36;
            ...
            this.spdPackingLotList.SetViewportLeftColumn(0, 0, 16);
            // 
            ...
            this.spdPackingLotList_Sheet1.ColumnCount = 48;
            ...
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 12).ColumnSpan = 4;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "Dimension";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 16).ColumnSpan = 6;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 16).Value = "TOTAL THICKNESS";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 22).ColumnSpan = 6;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 22).Value = "Report Spec Data";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 28).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 28).Value = "Comment";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 29).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 29).Value = "Remark";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 30).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 30).Value = "IMAGE_NUM1";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 31).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 31).Value = "IMAGE_NUM2";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 32).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 32).Value = "OUTSIDE_MIN";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 33).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 33).Value = "OUTSIDE_MAX";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 34).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 34).Value = "LENGTH_MIN";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 35).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 35).Value = "LENGTH_MAX";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 36).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 36).Value = "SG_MIN";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 37).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 37).Value = "SG_MAX";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 38).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 38).Value = "MS_MIN";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 39).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 39).Value = "MS_MAX";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 40).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 40).Value = "HC_MIN";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 41).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 41).Value = "HC_MAX";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 42).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 42).Value = "HV_MIN";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 43).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 43).Value = "HV_MAX";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 44).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 44).Value = "TRS_MIN";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 45).RowSpan = 2;
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(0, 45).Value = "TRS_MAX";
            ...
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 14).Value = "ID-Meter";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 15).Value = "Height(H)";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 16).Value = "Density (g/cm3)";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 17).Value = "Magnetic Satiration";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 18).Value = "Coercive Force";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 19).Value = "Hardness Hv20(Hv30)/HRA";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 20).Value = "TRS Kgf/mm2";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 21).Value = "Grain Size";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 22).Value = "Density (g/cm3)";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 23).Value = "Magnetic Satiration";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 24).Value = "Coercive Force";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 25).Value = "Hardness Hv20(Hv30)/HRA";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 26).Value = "TRS Kgf/mm2";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 27).Value = "Grain Size";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 46).Value = "GrainSize Min";
            this.spdPackingLotList_Sheet1.ColumnHeader.Cells.Get(1, 47).Value = "GrainSizeMax";
            ...
            numberCellType1.FractionDenominatorDigits = 4;
            numberCellType1.MaximumValue = 9999999.999D;
            numberCellType1.MinimumValue = -9999999.999D;
            this.spdPackingLotList_Sheet1.Columns.Get(12).CellType = numberCellType1;
            ...
            this.spdPackingLotList_Sheet1.Columns.Get(12).Width = 80F;
            ...
            numberCellType2.FractionDenominatorDigits = 4;
            numberCellType2.MaximumValue = 9999999.999D;
            numberCellType2.MinimumValue = -9999999.999D;
            this.spdPackingLotList_Sheet1.Columns.Get(13).CellType = numberCellType2;
            ...
            this.spdPackingLotList_Sheet1.Columns.Get(13).Width = 126F;
            ...
            this.spdPackingLotList_Sheet1.Columns.Get(14).CellType = numberCellType3;
            this.spdPackingLotList_Sheet1.Columns.Get(14).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.spdPackingLotList_Sheet1.Columns.Get(14).Label = "ID-Meter";
            this.spdPackingLotList_Sheet1.Columns.Get(14).Width = 121F;
            ...
            this.spdPackingLotList_Sheet1.Columns.Get(15).CellType = numberCellType4;
            this.spdPackingLotList_Sheet1.Columns.Get(15).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.spdPackingLotList_Sheet1.Columns.Get(15).Label = "Height(H)";
            this.spdPackingLotList_Sheet1.Columns.Get(15).Width = 111F;
            ...
            this.spdPackingLotList_Sheet1.Columns.Get(16).CellType = numberCellType5;
            this.spdPackingLotList_Sheet1.Columns.Get(16).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.spdPackingLotList_Sheet1.Columns.Get(16).Label = "Density (g/cm3)";
            this.spdPackingLotList_Sheet1.Columns.Get(16).Width = 113F;
            ...
            this.spdPackingLotList_Sheet1.Columns.Get(17).CellType = numberCellType6;
            this.spdPackingLotList_Sheet1.Columns.Get(17).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.spdPackingLotList_Sheet1.Columns.Get(17).Label = "Magnetic Satiration";
            this.spdPackingLotList_Sheet1.Columns.Get(17).Width = 150F;
            ...
            this.spdPackingLotList_Sheet1.Columns.Get(18).CellType = numberCellType7;
            this.spdPackingLotList_Sheet1.Columns.Get(18).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.spdPackingLotList_Sheet1.Columns.Get(18).Label = "Coercive Force";
            this.spdPackingLotList_Sheet1.Columns.Get(18).Width = 111F;
            ...
            this.spdPackingLotList_Sheet1.Columns.Get(19).CellType = numberCellType8;
            this.spdPackingLotList_Sheet1.Columns.Get(19).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.spdPackingLotList_Sheet1.Columns.Get(19).Label = "Hardness Hv20(Hv30)/HRA";
            this.spdPackingLotList_Sheet1.Columns.Get(19).Width = 211F;
            this.spdPackingLotList_Sheet1.Columns.Get(20).Label = "TRS Kgf/mm2";
            this.spdPackingLotList_Sheet1.Columns.Get(20).Width = 103F;
            this.spdPackingLotList_Sheet1.Columns.Get(21).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.spdPackingLotList_Sheet1.Columns.Get(21).Label = "Grain Size";
            this.spdPackingLotList_Sheet1.Columns.Get(21).Width = 105F;
            this.spdPackingLotList_Sheet1.Columns.Get(22).Label = "Density (g/cm3)";
            this.spdPackingLotList_Sheet1.Columns.Get(22).Width = 109F;
            this.spdPackingLotList_Sheet1.Columns.Get(23).Label = "Magnetic Satiration";
            this.spdPackingLotList_Sheet1.Columns.Get(23).Width = 134F;
            this.spdPackingLotList_Sheet1.Columns.Get(24).Label = "Coercive Force";
            this.spdPackingLotList_Sheet1.Columns.Get(24).Width = 104F;
            this.spdPackingLotList_Sheet1.Columns.Get(25).Label = "Hardness Hv20(Hv30)/HRA";
            this.spdPackingLotList_Sheet1.Columns.Get(25).Width = 180F;
            this.spdPackingLotList_Sheet1.Columns.Get(26).Label = "TRS Kgf/mm2";
            this.spdPackingLotList_Sheet1.Columns.Get(26).Width = 97F;
            this.spdPackingLotList_Sheet1.Columns.Get(27).Label = "Grain Size";
            this.spdPackingLotList_Sheet1.Columns.Get(27).Width = 96F;
            this.spdPackingLotList_Sheet1.Columns.Get(28).CellType = textCellType1;
            this.spdPackingLotList_Sheet1.Columns.Get(28).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.spdPackingLotList_Sheet1.Columns.Get(28).Width = 174F;
            this.spdPackingLotList_Sheet1.Columns.Get(29).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.spdPackingLotList_Sheet1.Columns.Get(29).Width = 273F;
            this.spdPackingLotList_Sheet1.Columns.Get(30).Locked = true;
            this.spdPackingLotList_Sheet1.Columns.Get(30).Visible = false;
            this.spdPackingLotList_Sheet1.Columns.Get(30).Width = 0F;
            this.spdPackingLotList_Sheet1.Columns.Get(31).Locked = true;
            this.spdPackingLotList_Sheet1.Columns.Get(31).Visible = false;
            this.spdPackingLotList_Sheet1.Columns.Get(31).Width = 0F;
            this.spdPackingLotList_Sheet1.Columns.Get(32).Locked = true;
            this.spdPackingLotList_Sheet1.Columns.Get(32).Visible = false;
            this.spdPackingLotList_Sheet1.Columns.Get(32).Width = 0F;
            this.spdPackingLotList_Sheet1.Columns.Get(33).Locked = true;
            this.spdPackingLotList_Sheet1.Columns.Get(33).Visible = false;
            this.spdPackingLotList_Sheet1.Columns.Get(33).Width = 0F;
            ...
            this.spdPackingLotList_Sheet1.Columns.Get(46).Label = "GrainSize Min";
            this.spdPackingLotList_Sheet1.Columns.Get(46).Visible = false;
            this.spdPackingLotList_Sheet1.Columns.Get(46).Width = 0F;
            this.spdPackingLotList_Sheet1.Columns.Get(47).Label = "GrainSizeMax";
            ...
            this.cdvShipReportType.Size = new System.Drawing.Size(224, 26);
            ...
            this.cdvShipReportType.TextBoxWidth = 224;
            ...
            this.cdvShipReportType.ButtonPress += new System.EventHandler(this.mcCodeView1_ButtonPress);
            // 
            // lblShipReportType
            // 
