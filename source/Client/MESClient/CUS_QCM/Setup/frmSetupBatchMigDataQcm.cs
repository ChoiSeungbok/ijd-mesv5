...
namespace CUS_QCM
{
    public partial class frmSetupBatchMigDataQcm : frmTranForm02
    {
        public frmSetupBatchMigDataQcm()
        {
            InitializeComponent();
            InitControl();
        }
        ...
        private void frmSetupBatchMigDataQcm_Load(object sender, EventArgs e)
        {
            try
            {
               ...
               // cdvInspectionType.Text = "RPT";         //default: Inspection Report
               // cdvInspectionType.DisplayText = "RPT";
        ...
        private void btnProcess_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                in_node.AddString("QCM_OPER", cdvOper.Text);
                ...
                in_node.AddString("MAT_CODE", this.cdvMatId.Text);
                in_node.AddString("QC_NO", txtInspectionID.Text);
                in_node.AddString("LOT_NO", txtLotID.Text);

                if (MPCR.CallService("CUS_QCM", "CUS_QCM_Batch_Mig_Data_Qcm", in_node, ref out_node) == false)
                {
