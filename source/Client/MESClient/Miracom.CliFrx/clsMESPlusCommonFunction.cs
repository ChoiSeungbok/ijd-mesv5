    ...
    public sealed class MPCF
    {
        ...
        public static string MakeDateFormat(string S, DATE_TIME_FORMAT DateTimeFormat)
        {
            ...
            try
            {
                ...
                if (DateTimeFormat == DATE_TIME_FORMAT.DATETIMEMS)
                {
                    if (S.Length < 17)
                    {
                        sReturn = "";
                    ...
                    case LANG_FORMAT.STANDARD:
                        ...
                        switch (DateTimeFormat)
                        {
                            ...
                            case DATE_TIME_FORMAT.TIME: //Time (hh:mm:ss)
                                ...
                                break;
                            case DATE_TIME_FORMAT.DATETIMEMS: //DateTime (YYYY/MM/DD/ hh:mm:ss.ms)

                                sReturn = S.Substring(0, 4) + MPGV.gsDateDelimiter + S.Substring(4, 2) + MPGV.gsDateDelimiter + S.Substring(6, 2) + " " + S.Substring(8, 2) + ":" + S.Substring(10, 2) + ":" + S.Substring(12, 2) + "." + S.Substring(14, 2);
                                break;
                            default:
        ...
        public static bool ExportToExcel(Control l_Control, string title, string Condition, bool ColorFlag, bool bTextBase, bool bShowDate, int iStartCol, int iEndCol)
        {
            try
            {
                ...
                {
                    ShowMsgBox(MPCF.GetMessage(366) + " : " + l_Control.ToString());
                    return false;
                }
            }
            catch (Exception ex)
