...
namespace Miracom.CliFrx
{
    public sealed class MPGC
    {
        ...
        public const int MESSAGE_INDEX = 34;                // <<Check>> 사용하는곳이 없음
        public const int MESSAGE_OPEN_ICON_INDEX = 51;      // <<Check>> 사용하는곳이 없음 
        public const int MESSAGE_CLOSE_ICON_INDEX = 52;     // <<Check>> 사용하는곳이 없음
        ...
        public const int ADM_IDLE_STATUS = 0;    //IDLE 상태
        public const int ADM_REQUEST_STATUS = 1;    //서버에 요청을 한상태
        public const int ADM_REPLY_STATUS = 2;   //서버로부터 응답을 받음
        ...
        public const int MP_MAX_SLOT_CNT = 1000; //理쒕? Slot 媛?닔
        public const int MP_MAX_BATCH_CNT = 12; //Batch???ы븿?좎닔 ?덈뒗 Lot??理쒕? 媛쒖닔
        ...
        public const int MP_MDI_CHILD_HEIGHT = 580; //MDI Child Form???믪씠
