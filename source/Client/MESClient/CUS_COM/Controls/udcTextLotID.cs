...
{
    public partial class udcTextLotID : UserControl, intCodeListControl
    {
        public udcTextLotID()
        {
            InitializeComponent();
        ...
        private void udcTextLotID_Load(object sender, EventArgs e)
        {
        ...
        private void btnPop_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frmPopLotList popup = new frmPopLotList();
                popup.StartPosition = FormStartPosition.CenterParent;
                popup.sArea_id = sArea_id;
                popup.sArea_desc = sArea_desc;
                popup.sSub_area_id = sSub_Area_id;
                popup.sSub_area_desc = sSub_Area_desc;
                popup.sOper_id = sOper_id;
                popup.sOper_desc = sOper_desc;
                popup.sOrder_id = sOrder;
                popup.sRes_id = sRes_id;
                popup.sRes_desc = sRes_desc;

                if (sOperReadOnly == "N")
                {
                    popup.cdvOper.Enabled = true;
                }
                ...
                if (popup.ShowDialog() == DialogResult.OK)
                {
                    ...
                    else if (CSGV.l_lot_list.Count > 0)
                    {
