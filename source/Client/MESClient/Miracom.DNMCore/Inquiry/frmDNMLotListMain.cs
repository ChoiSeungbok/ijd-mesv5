            ...
            */
            ...
            try
            {
                ...
                if (c_step == '1')
                {
                    ...
                    a[0].sCondition_ID = "$FACTORY";
                    a[0].sCondition_Value = MPGV.gsFactory;
                    a[1].sCondition_ID = "$OPER";
                    a[1].sCondition_Value = s_current_oper;
                    a[2].sCondition_ID = "$MAT_ID";
                    ...
                    a[4].sCondition_ID = "$INCLUNDE_ADJ_LOT";
                    ...
                    a[6].sCondition_ID = "$LONG_TERM_FLAG";
                ...
                else
                {
                    ...
                    a[2].sCondition_ID = "$INCLUNDE_ADJ_LOT";
                    if (chkIncludeAdjustLot.Checked == false)
                    {
