...
namespace CUS_INV
{
    public partial class frmViewDlvLotList : CUS_COM.frmViewForm01
    {
        public frmViewDlvLotList()
        {
            InitializeComponent();
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                spdLabelList_Sheet1.SheetName = "Sheet2";
                excelSp.Sheets.Add(spdLabelList_Sheet1);
