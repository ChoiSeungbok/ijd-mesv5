...
namespace CUS_INV
{
    public partial class frmTranEtcOutInvLot : CUS_COM.frmTranForm05
    {
        public frmTranEtcOutInvLot()
        {
            InitializeComponent();
        ...
        private void frmTranEtcOutInvLot_Load(object sender, EventArgs e)
        {
        ...
        private void InitControl()
        {
            try
            {
                ...
                if (MPCF.GetRegSetting(System.Windows.Forms.Application.ProductName, this.Name, chkZeroQty.Name) == "Y")
                {
                    chkZeroQty.Checked = true;
                }
                else
                {
                    chkZeroQty.Checked = false;
                }
            ...
            try
            {
               ...
               // dvcArgu[4].sCondition_Value = sMatType == CSGC.CP_RAW_MATERIAL ? "Y" : "N";
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        spdLotList_Sheet1.Cells[i, (int)LOT.OUT_QTY].Value = 0;
                    }
                    else
                    {
        ...
        private void chkZeroQty_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                MPCF.SaveRegSetting(Application.ProductName, this.Name, chkZeroQty.Name, "Y");
            }
            else
            {
                MPCF.SaveRegSetting(Application.ProductName, this.Name, chkZeroQty.Name, "N");
            }

        }

        private void btnErpAccountList_Click(object sender, EventArgs e)
        {
