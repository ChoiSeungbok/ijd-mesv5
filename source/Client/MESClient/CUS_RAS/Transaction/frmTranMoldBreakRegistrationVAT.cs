...
namespace CUS_RAS
{
    public partial class frmTranMoldBreakRegistrationVAT : CUS_COM.frmTranForm05
    {
        public frmTranMoldBreakRegistrationVAT()
        {
            InitializeComponent();
            InitControl();
        }
        ...
        private void ViewToolInfo()
        {
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CRAS2012-001", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.BO_PRESSURE].Value = dt.Rows[i]["BO_PRESSURE"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.BO_ELECTRICITY].Value = dt.Rows[i]["BO_ELECTRICITY"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.BO_RESISTANCE].Value = dt.Rows[i]["BO_RESISTANCE"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.BO_CURRENT].Value = dt.Rows[i]["BO_CURRENT"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.HOLD_LOT_ID].Value = dt.Rows[i]["HOLD_LOT_ID"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.ASSY_MOLD].Value = dt.Rows[i]["ASSY_MOLD"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.ASSY_MOLD_PRESSURE].Value = dt.Rows[i]["ASSY_MOLD_PRESSURE"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.PROFILE_NO].Value = dt.Rows[i]["PROFILE_NO"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.PROFILE_PRESSURE].Value = dt.Rows[i]["PROFILE_PRESSURE"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.PROFILE_ELECTRICITY].Value = dt.Rows[i]["PROFILE_ELECTRICITY"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.MOLD_LOCATION].Value = dt.Rows[i]["MOLD_LOCATION"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.MOD_IN_FORN_LOT].Value = dt.Rows[i]["MOD_IN_FORN_LOT"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.MOD_IN_REAR_LOT].Value = dt.Rows[i]["MOD_IN_REAR_LOT"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.MOD_IN_LEFT_LOT].Value = dt.Rows[i]["MOD_IN_LEFT_LOT"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.MOD_IN_RIGHT_LOT].Value = dt.Rows[i]["MOD_IN_RIGHT_LOT"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.MOD_IN_TOP_LOT].Value = dt.Rows[i]["MOD_IN_TOP_LOT"];
                    spdToolList.ActiveSheet.Cells[i, (int)MOLD_INFO.MOD_IN_BOTTON_LOT].Value = dt.Rows[i]["MOD_IN_BOTTON_LOT"];
        ...
        private bool SaveData()
        {
            try
            {
                ...
                in_node.AddString("CROWN_NO", txtholdLotid.Text);
                ...
                in_node.AddString("BO_PRESSURE", txtBoPressure.Text);
                in_node.AddString("BO_ELECTRICITY", txtBoElectricity.Text);
                in_node.AddString("BO_RESISTANCE", txtBoResistance.Text);
                in_node.AddString("BO_CURRENT", txtBoCurrent.Text);
                in_node.AddString("HOLD_LOT_ID", txtholdLotid.Text);
                in_node.AddString("ASSY_MOLD", txtlblAssyMold.Text);
                in_node.AddString("ASSY_MOLD_PRESSURE", txtAssyMoldPressure.Text);
                in_node.AddString("PROFILE_NO", cdvProfileNo.Text);
                in_node.AddString("PROFILE_PRESSURE", txtProfliePressure.Text);
                in_node.AddString("PROFILE_ELECTRICITY", txtProfileElectricity.Text);
                in_node.AddString("MOLD_LOCATION", cdvMoldLocation.Text);
                in_node.AddString("MOD_IN_FORN_LOT", txtMoldInFornLot.Text);
                in_node.AddString("MOD_IN_REAR_LOT", txtMoldInRearLot.Text);
                in_node.AddString("MOD_IN_LEFT_LOT", txtMoldInLeftLot.Text);
                in_node.AddString("MOD_IN_RIGHT_LOT", txtMoldInRightLot.Text);
                in_node.AddString("MOD_IN_TOP_LOT", txtMoldInTopLot.Text);
                in_node.AddString("MOD_IN_BOTTON_LOT", txtMoldInBottonLot.Text);
        ...
        private void frmTranMoldBreakRegistrationVAT_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (chkHold.Checked == false)
                    {
                        ...
                        txtholdLotid.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.CROWN_NO].Text;
                        ...
                        txtBoPressure.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.BO_PRESSURE].Text;
                        txtBoElectricity.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.BO_ELECTRICITY].Text;
                        txtBoResistance.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.BO_RESISTANCE].Text;
                        txtBoCurrent.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.BO_CURRENT].Text;
                        txtholdLotid.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.HOLD_LOT_ID].Text;
                        txtlblAssyMold.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.ASSY_MOLD].Text;
                        txtAssyMoldPressure.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.ASSY_MOLD_PRESSURE].Text;
                        cdvProfileNo.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.PROFILE_NO].Text;
                        txtProfliePressure.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.PROFILE_PRESSURE].Text;
                        txtProfileElectricity.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.PROFILE_ELECTRICITY].Text;
                        cdvMoldLocation.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.MOLD_LOCATION].Text;
                        txtMoldInFornLot.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.MOD_IN_FORN_LOT].Text;
                        txtMoldInRearLot.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.MOD_IN_FORN_LOT].Text;
                        txtMoldInLeftLot.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.MOD_IN_LEFT_LOT].Text;
                        txtMoldInRightLot.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.MOD_IN_RIGHT_LOT].Text;
                        txtMoldInTopLot.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.MOD_IN_TOP_LOT].Text;
                        txtMoldInBottonLot.Text = spdToolList.ActiveSheet.Cells[e.Row, (int)MOLD_INFO.MOD_IN_BOTTON_LOT].Text;
        ...
        private void cdvResId_ButtonPress(object sender, EventArgs e)
        {
            ...
            in_node.AddString("SQL", "SELECT RES_ID AS CODE, RES_DESC AS VALUE FROM MRASRESDEF  WHERE RES_GRP_1 ='E002' ");
            ...
            do
            {
                ...
                MPCR.FillDataView(cdvResId.GetListView, out_node);
        ...
        private void cdvProfileNo_ButtonPress(object sender, EventArgs e)
        {
            //C_PROFILE_DEF
            ...
            try
            {
                cdvProfileNo.Init();
                MPCF.InitListView(cdvIssueType.GetListView);
                cdvProfileNo.Columns.Add("Operation", 0, HorizontalAlignment.Left);
                cdvProfileNo.Columns.Add("Desc", 100, HorizontalAlignment.Left);
                cdvProfileNo.SelectedSubItemIndex = 0;
                cdvProfileNo.DisplaySubItemIndex = 1;

                if (BASLIST.ViewGCMDataList(cdvProfileNo.GetListView, '1', "C_PROFILE_DEF") == false)
                {
                    return;
                }

                cdvProfileNo.InsertEmptyRow(0, 1);
            }
            catch (Exception ex)
            {
                MPCF.ShowMsgBox(ex.Message);
        ...
        private void cdvMoldLocation_ButtonPress(object sender, EventArgs e)
        {
            try
            {
                cdvMoldLocation.Init();
                MPCF.InitListView(cdvIssueType.GetListView);
                cdvMoldLocation.Columns.Add("Operation", 0, HorizontalAlignment.Left);
                cdvMoldLocation.Columns.Add("Desc", 100, HorizontalAlignment.Left);
                cdvMoldLocation.SelectedSubItemIndex = 0;
                cdvMoldLocation.DisplaySubItemIndex = 1;

                if (BASLIST.ViewGCMDataList(cdvMoldLocation.GetListView, '1', "C_PAN") == false)
                {
                    return;
                }

                cdvMoldLocation.InsertEmptyRow(0, 1);
            }
            catch (Exception ex)
            {
                MPCF.ShowMsgBox(ex.Message);
