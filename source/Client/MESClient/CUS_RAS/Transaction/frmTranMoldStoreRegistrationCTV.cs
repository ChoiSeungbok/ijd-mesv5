...
namespace CUS_RAS
{
    public partial class frmTranMoldStoreRegistrationCTV : CUS_COM.frmTranForm05
    {
        public frmTranMoldStoreRegistrationCTV()
        {
            InitializeComponent();
        ...
        private void ViewMoldList()
        {
            ...
            try
            {
                ...
                dvcArgu[7].sCondition_ID = "VENDOR_LOT_ID";
                dvcArgu[7].sCondition_Value = txtVendorLot.Text;


                dvcArgu[8].sCondition_ID = "PO_NO";
                dvcArgu[8].sCondition_Value = txtPoNo.Text;
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    spdMoldList_Sheet1.Cells[i, (int)MOLD_INFO.PO_NO].Value = dt.Rows[i]["PO_NO"];
                    spdMoldList_Sheet1.Cells[i, (int)MOLD_INFO.PO_SEQ].Value = dt.Rows[i]["PO_SEQ"];
        ...
        private void frmTranMoldWarehouseRegistration_Load(object sender, EventArgs e)
        {
            try
            {
                dtpFromDate.Value = dtpToDate.Value.AddDays(-365);
