namespace CUS_RAS
{
    partial class frmViewCTMBallmillData
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.spdBallmill = new FarPoint.Win.Spread.FpSpread();
            this.spdBallmill_Sheet1 = new FarPoint.Win.Spread.SheetView();
            ...
            this.cdvSide = new Miracom.UI.Controls.MCCodeView.MCCodeView();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.spdBallmill)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.spdBallmill_Sheet1)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.cdvOper)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.cdvSide)).BeginInit();
            this.SuspendLayout();
            // 
            // lblDept
            // 
            ...
            // pnlStsCond
            // 
            this.pnlStsCond.Controls.Add(this.lblSide);
            this.pnlStsCond.Controls.Add(this.cdvSide);
            ...
            this.pnlStsCond.Controls.SetChildIndex(this.cdvSide, 0);
            this.pnlStsCond.Controls.SetChildIndex(this.lblSide, 0);
            // 
            // pnlMID
            // 
            ...
            // lblFormName
            // 
            this.lblFormName.Size = new System.Drawing.Size(316, 37);
            this.lblFormName.Text = "View CTM Ballmill Data";
            // 
            // lblDirectQuery
            // 
            this.lblDirectQuery.Location = new System.Drawing.Point(1614, 38);
            // 
            // btnView
            // 
            ...
            this.grpToolHisInfo.Controls.Add(this.spdBallmill);
            ...
            // spdBallmill
            // 
            this.spdBallmill.AccessibleDescription = "spdWorkOrder, Sheet1, Row 0, Column 0, ";
            this.spdBallmill.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.spdBallmill.Dock = System.Windows.Forms.DockStyle.Fill;
            this.spdBallmill.FocusRenderer = defaultFocusIndicatorRenderer1;
            this.spdBallmill.HorizontalScrollBar.Buttons = new FarPoint.Win.Spread.FpScrollBarButtonCollection("BackwardLineButton,ThumbTrack,ForwardLineButton");
            this.spdBallmill.HorizontalScrollBar.Name = "";
            this.spdBallmill.HorizontalScrollBar.Renderer = defaultScrollBarRenderer1;
            this.spdBallmill.HorizontalScrollBarPolicy = FarPoint.Win.Spread.ScrollBarPolicy.AsNeeded;
            this.spdBallmill.Location = new System.Drawing.Point(1, 19);
            this.spdBallmill.Margin = new System.Windows.Forms.Padding(0);
            this.spdBallmill.Name = "spdBallmill";
            ...
            this.spdBallmill.NamedStyles.AddRange(new FarPoint.Win.Spread.NamedStyle[] {
            namedStyle1,
            namedStyle2,
            namedStyle3,
            namedStyle4,
            ...
            namedStyle8,
            namedStyle9});
            this.spdBallmill.Sheets.AddRange(new FarPoint.Win.Spread.SheetView[] {
            this.spdBallmill_Sheet1});
            this.spdBallmill.Size = new System.Drawing.Size(1350, 526);
            ...
            this.spdBallmill.Skin = spreadSkin1;
            this.spdBallmill.TabIndex = 252;
            this.spdBallmill.TabStop = false;
            this.spdBallmill.VerticalScrollBar.Buttons = new FarPoint.Win.Spread.FpScrollBarButtonCollection("BackwardLineButton,ThumbTrack,ForwardLineButton");
            this.spdBallmill.VerticalScrollBar.Name = "";
            this.spdBallmill.VerticalScrollBar.Renderer = defaultScrollBarRenderer3;
            this.spdBallmill.VerticalScrollBarPolicy = FarPoint.Win.Spread.ScrollBarPolicy.AsNeeded;
            this.spdBallmill.SetViewportLeftColumn(0, 0, 3);
            this.spdBallmill.SetActiveViewport(0, 1, -1);
            // 
            // spdBallmill_Sheet1
            // 
            this.spdBallmill_Sheet1.Reset();
            this.spdBallmill_Sheet1.SheetName = "Sheet1";
            // Formulas and custom names must be loaded with R1C1 reference style
            this.spdBallmill_Sheet1.ReferenceStyle = FarPoint.Win.Spread.Model.ReferenceStyle.R1C1;
            this.spdBallmill_Sheet1.ColumnCount = 13;
            this.spdBallmill_Sheet1.RowCount = 0;
            this.spdBallmill_Sheet1.ActiveColumnIndex = -1;
            this.spdBallmill_Sheet1.ActiveRowIndex = -1;
            this.spdBallmill_Sheet1.ColumnFooter.DefaultStyle.HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            this.spdBallmill_Sheet1.ColumnFooter.DefaultStyle.NoteIndicatorColor = System.Drawing.Color.Red;
            this.spdBallmill_Sheet1.ColumnFooter.DefaultStyle.Parent = "HeaderDefault";
            this.spdBallmill_Sheet1.ColumnFooter.DefaultStyle.VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.General;
            this.spdBallmill_Sheet1.ColumnFooter.Visible = true;
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 0).Value = "Resource Code";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 1).Value = "Resource";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "Work Date";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "Work Time";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "SV Time";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "PV Time";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "SV RPM";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "PV RPM";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "Lot ID";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "Mat ID";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "Material";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "Side";
            this.spdBallmill_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "Status";
            this.spdBallmill_Sheet1.ColumnHeader.DefaultStyle.Border = bevelBorder2;
            this.spdBallmill_Sheet1.ColumnHeader.DefaultStyle.HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdBallmill_Sheet1.ColumnHeader.DefaultStyle.NoteIndicatorColor = System.Drawing.Color.Red;
            this.spdBallmill_Sheet1.ColumnHeader.DefaultStyle.Parent = "Style1";
            this.spdBallmill_Sheet1.ColumnHeader.DefaultStyle.VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.ColumnHeader.Rows.Get(0).Height = 24F;
            this.spdBallmill_Sheet1.Columns.Get(0).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(0).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.spdBallmill_Sheet1.Columns.Get(0).Label = "Resource Code";
            this.spdBallmill_Sheet1.Columns.Get(0).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(0).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(0).Visible = false;
            this.spdBallmill_Sheet1.Columns.Get(0).Width = 107F;
            this.spdBallmill_Sheet1.Columns.Get(1).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(1).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.spdBallmill_Sheet1.Columns.Get(1).Label = "Resource";
            this.spdBallmill_Sheet1.Columns.Get(1).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(1).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(1).Width = 70F;
            this.spdBallmill_Sheet1.Columns.Get(2).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(2).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(2).Label = "Work Date";
            this.spdBallmill_Sheet1.Columns.Get(2).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(2).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(2).Width = 75F;
            this.spdBallmill_Sheet1.Columns.Get(3).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(3).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(3).Label = "Work Time";
            this.spdBallmill_Sheet1.Columns.Get(3).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(3).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(3).Width = 77F;
            this.spdBallmill_Sheet1.Columns.Get(4).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(4).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(4).Label = "SV Time";
            this.spdBallmill_Sheet1.Columns.Get(4).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(4).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(4).Width = 66F;
            this.spdBallmill_Sheet1.Columns.Get(5).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(5).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(5).Label = "PV Time";
            this.spdBallmill_Sheet1.Columns.Get(5).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(5).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(5).Width = 66F;
            this.spdBallmill_Sheet1.Columns.Get(6).AllowAutoSort = true;
            numberCellType1.DecimalPlaces = 4;
            numberCellType1.ShowSeparator = true;
            this.spdBallmill_Sheet1.Columns.Get(6).CellType = numberCellType1;
            this.spdBallmill_Sheet1.Columns.Get(6).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.spdBallmill_Sheet1.Columns.Get(6).Label = "SV RPM";
            this.spdBallmill_Sheet1.Columns.Get(6).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(6).Width = 71F;
            this.spdBallmill_Sheet1.Columns.Get(7).AllowAutoSort = true;
            numberCellType2.DecimalPlaces = 4;
            numberCellType2.ShowSeparator = true;
            this.spdBallmill_Sheet1.Columns.Get(7).CellType = numberCellType2;
            this.spdBallmill_Sheet1.Columns.Get(7).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.spdBallmill_Sheet1.Columns.Get(7).Label = "PV RPM";
            this.spdBallmill_Sheet1.Columns.Get(7).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(7).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(7).Width = 71F;
            this.spdBallmill_Sheet1.Columns.Get(8).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(8).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.spdBallmill_Sheet1.Columns.Get(8).Label = "Lot ID";
            this.spdBallmill_Sheet1.Columns.Get(8).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(8).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(8).Visible = false;
            this.spdBallmill_Sheet1.Columns.Get(9).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(9).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.spdBallmill_Sheet1.Columns.Get(9).Label = "Mat ID";
            this.spdBallmill_Sheet1.Columns.Get(9).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(9).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(9).Visible = false;
            this.spdBallmill_Sheet1.Columns.Get(10).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(10).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.spdBallmill_Sheet1.Columns.Get(10).Label = "Material";
            this.spdBallmill_Sheet1.Columns.Get(10).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(10).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(10).Visible = false;
            this.spdBallmill_Sheet1.Columns.Get(10).Width = 97F;
            this.spdBallmill_Sheet1.Columns.Get(11).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(11).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(11).Label = "Side";
            this.spdBallmill_Sheet1.Columns.Get(11).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(11).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(12).AllowAutoSort = true;
            this.spdBallmill_Sheet1.Columns.Get(12).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(12).Label = "Status";
            this.spdBallmill_Sheet1.Columns.Get(12).Locked = true;
            this.spdBallmill_Sheet1.Columns.Get(12).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.spdBallmill_Sheet1.Columns.Get(12).Width = 78F;
            this.spdBallmill_Sheet1.DefaultStyle.HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            this.spdBallmill_Sheet1.DefaultStyle.Locked = false;
            this.spdBallmill_Sheet1.DefaultStyle.NoteIndicatorColor = System.Drawing.Color.Red;
            this.spdBallmill_Sheet1.DefaultStyle.Parent = "Style2";
            this.spdBallmill_Sheet1.DefaultStyle.VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.General;
            this.spdBallmill_Sheet1.EnhancedFilterSortingMode = FarPoint.Win.Spread.EnhancedFilterSortingMode.Text;
            this.spdBallmill_Sheet1.FilterBar.DefaultStyle.HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            this.spdBallmill_Sheet1.FilterBar.DefaultStyle.NoteIndicatorColor = System.Drawing.Color.Red;
            this.spdBallmill_Sheet1.FilterBar.DefaultStyle.Parent = "FilterBarDefault";
            this.spdBallmill_Sheet1.FilterBar.DefaultStyle.VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.General;
            this.spdBallmill_Sheet1.FilterBarHeaderStyle.HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            this.spdBallmill_Sheet1.FilterBarHeaderStyle.NoteIndicatorColor = System.Drawing.Color.Red;
            this.spdBallmill_Sheet1.FilterBarHeaderStyle.Parent = "RowHeaderDefault";
            this.spdBallmill_Sheet1.FilterBarHeaderStyle.VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.General;
            this.spdBallmill_Sheet1.FrozenColumnCount = 3;
            this.spdBallmill_Sheet1.GrayAreaBackColor = System.Drawing.Color.White;
            this.spdBallmill_Sheet1.NullBackColor = System.Drawing.Color.White;
            this.spdBallmill_Sheet1.RowHeader.Columns.Default.Resizable = false;
            this.spdBallmill_Sheet1.RowHeader.DefaultStyle.HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            this.spdBallmill_Sheet1.RowHeader.DefaultStyle.NoteIndicatorColor = System.Drawing.Color.Red;
            this.spdBallmill_Sheet1.RowHeader.DefaultStyle.Parent = "Style3";
            this.spdBallmill_Sheet1.RowHeader.DefaultStyle.VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.General;
            this.spdBallmill_Sheet1.Rows.Default.Height = 25F;
            this.spdBallmill_Sheet1.SheetCornerStyle.HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            this.spdBallmill_Sheet1.SheetCornerStyle.NoteIndicatorColor = System.Drawing.Color.Red;
            this.spdBallmill_Sheet1.SheetCornerStyle.Parent = "RowHeaderDefault";
            this.spdBallmill_Sheet1.SheetCornerStyle.VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.General;
            this.spdBallmill_Sheet1.ReferenceStyle = FarPoint.Win.Spread.Model.ReferenceStyle.A1;
            // 
            // btnChngeLotTime
            // 
            ...
            this.lblSide.FlatStyle = System.Windows.Forms.FlatStyle.System;
            this.lblSide.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.lblSide.ForeColor = System.Drawing.Color.Black;
            this.lblSide.Location = new System.Drawing.Point(919, 58);
            this.lblSide.Name = "lblSide";
            this.lblSide.Size = new System.Drawing.Size(40, 16);
            this.lblSide.TabIndex = 300;
            this.lblSide.Text = "Side";
            this.lblSide.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            // 
            // cdvSide
            // 
            this.cdvSide.BorderColor = System.Drawing.Color.DarkGray;
            this.cdvSide.BorderHotColor = System.Drawing.Color.Black;
            this.cdvSide.BtnFlatStyle = System.Windows.Forms.FlatStyle.Popup;
            this.cdvSide.BtnToolTipText = "";
            this.cdvSide.ButtonWidth = 30;
            this.cdvSide.DescText = "";
            this.cdvSide.DisplaySubItemIndex = 1;
            this.cdvSide.DisplayText = "";
            this.cdvSide.Focusing = null;
            this.cdvSide.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.cdvSide.Index = 0;
            this.cdvSide.IsViewBtnImage = false;
            this.cdvSide.Location = new System.Drawing.Point(1011, 53);
            this.cdvSide.MaxLength = 100;
            this.cdvSide.MCViewStyle.BorderColor = System.Drawing.SystemColors.Control;
            this.cdvSide.MCViewStyle.BorderHotColor = System.Drawing.SystemColors.Control;
            this.cdvSide.MultiSelect = false;
            this.cdvSide.Name = "cdvSide";
            this.cdvSide.ReadOnly = true;
            this.cdvSide.SameWidthHeightOfButton = false;
            this.cdvSide.SearchSubItemIndex = 0;
            this.cdvSide.SelectedDescIndex = 0;
            this.cdvSide.SelectedDescToQueryText = "";
            this.cdvSide.SelectedSubItemIndex = 0;
            this.cdvSide.SelectedValueToQueryText = "";
            this.cdvSide.SelectionStart = 0;
            this.cdvSide.Size = new System.Drawing.Size(121, 26);
            this.cdvSide.SmallImageList = null;
            this.cdvSide.StyleBorder = System.Windows.Forms.BorderStyle.Fixed3D;
            this.cdvSide.TabIndex = 299;
            this.cdvSide.TextBoxToolTipText = "";
            this.cdvSide.TextBoxWidth = 121;
            this.cdvSide.VisibleButton = true;
            this.cdvSide.VisibleColumnHeader = false;
            this.cdvSide.VisibleDescription = false;
            this.cdvSide.ButtonPress += new System.EventHandler(this.cdvSide_ButtonPress);
            // 
            // frmViewCTMBallmillData
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.ClientSize = new System.Drawing.Size(1372, 744);
            this.Name = "frmViewCTMBallmillData";
            this.Text = "View CTM Ballmill Data";
            this.Load += new System.EventHandler(this.frmViewCTMBallmillData_Load);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.spdBallmill)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.spdBallmill_Sheet1)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.cdvOper)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.cdvSide)).EndInit();
        ...
        private FarPoint.Win.Spread.FpSpread spdBallmill;
        private FarPoint.Win.Spread.SheetView spdBallmill_Sheet1;
        ...
        public Miracom.UI.Controls.MCCodeView.MCCodeView cdvSide;
    }
}