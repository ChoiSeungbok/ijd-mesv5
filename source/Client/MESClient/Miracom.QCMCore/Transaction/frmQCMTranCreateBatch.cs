            ...
            switch (MPCF.Trim(FuncName))
            {
                case "CREATE":
                    ...
                    if (bItemCheck)
                    {
                        ...
                        {
                            MPCF.ShowMsgBox(MPCF.GetMessage(202)); //?섎웾???쇱튂?섏? ?딆뒿?덈떎.
                            txtQty.Focus();
                            return false;
                        }
                    }
                    ...
                    {
                        MPCF.ShowMsgBox(MPCF.GetMessage(200)); //Item ?섎웾??Batch??理쒕? ?섎웾??珥덇낵?댁꽌???덈맗?덈떎.
                        txtQty.Focus();
                        return false;
                    }
                    ...
                    {
                        MPCF.ShowMsgBox(MPCF.GetMessage(201)); //Item ?섎웾??Inspection Set??理쒕? ?섎웾??珥덇낵?댁꽌???덈맗?덈떎.
                        txtQty.Focus();
                        return false;
                    }
