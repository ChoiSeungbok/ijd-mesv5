...
//
//   System      : MES
//   File Name   : frmQCMTranFinalDecision.vb
...
//       - Final_Decision() : Result Record transaction
//
//   Detail Description
//       -
//
...
{
    public class frmQCMTranFinalDecision : Miracom.MESCore.TranForm01
    {
        
        #region " Windows Form auto generated code "
        
        public frmQCMTranFinalDecision()
        {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            this.pnlBottom.Controls.SetChildIndex(this.btnAccept, 0);
            ...
            this.spdInspItem_Sheet1.Columns.Get(6).CellType = numberCellType16;
            ...
            this.spdInspItem_Sheet1.Columns.Get(11).CellType = numberCellType17;
            ...
            this.spdInspItem_Sheet1.Columns.Get(12).CellType = numberCellType18;
            ...
            this.spdInspItem_Sheet1.Columns.Get(13).CellType = numberCellType19;
            ...
            this.spdDefect_Sheet1.Columns.Get(1).CellType = numberCellType20;
            ...
            this.btnAccept.Location = new System.Drawing.Point(466, 7);
            ...
            // 
            // frmQCMTranFinalDecision
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 546);
            this.Name = "frmQCMTranFinalDecision";
            this.Tag = "QCM2003";
            this.Text = "Final Decision";
            this.Activated += new System.EventHandler(this.frmQCMTranFinalDecision_Activated);
            this.Load += new System.EventHandler(this.frmQCMTranFinalDecision_Load);
            ...
            try
            {
                ...
                switch (MPCF.Trim(FuncName))
                {
                    case "FINAL_DECISION":
                        ...
                        {
                            if (MPCF.Trim(ctrlBatchInfo.SkipResult) != "Y")
                            {
        ...
        //            .SetValue(7, 3, RTrim(View_Batch_Info_Out.final_decision))
            ...
            try
            {
                ...
                do
                {
                    ...
                    for (i = 0; i < out_node.GetList(0).Count; i++)
                    {
                        ...
                        itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("ITEM_ID")));
                        itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetDouble("ITEM_QTY_1")));
                        itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetChar("RESULT_FLAG")));
                        itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("DEFECT_CODE")));
                        itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("ISP_COMMENT")));
                        itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("ITEM_STATUS")));
                        itmX.SubItems.Add(MPCF.MakeDateFormat(out_node.GetList(0)[i].GetString("TRAN_TIME")));
                        itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("USER_ID")));
                ...
                } while (out_node.GetString("NEXT_ITEM_ID") != "");
        ...
        //
        private bool Final_Decision(char ProcStep, string sDecision)
        {
            TRSNode in_node = new TRSNode("FINAL_DECISION_IN");
            ...
            try
            {
                ...
                in_node.AddString("BATCH_ID", MPCF.Trim(txtBatchID.Text));
                in_node.AddString("FINAL_DECISION", sDecision);
                ...
                if (MPCR.CallService("QCM", "QCM_Final_Decision", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private void frmQCMTranFinalDecision_Load(object sender, System.EventArgs e)
        {
        ...
        private void frmQCMTranFinalDecision_Activated(object sender, System.EventArgs e)
        {
        ...
        private void btnProcess_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
                if (CheckCondition("FINAL_DECISION") == false)
                {
                    return;
                }
                
                if (Final_Decision('1', MPGC.MP_QCM_DECISION_REJECT) == false)
                {
                    return;
                }
        ...
        private void btnAccept_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (Final_Decision('1', MPGC.MP_QCM_DECISION_ACCEPT) == false)
                {
                    return;
                }
