...
namespace Miracom.MESCore
{
    public sealed class RASLIST
    {
        ...
        //        - Optional ByVal sFilter As String = ""        : sFilter濡??쒖옉?섎뒗 Resource
        ...
        //        - ByVal sIncludeDeleteHistory As String                : ??젣?대젰源뚯? ?쒖떆?щ??
        ...
        //       - ByVal control As Control                    : List媛 ?ㅼ뼱媛?control
        //        - ByVal c_step As String                        : ?뺤옣 Process Step
        //        - Optional ByVal sFilter As String = ""        : sFilter濡??쒖옉?섎뒗 Event
        //        - Optional ByVal sTreeItem As String = ""    : TreeView ?먯꽌 異붽???Node??Text
        //        - Optional ByVal sExt_Factory As String = "" : ?꾩옱 Factory媛 ?꾨땶寃쎌슦?????Factory
        //
        ...
        //        - Optional ByVal sIncludeDelHistory As String = ""  : Delete History源뚯? ?ы븿??寃껋씤吏?
        //       - Optional ByVal sTreeItem As String = ""           : Tree Item 媛?
        //       - Optional ByVal bIgnoreError As Boolean = False    : ?먮윭 諛쒖깮??臾댁떆??寃껋씤吏?
        //
        ...
        //       - ByVal control As Control                    : List媛 ?ㅼ뼱媛?control
        //        - ByVal c_step As String                        : ?뺤옣 Process Step
        //        - ByVal sKey As String                        : Key 媛?(step='1' ?쇨꼍??Res_ID, step='2' ??寃쎌슦 User_ID)
        //        - Optional ByVal sExt_Factory As String = "": ?꾩옱 Factory媛 ?꾨땶寃쎌슦??Factory
        //
        ...
        public static bool ViewCarrierSublotList(Control control, char c_step, string sCrrID, TreeNode parentNode, string sExtFactory, ref int iListCount, bool bGrade)
        {
            ...
            try
            {
                ...
                //Add by J.S. 2009.03.04 동일한 slot_no에 여러개의 sublot이 있는 경우 때문에 수정
                iCrrSize = 0;
                if (control is ListView)
                {
        ...
        //        - Optional ByVal sFromTime As String = ""   : ?쒖옉 ?쒓컙
        //        - Optional ByVal sToTime As String = ""     : 留덉?留??쒓컙
        //        - Optional ByVal parentNode As TreeNode = Nothing    : TreeView ?먯꽌 異붽???Node
        //       - Optional ByVal bIgnoreError As Boolean = False    : ?먮윭 諛쒖깮??臾댁떆??寃껋씤吏?
        //
            ...
            do
            {
                ...
                for (i = 0; i < out_node.GetList(0).Count; i++)
                {
                    ...
                    if (control is FarPoint.Win.Spread.FpSpread)
                    {
                        ...
                        iCol++;
                        sheetX.Cells[iRow, iCol].Value = out_node.GetList(0)[i].GetInt("REUSE_COUNT");
                        ...
                        iCol++;
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_1"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_2"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_3"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_4"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_5"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_6"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_7"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_8"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_9"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_10"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_11"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_12"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_13"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_14"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_15"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_16"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_17"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_18"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_19"));
                                                                                                     
                        iCol++;                                                                      
                        sheetX.Cells[iRow, iCol].Value = MPCF.Trim(out_node.GetList(0)[i].GetString("CRR_CMF_20"));
        ...
        //        - Optional ByVal sFromTime As String = ""   : ?쒖옉 ?쒓컙
        //        - Optional ByVal sToTime As String = ""     : 留덉?留??쒓컙
        //       - Optional ByVal sIncludeDelHistory as string = ""  : Lot????젣 ?대젰源뚯? ?ы븿?좎? ?щ?
        //        - Optional ByVal parentNode As TreeNode = Nothing    : TreeView ?먯꽌 異붽???Node
        //       - Optional ByVal bIgnoreError As Boolean = False    : ?먮윭 諛쒖깮??臾댁떆??寃껋씤吏?
        //
        ...
        //       -    ByVal sDeleteFlag As String = ""       : Tool????젣/?④린/諛섑뭹 ?щ?
        //        - Optional ByVal parentNode As TreeNode = Nothing    : TreeView ?먯꽌 異붽???Node
        //       - Optional ByVal bIgnoreError As Boolean = False    : ?먮윭 諛쒖깮??臾댁떆??寃껋씤吏?
        //
