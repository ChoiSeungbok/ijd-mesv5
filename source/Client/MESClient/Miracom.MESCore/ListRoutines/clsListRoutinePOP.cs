...
namespace Miracom.MESCore
{
    public sealed class POPLIST
    {
        ...
        // Arguments
        //       - ByVal control As Control                    : List媛€ ?ㅼ뼱媛?control
        //        - ByVal c_step As String                        : ?뺤옣Process Step
        //        - Optional ByVal sExt_Factory As String = "": ?꾩옱Factory媛€ ?꾨땶寃쎌슦??Factory
        //        - Optional ByVal sTreeItem As String = ""    : TreeView ?먯꽌異붽???Node??Text
        //       - Optional ByVal Col As Integer = -1        : Spread 而⑦듃濡ㅼ씪寃쎌슦?곗씠?€瑜?肉뚮젮以?Column Index (-1?대㈃?뱀젙Row ?꾩껜??肉뚮젮以?
        //       - Optional ByVal Row As Integer = -1        : Spread 而⑦듃濡ㅼ씪寃쎌슦?곗씠?€瑜?肉뚮젮以?Row Index (-1?대㈃?뱀젙Column ?꾩껜??肉뚮젮以?
        //
