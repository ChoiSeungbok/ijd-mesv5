...
{
    public class frmINVTranInInventorySerial : Miracom.MESCore.TranForm09
    {
        
        #region " Windows Form auto generated code "
        
        public frmINVTranInInventorySerial()
        {
        ...
        protected System.Windows.Forms.TextBox txtSerial;
        protected System.Windows.Forms.Label lblSerial;
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            this.spdData.Location = new System.Drawing.Point(3, 64);
            this.spdData.Name = "spdData";
            this.spdData.Sheets.AddRange(new FarPoint.Win.Spread.SheetView[] {
            this.spdData_Sheet1});
            this.spdData.Size = new System.Drawing.Size(716, 212);
            ...
            this.spdData_Sheet1.ColumnHeader.Cells.Get(0, 1).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            this.spdData_Sheet1.ColumnHeader.Cells.Get(0, 1).Value = "Serial No.";
            this.spdData_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "Material Unit";
            this.spdData_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "Material Qty";
            this.spdData_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "Material Type";
            ...
            this.spdData_Sheet1.Columns.Get(0).Width = 39F;
            textCellType1.MaxLength = 25;
            this.spdData_Sheet1.Columns.Get(1).CellType = textCellType1;
            this.spdData_Sheet1.Columns.Get(1).Label = "Serial No.";
            this.spdData_Sheet1.Columns.Get(1).Width = 229F;
            textCellType2.MaxLength = 10;
            this.spdData_Sheet1.Columns.Get(2).CellType = textCellType2;
            this.spdData_Sheet1.Columns.Get(2).Label = "Material Unit";
            this.spdData_Sheet1.Columns.Get(2).Width = 122F;
            numberCellType1.DecimalPlaces = 0;
            numberCellType1.LeadingZero = FarPoint.Win.Spread.CellType.LeadingZero.Yes;
            numberCellType1.MaximumValue = 9999999D;
            numberCellType1.MinimumValue = 0D;
            this.spdData_Sheet1.Columns.Get(3).CellType = numberCellType1;
            this.spdData_Sheet1.Columns.Get(3).Label = "Material Qty";
            this.spdData_Sheet1.Columns.Get(3).Width = 129F;
            textCellType3.MaxLength = 1;
            this.spdData_Sheet1.Columns.Get(4).CellType = textCellType3;
            this.spdData_Sheet1.Columns.Get(4).Label = "Material Type";
            this.spdData_Sheet1.Columns.Get(4).Width = 130F;
            ...
            this.lblSetAllocQty.Size = new System.Drawing.Size(100, 14);
            ...
            this.lblInQty1.Size = new System.Drawing.Size(100, 14);
            this.lblInQty1.TabIndex = 0;
            this.lblInQty1.Text = "In Qty";
            this.lblInQty1.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            // 
            // frmINVTranInInventorySerial
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 546);
            this.Name = "frmINVTranInInventorySerial";
            this.Text = "In Inventory";
            this.Activated += new System.EventHandler(this.frmINVTranInInventorySerial_Activated);
        ...
        private bool View_Inventory_Info(char c_step, string sMatID, int iMatVer, string sOper)
        {
            ...
            try
            {
                ...
                txtQty1.Text = MPCF.Format("#####,##0.###", out_node.GetString("QTY_1"));
                txtAllocQty.Text = MPCF.Format("#####,##0.###", out_node.GetString("ALLOC_QTY"));
        ...
        private bool In_Inventory(char ProcStep)
        {
            ...
            try
            {
                ...
                in_node.AddInt("MAT_VER", MPCF.ToInt(cdvMatVersion.Text)); // Added by H.J. Noh
                ...
                for (i = 0; i < spdData.Sheets[0].RowCount; i++)
                {
                    if (spdData.Sheets[0].GetValue(i, 0) != null && Convert.ToBoolean(spdData.Sheets[0].GetValue(i, 0)) == true)
                    {
                        ...
                        serial_list.AddInt("SERIAL_SEQ", i_seq);
                        serial_list.AddString("SERIAL_ID", MPCF.Trim(spdData.Sheets[0].GetValue(i, 1)));
                        serial_list.AddString("MAT_UNIT", MPCF.Trim(spdData.Sheets[0].GetValue(i, 2)));
                        serial_list.AddDouble("MAT_QTY", MPCF.ToDbl(spdData.Sheets[0].GetValue(i, 3)));
                        serial_list.AddChar("MAT_QTY", MPCF.ToChar(spdData.Sheets[0].GetValue(i, 4)));
                ...
                if (MPCR.CallService("INV", "INV_In_Inventory_Serial", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private void frmINVTranInInventorySerial_Activated(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ClearData('1');
                    spdData.Sheets[0].RowCount = 2;
                    spdData.Sheets[0].ClearRange(0, 0, 2, 5, true);
        ...
        private void btnProcess_Click(System.Object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (In_Inventory('U') == false) return;
        ...
        private void spdData_Change(object sender, FarPoint.Win.Spread.ChangeEventArgs e)
        {
            ...
            try
            {
                ...
                if (e.Column > 0 && e.Row >= 0)
                {
                    ...
                    if (MPCF.ToDbl(spdData.Sheets[0].Cells[e.Row, 3].Text) == 0)
                    {
