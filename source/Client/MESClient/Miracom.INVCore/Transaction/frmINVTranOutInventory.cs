...
{
    public class frmINVTranOutInventory : Miracom.MESCore.TranForm09
    {
        
        #region " Windows Form auto generated code "
        
        public frmINVTranOutInventory()
        {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            // 
            // frmINVTranOutInventory
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 546);
            this.Name = "frmINVTranOutInventory";
            this.Text = "Tran Out Store";
        ...
        private bool Out_Inventory(char ProcStep)
        {
            ...
            try
            {
                ...
                if (MPCR.CallService("INV", "INV_Out_Inventory", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private void btnProcess_Click(System.Object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (Out_Inventory('1') == false) return;
