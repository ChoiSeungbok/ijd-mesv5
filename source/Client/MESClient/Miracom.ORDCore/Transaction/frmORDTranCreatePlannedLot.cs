...
{
    public class frmORDTranCreatePlannedLot : Miracom.MESCore.TranForm08
    {
        
        #region " Windows Form auto generated code "
        
        public frmORDTranCreatePlannedLot()
        {
        ...
        private System.Windows.Forms.ColumnHeader colCreateFlag;
        private System.Windows.Forms.ColumnHeader colLotCreateTime;
        private System.Windows.Forms.ColumnHeader colLotID;
        private System.Windows.Forms.ColumnHeader colLotDesc;
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            this.colLotDesc = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
            ...
            this.colCreateFlag = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
            this.colLotCreateTime = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
            ...
            // lblFormTitle
            // 
            this.lblFormTitle.Text = "Create Planned Lot";
            // 
            // pnlCreateLot
            // 
            ...
            // grpOrderList
            // 
            this.grpOrderList.Controls.Add(this.lisLotList);
            ...
            // colLotDesc
            // 
            this.colLotDesc.Text = "Lot Desc";
            this.colLotDesc.Width = 200;
            // 
            // colMatID
            // 
            ...
            // colCreateFlag
            // 
            this.colCreateFlag.Text = "Create Flag";
            this.colCreateFlag.Width = 80;
            // 
            // colLotCreateTime
            // 
            this.colLotCreateTime.Text = "Lot Create Time";
            this.colLotCreateTime.Width = 120;
            // 
            // colCreateUserID
            // 
            ...
            // grpWorkDate
            // 
            this.grpWorkDate.Controls.Add(this.btnViewLotList);
            ...
            // btnViewLotList
            // 
            this.btnViewLotList.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.btnViewLotList.FlatStyle = System.Windows.Forms.FlatStyle.System;
            this.btnViewLotList.Location = new System.Drawing.Point(596, 14);
            this.btnViewLotList.Name = "btnViewLotList";
            this.btnViewLotList.Size = new System.Drawing.Size(118, 21);
            ...
            // 
            // frmORDTranCreatePlannedLot
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 553);
            this.Name = "frmORDTranCreatePlannedLot";
            this.Text = "Create Planned Lot";
        ...
        private const int LOT_DESC = 2;
        private const int MAT_ID = 3;
        private const int MAT_VER = 4;
        private const int FLOW = 5;
        private const int FLOW_SEQ_NUM = 6;
        private const int OPER = 7;
        private const int QTY_1 = 8;
        private const int QTY_2 = 9;
        private const int QTY_3 = 10;
        private const int LOT_TYPE = 11;
        private const int OWNER_CODE = 12;
        private const int CREATE_CODE = 13;
        private const int LOT_PRIORITY = 14;
        private const int ORG_DUE_TIME = 15;
        private const int RES_ID = 16;
        private const int ORDER_ID = 17;
        private const int LOT_CREATE_FLAG = 18;
        private const int LOT_CREATE_TIME = 19;
        private const int CREATE_USER_ID = 20;
        private const int CREATE_TIME = 21;
        private const int UPDATE_USER_ID = 22;
        private const int UPDATE_TIME = 23;
        ...
        //       - View all Planned Lot List
        // Return Value
        //       - boolean : True / False
        // Arguments
        //       - ByVal control As Control                    : List媛 ?ㅼ뼱媛?control
        //        - ByVal c_step As String                        : ?뺤옣 Process Step
        //        - Optional ByVal sFilter As String = ""        : sFilter濡??쒖옉?섎뒗 Flow
        //        - Optional ByVal sOper As String = ""        : sOper瑜?媛吏?Flow
        //        - Optional ByVal sMaterial As String = ""    : sMaterial瑜?媛吏?Flow
        ...
        private bool View_PlannedLot_List_Detail()
        {
            ...
            do
            {
                ...
                for (i = 0; i < out_node.GetList(0).Count; i++)
                {
                    ...
                    itmX.SubItems.Add(MPCF.Trim(plan_list.GetString("LOT_ID")));
                    itmX.SubItems.Add(MPCF.Trim(plan_list.GetString("LOT_DESC")));
                    itmX.SubItems.Add(MPCF.Trim(plan_list.GetString("MAT_ID")));
                    itmX.SubItems.Add(MPCF.Trim(plan_list.GetInt("MAT_VER")));
                    itmX.SubItems.Add(MPCF.Trim(plan_list.GetString("FLOW")));
                    itmX.SubItems.Add(MPCF.Trim(plan_list.GetInt("FLOW_SEQ_NUM")));
                    itmX.SubItems.Add(MPCF.Trim(plan_list.GetString("OPER")));
                    itmX.SubItems.Add(MPCF.Format("#####,##0.###", plan_list.GetDouble("QTY_1")));
                    itmX.SubItems.Add(MPCF.Format("#####,##0.###", plan_list.GetDouble("QTY_2")));
                    itmX.SubItems.Add(MPCF.Format("#####,##0.###", plan_list.GetDouble("QTY_3")));
                    ...
                    itmX.SubItems.Add(MPCF.Trim(plan_list.GetString("ORDER_ID")));
                    itmX.SubItems.Add(MPCF.Trim(plan_list.GetChar("LOT_CREATE_FLAG")));
                    itmX.SubItems.Add(MPCF.MakeDateFormat(plan_list.GetString("LOT_CREATE_TIME")));
        ...
        private void btnViewLotList_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
                if (View_PlannedLot_List_Detail() == false)
                {
                    return;
                }
                ClearData('2');
        ...
        private void lisLotList_Click(object sender, System.EventArgs e)
        {
            ...
            if (lisLotList.SelectedItems.Count > 0)
            {
                ...
                sLotID = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[LOT_ID].Text);
                txtLotID.Text = sLotID;
                txtLotDesc.Text = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[LOT_DESC].Text);
                spdLotInfo.Sheets[0].Cells[0, 1].Value = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[MAT_ID].Text + "(" + lisLotList.SelectedItems[0].SubItems[MAT_VER].Text + ")");
                spdLotInfo.Sheets[0].Cells[0, 3].Value = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[FLOW].Text + "(" + lisLotList.SelectedItems[0].SubItems[FLOW_SEQ_NUM].Text + ")");
                spdLotInfo.Sheets[0].Cells[0, 5].Value = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[OPER].Text);
                spdLotInfo.Sheets[0].Cells[1, 1].Value = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[QTY_1].Text) + "/" + MPCF.Trim(lisLotList.SelectedItems[0].SubItems[QTY_2].Text) + "/" + MPCF.Trim(lisLotList.SelectedItems[0].SubItems[QTY_3].Text);
                spdLotInfo.Sheets[0].Cells[1, 3].Value = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[CREATE_CODE].Text);
                spdLotInfo.Sheets[0].Cells[1, 5].Value = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[OWNER_CODE].Text);
                spdLotInfo.Sheets[0].Cells[2, 1].Value = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[LOT_TYPE].Text);
                spdLotInfo.Sheets[0].Cells[2, 3].Value = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[LOT_PRIORITY].Text);
                spdLotInfo.Sheets[0].Cells[2, 5].Value = MPCF.Trim(lisLotList.SelectedItems[0].SubItems[ORG_DUE_TIME].Text);
