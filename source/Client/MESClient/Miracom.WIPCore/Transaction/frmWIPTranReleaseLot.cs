...
{
    public class frmWIPTranReleaseLot : Miracom.MESCore.TranForm07
    {
        
        #region " Windows Form auto generated code "
        
        public frmWIPTranReleaseLot()
        {
        ...
        private UI.Controls.MCCodeView.MCCodeView cdvQueueTimeReleaseCode;
        private Label lblQueueTimeReleaseCode;
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            this.cdvQueueTimeReleaseCode = new Miracom.UI.Controls.MCCodeView.MCCodeView();
            this.lblQueueTimeReleaseCode = new System.Windows.Forms.Label();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.cdvQueueTimeReleaseCode)).BeginInit();
            this.SuspendLayout();
            // 
            // pnlTranInfo
            // 
            ...
            // grpTranInfo
            // 
            this.grpTranInfo.Controls.Add(this.cdvQueueTimeReleaseCode);
            this.grpTranInfo.Controls.Add(this.lblQueueTimeReleaseCode);
            ...
            this.cdvReleaseCode.TabIndex = 5;
            ...
            this.lblReleaseCode.TabIndex = 4;
            ...
            this.cdvBinReleaseCode.TabIndex = 7;
            ...
            this.lblBinReleaseCode.TabIndex = 6;
            this.lblBinReleaseCode.Text = "BIN Release Code";
            this.lblBinReleaseCode.Visible = false;
            // 
            // cdvQueueTimeReleaseCode
            // 
            this.cdvQueueTimeReleaseCode.BorderColor = System.Drawing.Color.DarkGray;
            this.cdvQueueTimeReleaseCode.BorderHotColor = System.Drawing.Color.Black;
            this.cdvQueueTimeReleaseCode.BtnFlatStyle = System.Windows.Forms.FlatStyle.System;
            this.cdvQueueTimeReleaseCode.BtnToolTipText = "";
            this.cdvQueueTimeReleaseCode.DescText = "";
            this.cdvQueueTimeReleaseCode.DisplaySubItemIndex = -1;
            this.cdvQueueTimeReleaseCode.DisplayText = "";
            this.cdvQueueTimeReleaseCode.Focusing = null;
            this.cdvQueueTimeReleaseCode.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.cdvQueueTimeReleaseCode.Index = 0;
            this.cdvQueueTimeReleaseCode.IsViewBtnImage = false;
            this.cdvQueueTimeReleaseCode.Location = new System.Drawing.Point(170, 104);
            this.cdvQueueTimeReleaseCode.MaxLength = 10;
            this.cdvQueueTimeReleaseCode.MCViewStyle.BorderColor = System.Drawing.SystemColors.Control;
            this.cdvQueueTimeReleaseCode.MCViewStyle.BorderHotColor = System.Drawing.SystemColors.Control;
            this.cdvQueueTimeReleaseCode.Name = "cdvQueueTimeReleaseCode";
            this.cdvQueueTimeReleaseCode.ReadOnly = true;
            this.cdvQueueTimeReleaseCode.SearchSubItemIndex = 0;
            this.cdvQueueTimeReleaseCode.SelectedDescIndex = -1;
            this.cdvQueueTimeReleaseCode.SelectedSubItemIndex = -1;
            this.cdvQueueTimeReleaseCode.SelectionStart = 0;
            this.cdvQueueTimeReleaseCode.Size = new System.Drawing.Size(148, 20);
            this.cdvQueueTimeReleaseCode.SmallImageList = null;
            this.cdvQueueTimeReleaseCode.StyleBorder = System.Windows.Forms.BorderStyle.Fixed3D;
            this.cdvQueueTimeReleaseCode.TabIndex = 14;
            this.cdvQueueTimeReleaseCode.TextBoxToolTipText = "";
            this.cdvQueueTimeReleaseCode.TextBoxWidth = 148;
            this.cdvQueueTimeReleaseCode.Visible = false;
            this.cdvQueueTimeReleaseCode.VisibleButton = true;
            this.cdvQueueTimeReleaseCode.VisibleColumnHeader = false;
            this.cdvQueueTimeReleaseCode.VisibleDescription = false;
            this.cdvQueueTimeReleaseCode.ButtonPress += new System.EventHandler(this.cdvQueueTimeReleaseCode_ButtonPress);
            // 
            // lblQueueTimeReleaseCode
            // 
            this.lblQueueTimeReleaseCode.AutoSize = true;
            this.lblQueueTimeReleaseCode.FlatStyle = System.Windows.Forms.FlatStyle.System;
            this.lblQueueTimeReleaseCode.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.lblQueueTimeReleaseCode.Location = new System.Drawing.Point(12, 108);
            this.lblQueueTimeReleaseCode.Name = "lblQueueTimeReleaseCode";
            this.lblQueueTimeReleaseCode.Size = new System.Drawing.Size(135, 13);
            this.lblQueueTimeReleaseCode.TabIndex = 13;
            this.lblQueueTimeReleaseCode.Text = "Queue Time Release Code";
            this.lblQueueTimeReleaseCode.Visible = false;
            // 
            // frmWIPTranReleaseLot
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 546);
            this.Name = "frmWIPTranReleaseLot";
            this.Text = "Release Lot";
            this.Activated += new System.EventHandler(this.frmWPTranReleaseLot_Activated);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.cdvQueueTimeReleaseCode)).EndInit();
        ...
        private bool Release_Lot()
        {
            ...
            try
            {
                ...
                in_node.AddString("QUEUE_TIME_RELEASE_CODE", MPCF.Trim(cdvQueueTimeReleaseCode.Text));
                ...
                if (MPCR.CallService("WIP", "WIP_Release_Lot", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private bool CheckQueueTimeHoldLot()
        {
            TRSNode in_node = new TRSNode("ATTR_IN");
            TRSNode out_node = new TRSNode("ATTR_OUT");
            string s_qtm_hold_code;

            lblQueueTimeReleaseCode.Visible = false;
            cdvQueueTimeReleaseCode.Visible = false;
            cdvQueueTimeReleaseCode.Text = "";

            MPCR.SetInMsg(in_node);
            in_node.ProcStep = '1';
            in_node.AddString("ATTR_TYPE", MPGC.MP_ATTR_TYPE_LOT);
            in_node.AddString("ATTR_KEY", txtLotID.Text);
            in_node.AddString("ATTR_NAME", MPGC.MP_SYS_ATTR_QUEUE_TIME_HOLD_CODE);
            if (MPCR.CallService("BAS", "BAS_View_Attribute_Value", in_node, ref out_node) == false)
            {
                return false;
            }
            ...
            if (out_node.GetList("VALUE_LIST").Count > 0)
            {
                s_qtm_hold_code = out_node.GetList("VALUE_LIST")[0].GetString("ATTR_VALUE");
                if (s_qtm_hold_code == MPCF.Trim(cdvHoldCode.Text))
                {
                    lblQueueTimeReleaseCode.Visible = true;
                    cdvQueueTimeReleaseCode.Visible = true;
                }
            }
        ...
        private void frmWPTranReleaseLot_Activated(object sender, System.EventArgs e)
        {
        ...
        private void cdvHoldCode_SelectedItemChanged(object sender, MCCodeViewSelChanged_EventArgs e)
        {
            ...
            if (CheckQueueTimeHoldLot() == false) return;
        }
        ...
        private void cdvQueueTimeReleaseCode_ButtonPress(object sender, EventArgs e)
        {
            cdvQueueTimeReleaseCode.Init();
            MPCF.InitListView(cdvQueueTimeReleaseCode.GetListView);
            cdvQueueTimeReleaseCode.Columns.Add("Release Code", 150, HorizontalAlignment.Left);
            cdvQueueTimeReleaseCode.Columns.Add("Desc", 200, HorizontalAlignment.Left);
            cdvQueueTimeReleaseCode.SelectedSubItemIndex = 0;
            BASLIST.ViewGCMDataList(cdvQueueTimeReleaseCode.GetListView, '1', MPGC.MP_WIP_QUEUE_TIME_RELEASE_CODE, -1, null, MPGV.gsCentralFactory);
            cdvQueueTimeReleaseCode.InsertEmptyRow(0, 1);
        }
    }
