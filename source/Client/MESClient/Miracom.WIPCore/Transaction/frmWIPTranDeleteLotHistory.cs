...
//
//   System      : MES
//   File Name   : frmWIPTranDeleteLotHistory.vb
...
//       - View_History() : View Lot History
//       - Delete_Lot_History() : Delete Lot History
//
//   Detail Description
//       -
//
...
{
    public class frmWIPTranDeleteLotHistory : Miracom.MESCore.TranForm06
    {
        
        #region " Windows Form auto generated code "
        
        public frmWIPTranDeleteLotHistory()
        {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            this.chkMultiTR = new System.Windows.Forms.CheckBox();
            ...
            // grpTranTop
            // 
            this.grpTranTop.Controls.Add(this.chkMultiTR);
            ...
            this.grpTranTop.Controls.SetChildIndex(this.chkMultiTR, 0);
            // 
            // btnProcess
            // 
            ...
            this.lblPeriod.Location = new System.Drawing.Point(458, 16);
            ...
            // chkMultiTR
            // 
            this.chkMultiTR.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.chkMultiTR.AutoSize = true;
            this.chkMultiTR.Checked = true;
            this.chkMultiTR.CheckState = System.Windows.Forms.CheckState.Checked;
            this.chkMultiTR.FlatStyle = System.Windows.Forms.FlatStyle.System;
            this.chkMultiTR.Location = new System.Drawing.Point(350, 13);
            this.chkMultiTR.Name = "chkMultiTR";
            this.chkMultiTR.RightToLeft = System.Windows.Forms.RightToLeft.No;
            this.chkMultiTR.Size = new System.Drawing.Size(106, 18);
            this.chkMultiTR.TabIndex = 4;
            this.chkMultiTR.Text = "Delete Multi TR";
            this.chkMultiTR.Visible = false;
            // 
            // spdHistory
            // 
            ...
            // 
            // frmWIPTranDeleteLotHistory
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 553);
            this.Name = "frmWIPTranDeleteLotHistory";
            this.Text = "Delete Lot History";
            this.Activated += new System.EventHandler(this.frmWIPTranDeleteLotHistory_Activated);
        ...
        private void View_History()
        {
            ...
            if (txtLotID.Text != "")
            {
                ...
                if (WIPLIST.ViewLotHistory(spdHistory, '1', txtLotID.Text, sFromTime, sToTime, ' ', null, false, "") == false)
                {
                    return;
                }
        ...
        // Arguments
        //       -
        private bool Delete_Lot_History()
        {
            ...
            try
            {
                ...
                if (MPCR.CallService("WIP", "WIP_Delete_Lot_History", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private void frmWIPTranDeleteLotHistory_Activated(object sender, System.EventArgs e)
        {
            
            if (b_load_flag == false)
            {

                MPCF.FieldClear(this, chkMultiTR);
        ...
        private void txtLotID_TextChanged(object sender, System.EventArgs e)
        {
            if (txtLotID.Text == "")
            {
                MPCF.FieldClear(this, chkMultiTR, null, null, null, null, false);
                MPCF.ClearList(spdHistory, true);
            }
        }
