...
//
//   System      : MES
//   File Name   : frmWIPTranEndLotForStep.cs
//   Description : End Lot For Step Transaction
//
//   MES Version : 5.1.1.1
//
//   Function List
//       - ViewLotInfo() : View Lot Information
//       - ClearData() : Clear Form Control Data
//       - CheckCondition() : Check the conditions before transaction
//       - View_Lot_Step_Status() : View lot's Current Step
//       - End_Lot_For_Step() : End Lot transaction
//
//   Detail Description
//       -
//
...
{
    public class frmWIPTranEndLotForStep : Miracom.MESCore.TranForm07
    {
        
        #region " Windows Form auto generated code "
        
        public frmWIPTranEndLotForStep()
        {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            // grpTranInfo
            // 
            this.grpTranInfo.Controls.Add(this.txtCurrentStep);
            this.grpTranInfo.Controls.Add(this.lblCurrentStep);
            this.grpTranInfo.Controls.Add(this.cdvStep);
            ...
            this.txtCurrentStep.MaxLength = 10;
            ...
            this.txtCurrentStep.TabIndex = 1;
            // 
            // lblCurrentStep
            // 
            ...
            // 
            // frmWIPTranEndLotForStep
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 546);
            this.Name = "frmWIPTranEndLotForStep";
            this.Text = "End Lot For Step";
            this.Activated += new System.EventHandler(this.frmWIPTranEndLotForStep_Activated);
        ...
        //
        private bool End_Lot_For_Step(char ProcStep)
        {

            TRSNode in_node = new TRSNode("END_LOT_FOR_STEP_IN");
            ...
            try
            {
                ...
                if (MPCR.CallService("WIP", "WIP_End_Lot_For_Step", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private void frmWIPTranEndLotForStep_Activated(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SetCMFItem(MPGC.MP_CMF_TRN_END_STEP);
        ...
        private void btnProcess_Click(System.Object sender, System.EventArgs e)
        {
            ...
            try
            {
                if (CheckCondition("END_LOT_FOR_STEP") == true)
                {
                    if (End_Lot_For_Step('1') == false)
                    {
                        return;
                    }
                    ViewLotInfo(txtLotID.Text);
