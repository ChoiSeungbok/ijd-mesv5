...
//
//   System      : MES
//   File Name   : frmWIPTranReleaseBatch.vb
...
{
    public class frmWIPTranReleaseBatch : Miracom.CliFrx.BaseForm03
    {
        
        #region " Windows Form auto generated code "
        
        public frmWIPTranReleaseBatch()
        {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            // 
            // frmWIPTranReleaseBatch
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 546);
            this.Name = "frmWIPTranReleaseBatch";
            this.Text = "Release Batch";
            this.Activated += new System.EventHandler(this.frmWIPTranReleaseBatch_Activated);
        ...
        //
        private bool Release_Batch()
        {

            TRSNode in_node = new TRSNode("RELEASE_BATCH_IN");
            ...
            try
            {
                ...
                in_node.AddString("BATCH_ID", MPCF.Trim(txtBatchID.Text));
                in_node.AddString("BATCH_COMMENT", MPCF.Trim(txtComment.Text));

                if (MPCR.CallService("WIP", "WIP_Release_Batch", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private void frmWIPTranReleaseBatch_Activated(object sender, System.EventArgs e)
        {
            try
            {
        ...
        private void btnProcess_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
                if (CheckCondition("RELEASE_BATCH") == true)
                {
                    if (Release_Batch() == false)
                    {
                        return;
                    }
                    //If View_Batch_Lot_List() = False Then Exit Sub
                    lisLotList.Items.Clear();
                }
            }
            catch (Exception ex)
