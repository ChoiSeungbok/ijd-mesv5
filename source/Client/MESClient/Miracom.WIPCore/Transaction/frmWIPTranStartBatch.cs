...
//
//   System      : MES
//   File Name   : frmWIPTranStartBatch.vb
...
{
    public class frmWIPTranStartBatch : Miracom.MESCore.TranForm11
    {
        
        #region " Windows Form auto generated code "
        
        public frmWIPTranStartBatch()
        {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            // lblFormTitle
            // 
            this.lblFormTitle.Text = "Start Batch";
            // 
            // txtBatchID
            // 
            ...
            // columnHeader193
            // 
            this.columnHeader193.DisplayIndex = 3;
            this.columnHeader193.Text = "Mat Ver";
            this.columnHeader193.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
            // 
            // columnHeader194
            // 
            this.columnHeader194.DisplayIndex = 5;
            this.columnHeader194.Text = "Flow Seq";
            this.columnHeader194.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
            // 
            // grpResInfo
            // 
            ...
            // 
            // frmWIPTranStartBatch
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 553);
            this.Name = "frmWIPTranStartBatch";
            this.Text = "Start Batch";
            this.Activated += new System.EventHandler(this.frmWIPTranStartBatch_Activated);
            this.Load += new System.EventHandler(this.frmWIPTranStartBatch_Load);
            ...
            try
            {
                switch (ProcStep)
                {
                    ...
                    case "2":
                        ...
                        //Lot ?낅젰 ???뷀꽣 ???꾨뱶 珥덇린??諛?Lot Information 異쒕젰
        ...
        private bool View_Batch_Lot_List()
        {
            ...
            try
            {
                ...
                cdvResID.Text = MPCF.Trim(out_node.GetString("BATCH_RES_ID"));
        ...
        //
        private bool Start_Batch(char ProcStep)
        {
            TRSNode in_node = new TRSNode("START_BATCH_IN");
            ...
            try
            {
                ...
                if (MPCR.CallService("WIP", "WIP_Start_Batch", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private void frmWIPTranStartBatch_Load(object sender, System.EventArgs e)
        {
        ...
        private void frmWIPTranStartBatch_Activated(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    ClearData("1");
                    MPCR.SetCMFItem(MPGC.MP_CMF_TRN_START, "lblCMF", "cdvCMF", grpCMF);
        ...
        private void btnProcess_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
                if (CheckCondition("START_BATCH") == true)
                {
                    if (Start_Batch('1') == false)
                    {
                        return;
                    }
                    if (View_Batch_Lot_List() == false)
                    {
                        return;
                    }
                    if (lisLotList.Items.Count > 0)
