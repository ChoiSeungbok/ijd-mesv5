...
//
//   System      : MES
//   File Name   : frmWIPTranMultiStartLotInResource.vb
//   Description : Multi Start Lot Transaction
//
//   MES Version : 4.1.0.0
//
//   Function List
...
{
    public class frmWIPTranMultiStartLotInResource : Miracom.MESCore.TranForm08
    {
        
        #region " Windows Form auto generated code "
        
        public frmWIPTranMultiStartLotInResource()
        {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            this.grpResInfo.Size = new System.Drawing.Size(722, 152);
            ...
            this.pnlResInfoMain.Size = new System.Drawing.Size(716, 133);
            ...
            this.pnlResIDMid.Location = new System.Drawing.Point(0, 28);
            this.pnlResIDMid.Name = "pnlResIDMid";
            this.pnlResIDMid.Size = new System.Drawing.Size(716, 105);
            this.pnlResIDMid.TabIndex = 5;
            // 
            // spdResInfo
            // 
            ...
            this.pnlResID.Size = new System.Drawing.Size(716, 28);
            this.pnlResID.TabIndex = 1;
            // 
            // pnlTranTime
            // 
            ...
            this.pnlLotList.Location = new System.Drawing.Point(3, 3);
            this.pnlLotList.Name = "pnlLotList";
            this.pnlLotList.Size = new System.Drawing.Size(722, 285);
            this.pnlLotList.TabIndex = 0;
            // 
            // grpLotList
            // 
            ...
            this.grpLotList.Size = new System.Drawing.Size(722, 285);
            ...
            this.lisLotListTemp.Size = new System.Drawing.Size(716, 266);
            ...
            this.lisLotList.Size = new System.Drawing.Size(716, 266);
            ...
            this.chkBindSameTr.Location = new System.Drawing.Point(12, 12);
            this.chkBindSameTr.Name = "chkBindSameTr";
            this.chkBindSameTr.Size = new System.Drawing.Size(158, 17);
            this.chkBindSameTr.TabIndex = 14;
            this.chkBindSameTr.Text = "Bind with Same Transaction";
            this.chkBindSameTr.UseVisualStyleBackColor = true;
            // 
            // frmWIPTranMultiStartLotInResource
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 553);
            this.Name = "frmWIPTranMultiStartLotInResource";
            this.Text = "Multi Start Lot In Resource";
            this.Activated += new System.EventHandler(this.frmWIPTranMultiStartLotInResource_Activated);
            this.Load += new System.EventHandler(this.frmWIPTranMultiStartLotInResource_Load);
        ...
        //
        private bool MultiStartLot(char ProcStep)
        {

            int i = 0;

            TRSNode in_node = new TRSNode("MULTI_START_LOT_IN");
            ...
            try
            {
                ...
                for (i = 0; i < lisLotList.Items.Count; i++)
                {
                    ...
                    list_item.AddInt("LAST_ACTIVE_HIST_SEQ", MPCF.ToInt(GetLastHistSeq(i)));
                    list_item.AddString("LOT_ID", MPCF.Trim(GetLotID(i)));
                    list_item.AddString("MAT_ID", GetMaterial(i));
                    list_item.AddInt("MAT_VER", GetMaterialVer(i));
                    list_item.AddString("FLOW", GetFlow(i));
                    list_item.AddInt("FLOW_SEQ_NUM", GetFlowSeq(i));
                    list_item.AddString("OPER", GetOperation(i));
                }

                if (MPCR.CallService("WIP", "WIP_Multi_Start_Lot", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private void frmWIPTranMultiStartLotInResource_Load(object sender, System.EventArgs e)
        {
        ...
        private void frmWIPTranMultiStartLotInResource_Activated(object sender, System.EventArgs e)
        {
        ...
        private void btnProcess_Click(System.Object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (MultiStartLot('1') == false) return;
