...
//
//   System      : MES
//   File Name   : frmWIPTranSkipLot.vb
//   Description : Skip Lot Transaction
//
//   MES Version : 4.1.0.0
//
//   Function List
...
{
    public class frmWIPTranSkipLot : Miracom.MESCore.TranForm07
    {
        
        #region " Windows Form auto generated code "
        
        public frmWIPTranSkipLot()
        {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            // lblFormTitle
            // 
            this.lblFormTitle.Text = "Skip Lot";
            // 
            // grpTranInfo
            // 
            ...
            this.cdvToFlow.Location = new System.Drawing.Point(12, 14);
            ...
            this.cdvToFlow.Size = new System.Drawing.Size(305, 20);
            ...
            this.cdvToFlow.WidthFlowAndSequence = 199;
            ...
            this.cdvToOperation.Location = new System.Drawing.Point(118, 39);
            ...
            this.lblToOperation.Location = new System.Drawing.Point(12, 42);
            this.lblToOperation.Name = "lblToOperation";
            this.lblToOperation.Size = new System.Drawing.Size(100, 14);
            this.lblToOperation.TabIndex = 2;
            ...
            this.Name = "frmWIPTranSkipLot";
            this.Text = "Skip Lot";
            this.Activated += new System.EventHandler(this.frmWIPTranSkipLot_Activated);
        ...
        //
        private bool Skip_Lot(char ProcStep)
        {
            ...
            try
            {
                ...
                //in_node.AddDouble("QTY_1", LOT.GetDouble("QTY_1").ToString("####,##0.###"));
                //in_node.AddDouble("QTY_2", LOT.GetDouble("QTY_2").ToString("####,##0.###"));
                //in_node.AddDouble("QTY_3", LOT.GetDouble("QTY_3").ToString("####,##0.###"));
                ...
                if (MPCR.CallService("WIP", "WIP_Skip_Lot", in_node, ref out_node) == false)
                {
                    return false;
                }
        ...
        private void frmWIPTranSkipLot_Activated(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SetCMFItem(MPGC.MP_CMF_TRN_SKIP);
        ...
        private void btnProcess_Click(System.Object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (BASCore.BASCR.CheckListPopup(this, MPGC.MP_TRAN_CODE_SKIP, LOT.GetString("LOT_ID"), "", "", 'B') == false) return;
                if (Skip_Lot('1') == false) return;
                if (BASCore.BASCR.CheckListPopup(this, MPGC.MP_TRAN_CODE_SKIP, LOT.GetString("LOT_ID"), "", "", 'A') == false) return;
