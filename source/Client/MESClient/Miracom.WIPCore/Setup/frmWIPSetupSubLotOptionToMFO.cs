...
//
//   System      : MES
//   File Name   : frmWIPSetupGeneralCodeData.vb
...
//       - Update_MFO_Sublot_List() : Attach/Detach Collection Sets to MFO, FO, O
//       - View_MFO_SubLot_List() :View MFO-Collection Set Relation
//
//   Detail Description
//       -
//
...
{
    public class frmWIPSetupSubLotOptionToMFO : Miracom.MESCore.SetupForm01
    {
        
        #region " Windows Form auto generated code "
        
        public frmWIPSetupSubLotOptionToMFO()
        {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmWIPSetupSubLotOptionToMFO));
            ...
            // btnDelete
            // 
            this.btnDelete.Location = new System.Drawing.Point(466, 5);
            this.btnDelete.TabIndex = 1;
            this.btnDelete.Visible = false;
            // 
            // btnUpdate
            // 
            this.btnUpdate.Location = new System.Drawing.Point(558, 5);
            ...
            this.lblFormTitle.Text = "Sub Lot Option Setup";
            // 
            // tabMFO
            // 
            this.tabMFO.Controls.Add(this.tbpOper);
            this.tabMFO.Controls.Add(this.tbpFlowOper);
            ...
            this.spdOper_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "Sub Lot Tracking Flag";
            ...
            this.spdOper_Sheet1.Columns.Get(0).Width = 80F;
        ...
        "U : Upkeep"};
            ...
            this.spdOper_Sheet1.Columns.Get(3).Label = "Sub Lot Tracking Flag";
            ...
            this.spdOper_Sheet1.Columns.Get(3).Width = 180F;
            ...
            this.spdOper_Sheet1.RowHeader.Columns.Get(0).Width = 56F;
            ...
            this.tbpFlowOper.Controls.Add(this.grpFO);
            this.tbpFlowOper.Location = new System.Drawing.Point(4, 22);
            this.tbpFlowOper.Name = "tbpFlowOper";
            this.tbpFlowOper.Padding = new System.Windows.Forms.Padding(3, 0, 3, 3);
            this.tbpFlowOper.Size = new System.Drawing.Size(734, 490);
            this.tbpFlowOper.TabIndex = 1;
            this.tbpFlowOper.Text = "Flow-Operation";
            this.tbpFlowOper.Visible = false;
            // 
            // pnlFOMid
            // 
            ...
            this.pnlFOMid.Size = new System.Drawing.Size(728, 440);
            ...
            this.spdFO_Sheet1});
            this.spdFO.Size = new System.Drawing.Size(728, 435);
            ...
            this.spdFO_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "Sub Lot Tracking Flag";
            ...
            this.spdFO_Sheet1.Columns.Get(0).Width = 80F;
        ...
        "N : No Tracking",
        "U : Upkeep"};
            this.spdFO_Sheet1.Columns.Get(3).CellType = comboBoxCellType2;
            this.spdFO_Sheet1.Columns.Get(3).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            this.spdFO_Sheet1.Columns.Get(3).Label = "Sub Lot Tracking Flag";
            ...
            this.cdvFlow.Location = new System.Drawing.Point(90, 17);
            ...
            this.lblFlow.Location = new System.Drawing.Point(15, 21);
            ...
            this.pnlMFOMid.Size = new System.Drawing.Size(728, 440);
            ...
            this.spdMFO_Sheet1});
            this.spdMFO.Size = new System.Drawing.Size(728, 435);
            ...
            this.spdMFO_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "Sub Lot Tracking Flag";
            ...
            this.spdMFO_Sheet1.Columns.Get(0).Width = 53F;
            ...
            this.spdMFO_Sheet1.Columns.Get(2).Width = 132F;
            ...
            this.spdMFO_Sheet1.Columns.Get(3).Width = 96F;
            ...
            this.spdMFO_Sheet1.Columns.Get(4).Width = 129F;
        ...
        "U : Upkeep"};
            ...
            this.spdMFO_Sheet1.Columns.Get(5).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.General;
            this.spdMFO_Sheet1.Columns.Get(5).Label = "Sub Lot Tracking Flag";
            ...
            this.spdMFO_Sheet1.Columns.Get(5).Width = 142F;
            ...
            this.spdMFO_Sheet1.RowHeader.Columns.Get(0).Width = 45F;
            ...
            this.cdvMaterial.Location = new System.Drawing.Point(9, 17);
            ...
            // 
            // frmWIPSetupSubLotOptionToMFO
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 553);
            this.Name = "frmWIPSetupSubLotOptionToMFO";
            this.Text = "Sublot Option Setup";
            this.Activated += new System.EventHandler(this.frmWIPSetupSubLotOptionToMFO_Activated);
        ...
        //
        // View_MFO_SubLot_List()
        //       - View MFO-SubLot Option List
        // Return Value
        //       - Boolean : True or False
        // Arguments
        //       -
        //
        private bool View_MFO_SubLot_List(char ProcStep, char OptLevel)
        {
            int i;
            int LastRow = 0;

            TRSNode in_node = new TRSNode("VIEW_MFO_SUBLOT_LIST_IN");
            TRSNode out_node = new TRSNode("VIEW_MFO_SUBLOT_LIST_OUT");
            ...
            try
            {
                ...
                do
                {
                    if (MPCR.CallService("WIP", "WIP_View_MFO_Sublot_List", in_node, ref out_node) == false)
                    {
                        return false;
                    }
                    ...
                    switch (OptLevel)
                    {
                        case '1':
                            ...
                            for (i = 0; i < out_node.GetList(0).Count; i++)
                            {
                                ...
                                if (out_node.GetList(0)[i].GetChar("SUBLOT_TRACKING_FLAG") == 'Y')
                                {
                                    with_1.SetValue(LastRow, 5, 0);
                                }
                                else if (out_node.GetList(0)[i].GetChar("SUBLOT_TRACKING_FLAG") == 'N')
                                {
                                    with_1.SetValue(LastRow, 5, 1);
                                }
                                else
                                {
                                    with_1.SetValue(LastRow, 5, 2);
                                }
                        ...
                        case '2':
                            ...
                            for (i = 0; i < out_node.GetList(0).Count; i++)
                            {
                                ...
                                if (out_node.GetList(0)[i].GetChar("SUBLOT_TRACKING_FLAG") == 'Y')
                                {
                                    with_2.SetValue(LastRow, 3, 0);
                                }
                                else if (out_node.GetList(0)[i].GetChar("SUBLOT_TRACKING_FLAG") == 'N')
                                {
                                    with_2.SetValue(LastRow, 3, 1);
                                }
                                else
                                {
                                    with_2.SetValue(LastRow, 3, 2);
                                }
                        ...
                        case '3':
                            ...
                            for (i = 0; i < out_node.GetList(0).Count; i++)
                            {
                                ...
                                if (out_node.GetList(0)[i].GetChar("SUBLOT_TRACKING_FLAG") == 'Y')
                                {
                                    ...
                                    with_3.SetValue(LastRow, 3, 0);
                                }
                                else if (out_node.GetList(0)[i].GetChar("SUBLOT_TRACKING_FLAG") == 'N')
                                {
                                    with_3.SetValue(LastRow, 3, 1);
                                }
                                else
                                {
                                    with_3.SetValue(LastRow, 3, 2);
                                }
        ...
        //
        private bool Update_MFO_Sublot_List(char ProcStep, char OptLevel)
        {
            int i = 0;

            TRSNode in_node = new TRSNode("UPDATE_MFO_SUBLOT_LIST_IN");
            ...
            try
            {
                    ...
                    case '1':
                        for (i = 0; i < spdMFO.Sheets[0].RowCount; i++)
                        {
                            if (spdMFO.Sheets[0].GetValue(i, 0) != null && Convert.ToBoolean(spdMFO.Sheets[0].GetValue(i, 0)) == true)
                            {
                                ...
                                if (MPCF.ToInt(spdMFO.Sheets[0].GetValue(i, 5)) == 0)
                                {
                                    list_item.AddChar("SUBLOT_TRACKING_FLAG", 'Y');
                                }
                                else if (MPCF.ToInt(spdMFO.Sheets[0].GetValue(i, 5)) == 1)
                                {
                                    list_item.AddChar("SUBLOT_TRACKING_FLAG", 'N');
                                }
                                else
                                {
                                    list_item.AddChar("SUBLOT_TRACKING_FLAG", ' ');
                                }
                            }
                        }
                        break;
                    case '2':
                        for (i = 0; i < spdFO.Sheets[0].RowCount; i++)
                        {
                            if (spdFO.Sheets[0].GetValue(i, 0) != null && Convert.ToBoolean(spdFO.Sheets[0].GetValue(i, 0)) == true)
                            {
                                ...
                                if (MPCF.ToInt(spdFO.Sheets[0].GetValue(i, 3)) == 0)
                                {
                                    list_item.AddChar("SUBLOT_TRACKING_FLAG", 'Y');
                                }
                                else if (MPCF.ToInt(spdFO.Sheets[0].GetValue(i, 3)) == 1)
                                {
                                    list_item.AddChar("SUBLOT_TRACKING_FLAG", 'N');
                                }
                                else
                    ...
                    case '3':
                        for (i = 0; i < spdOper.Sheets[0].RowCount; i++)
                        {
                            if (spdOper.Sheets[0].GetValue(i, 0) != null && Convert.ToBoolean(spdOper.Sheets[0].GetValue(i, 0)) == true)
                            {
                                ...
                                if (MPCF.ToInt(spdOper.Sheets[0].GetValue(i, 3)) == 0)
                                {
                                    list_item.AddChar("SUBLOT_TRACKING_FLAG", 'Y');
                                }
                                else if (MPCF.ToInt(spdOper.Sheets[0].GetValue(i, 3)) == 1)
                                {
                                    list_item.AddChar("SUBLOT_TRACKING_FLAG", 'N');
                                }
                                else
                ...
                if (MPCR.CallService("WIP", "WIP_Update_MFO_Sublot_List", in_node, ref out_node) == false)
                {
                    return false;
                }
                ...
                View_MFO_SubLot_List('1', OptLevel);
        ...
        private void frmWIPSetupSubLotOptionToMFO_Activated(object sender, System.EventArgs e)
        {
            try
            {
                if (LoadFlag == false)
                {
                    ...
                    if (View_MFO_SubLot_List('2', '3') == false)
                    {
                        return;
                    }
                    LoadFlag = true;
        ...
        private void btnUpdate_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
                if (CheckCondition("Update_MFO_Sublot_List", MPGC.MP_STEP_UPDATE) == true)
                {
                    if (tabMFO.SelectedIndex == 0)
                    {
                        Update_MFO_Sublot_List(MPGC.MP_STEP_UPDATE, '3');
                    }
                    else if (tabMFO.SelectedIndex == 1)
                    {
                        Update_MFO_Sublot_List(MPGC.MP_STEP_UPDATE, '2');
                    }
                    else if (tabMFO.SelectedIndex == 2)
                    {
                        Update_MFO_Sublot_List(MPGC.MP_STEP_UPDATE, '1');
                    }
                }
            }
            catch (Exception ex)
