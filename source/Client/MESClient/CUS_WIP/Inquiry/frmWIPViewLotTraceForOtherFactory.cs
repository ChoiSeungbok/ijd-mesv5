...
namespace CUS_WIP
{
    public partial class frmWIPViewLotTraceForOtherFactory : CUS_COM.frmViewForm01
    {
        public frmWIPViewLotTraceForOtherFactory()
        {
            InitializeComponent();
            InitControl();
        }
        ...
        private bool View_Material_Usage(string as_lot_id, string sOper)
        {
            ...
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-003", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool ViewWorkerList(string lot_id, int histSeq)
        {
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-004", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_Press_EQP(string as_lot_id, string as_res_id)
        {
            ...
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-005", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_Cup_EQP(string as_lot_id, string as_res_id)
        {
            ...
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-006", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_Laser_EQP(string as_lot_id, string as_res_id)
        {
            ...
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-007", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_Round_EQP(string as_lot_id, string as_res_id)
        {
            ...
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-008", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_Ball_Mill_EQP(string as_lot_id, string as_res_id)
        {
            ...
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-009", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_Impact_EQP(string as_lot_id, string as_res_id)
        {
            ...
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-010", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_EDC_Data(string as_lot_id, string as_mat_id, string as_oper)
        {
            ...
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-011", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_Dry_CIP_EQP(string as_lot_id, string as_res_id, int i_start_hist_seq)
        {
            ...
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-012", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private bool View_Extruding_EQP(string as_lot_id, string as_res_id, int ai_hist_seq)
        {
            ...
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-013", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private void SelectedItemChangedByColSet(string inspId)
        {
            ...
            try
            {
                ...
                if (MPCF.Trim(inspId) != "")
                {
                    ...
                    if (TPDR.GetDataOne("", ref dt, "CWIP3018-014", dvcArgu, false, false, ref sSql) == false)
                    {
                        if (dt != null)
                            dt.Dispose();
        ...
        private bool ViewInspectionData(string inspId)
        {
            try
            {
                ...
                if (TPDR.GetDataOne("", ref dt, "CWIP3018-015", dvcArgu, false, false, ref sSql) == false)
                {
                    if (dt != null)
                        dt.Dispose();
        ...
        private void frmWIPViewLotTraceForOtherFactory_Load(object sender, EventArgs e)
        {
            spdEquip.ActiveSheet = spdEquip_Default;
            grpEquipmentData.Text = MPCF.FindLanguage("Equipment Data", 0);
