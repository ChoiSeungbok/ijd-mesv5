    ...
    public partial class frmTranOutsourcingInProcess : CUS_COM.frmViewForm01
    {
        ...
        private bool SaveLossData()
        {
            try
            {
                ...
                CalLotQty(spdLotList.ActiveSheet.Cells[spdLotList.ActiveSheet.ActiveRowIndex, (int)LOT_INFO.LOT_ID].Text);
        ...
        //lot 정보 조회함수
        private void ViewLotList(string sOrder_id, string sPo)
        {
            try
            {
                TPDR.DirectViewCond[] dvcArgu = new TPDR.DirectViewCond[3];
                ...
                dvcArgu[2].sCondition_ID = "PO_NO";
                dvcArgu[2].sCondition_Value = sPo;
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    spdLotList_Sheet1.Cells[i, (int)LOT_INFO.GOOD_QTY].Value = MPCF.ToDbl(dt.Rows[i]["GOOD_QTY"]) - MPCF.ToDbl(dt.Rows[i]["BAD_QTY"]);
        ...
        {  
            try
            {
                ...
                //in_node.AddString("OPER", cdvOper.Text);
                in_node.AddString("OPER", spdLotList.ActiveSheet.Cells[spdLotList.ActiveSheet.ActiveRowIndex, (int)LOT_INFO.OPER].Text);
                in_node.AddString("ORDER_ID", spdPoInfo.ActiveSheet.Cells[spdPoInfo.ActiveSheet.ActiveRowIndex, (int)PO_INFO.ORDER_ID].Text);
                in_node.AddString("LOT_ID", spdLotList.ActiveSheet.Cells[spdLotList.ActiveSheet.ActiveRowIndex, (int)LOT_INFO.LOT_ID].Text);
                in_node.AddString("PO_NO", spdLotList.ActiveSheet.Cells[spdLotList.ActiveSheet.ActiveRowIndex, (int)PO_INFO.PO_NO].Text);
                in_node.AddString("PO_SEQ", spdLotList.ActiveSheet.Cells[spdLotList.ActiveSheet.ActiveRowIndex, (int)PO_INFO.PO_SEQ].Text);
        ...
        private void CalLotQty(string sLot_id)
        {
            double dLotQty = 0;
            ...
            try
            {
                spdLotList.Search(0, sLot_id, false, false, false, false, 0, (int)LOT_INFO.LOT_ID, ref iRow, ref iCol);

                dLotQty = MPCF.ToDbl(spdLotList.ActiveSheet.Cells[iRow, (int)LOT_INFO.QTY_1].Text);
                dLotLossQty = MPCF.ToDbl(spdLotList.ActiveSheet.Cells[iRow, (int)LOT_INFO.BAD_QTY].Text);
                ...
                spdLotList.ActiveSheet.SetValue(iRow, (int)LOT_INFO.GOOD_QTY, dLotQty - dLotLossQty - dSumSplitLotQty);
            ...
            try
            {
                ...
                switch (CHECK)
                {
                    ...
                    case CSGC.CHECK.SAVE:
                        ...
                        dGoodQty = MPCF.ToDbl(spdLotList.ActiveSheet.Cells[spdLotList.ActiveSheet.ActiveRowIndex, (int)LOT_INFO.GOOD_QTY].Text);

                        if (dGoodQty < dLotLossQty)
                        {
        ...
        private void spdPoInfo_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            try
            {
                ...
                sPo = spdPoInfo.ActiveSheet.Cells[e.Row, (int)PO_INFO.PO_NO].Text;

                if (MPCF.Trim(sOrder_id) != "")
                {
                    ViewLotList(sOrder_id, sPo);
                    MPCF.ClearList(spdInLotList);
                    CSCF.ClearSpread(spdLossList, 0, (int)LOSS_INFO.LOSS_QTY, "0");
                }
            }
            catch (Exception ex)
            {
        ...
        private void spdLotList_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (spdLotList.ActiveSheet.Rows[e.Row].BackColor == Color.FromArgb(255, 192, 255))
                    return;
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sPo = spdPoInfo.ActiveSheet.Cells[spdPoInfo.ActiveSheet.ActiveRowIndex, (int)PO_INFO.PO_NO].Text;
                sLot_id = spdLotList.ActiveSheet.Cells[spdLotList.ActiveSheet.ActiveRowIndex, (int)LOT_INFO.LOT_ID].Text;

                if (SaveProcess('2'))
                {
                    ClearData("END");
                    //ViewLotList(sOrder, sPo);
                    //ViewInLotList(sLot_id);
                    //ViewLossList("");
                }
            }
