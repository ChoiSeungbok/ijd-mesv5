...
namespace CUS_WIP
{
    public partial class frmTranCupCellMapping : CUS_COM.frmTranForm01
    {
        public frmTranCupCellMapping()
        {
            InitializeComponent();
        ...
        private void ViewLotList()
        {
            ...
            try
            {
                ...
                //D12와 cell인경우 쿼리가 바뀐다. 
                if (cdvGroupType.Text == CSGC.CP_MAPPING_GROUP_D12)
                    sView_ID = "CWIP2012-001";              //D12
                else
                    sView_ID = "CWIP2012-004";              //CELL
                ...
                {   
                    //20240405 현업실수가 너무 많아서...그냥 V5Y6인경우는 6으로 자동나눠지게함.
                    if(dt.Rows[i]["MAT_DESC"].ToString().Contains("V5Y6") == true)
                    {
                        txtMappingCount.Text = "6";
                    }
        ...
        private bool SaveProcess(char c_step)
        {
            ...
            try
            {
                ...
                in_node.AddInt("MAPPING_COUNT", iMappingCount);
        ...
        private void frmTranCupCellMapping_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void cdvOper_ButtonPress(object sender, EventArgs e)
        {
            try
            {
                ...
                cdvOper.Columns.Add("Key_1", 50, HorizontalAlignment.Left);
                cdvOper.Columns.Add("Desc", 100, HorizontalAlignment.Left);
                cdvOper.Columns.Add("Option", 0, HorizontalAlignment.Left);
        ...
        private void cdvOperResource_ButtonPress(object sender, EventArgs e)
        {
            try
            {
                ...
                cdvOperResource.Columns.Add("Operation", 50, HorizontalAlignment.Left);
                cdvOperResource.Columns.Add("Desc", 100, HorizontalAlignment.Left);
        ...
        private void cdvGroupType_ButtonPress(object sender, EventArgs e)
        {
            try
            {
                ...
                cdvGroupType.Columns.Add("Key_1", 50, HorizontalAlignment.Left);
                cdvGroupType.Columns.Add("Desc", 100, HorizontalAlignment.Left);
                cdvGroupType.Columns.Add("Count", 0, HorizontalAlignment.Left);
        ...
        private void cdvResource_ButtonPress(object sender, EventArgs e)
        {
            try
            {
                ...
                cdvResource.Columns.Add("Count", 0, HorizontalAlignment.Left);
        ...
        private void cdvCar_ButtonPress(object sender, EventArgs e)
        {
            try
            {
                ...
                cdvCar.Columns.Add("Key_1", 50, HorizontalAlignment.Left);
                cdvCar.Columns.Add("Desc", 100, HorizontalAlignment.Left);
                cdvCar.Columns.Add("Count", 0, HorizontalAlignment.Left);
