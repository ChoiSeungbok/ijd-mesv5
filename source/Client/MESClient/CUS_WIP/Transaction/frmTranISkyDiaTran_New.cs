...
namespace CUS_WIP
{
    public partial class frmTranISkyDiaTran_New : CUS_COM.frmTranForm06
    {
        public frmTranISkyDiaTran_New()
        {
            InitializeComponent();
        ...
        private void ViewLotIngList()
        {
            try
            {
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    spdLotIngView_Sheet1.Cells[i, (int)LOT_ING_INFO.ORDER_ID].Value = dt.Rows[i]["ORDER_ID"];
                    spdLotIngView_Sheet1.Cells[i, (int)LOT_ING_INFO.PACK_ORDER_ID].Value = dt.Rows[i]["PACK_ORDER_ID"];
                    spdLotIngView_Sheet1.Cells[i, (int)LOT_ING_INFO.PACK_LINE_NO].Value = dt.Rows[i]["PACK_LINE_NO"];
                }
        ...
        private void frmTranISkyDiaTran_New_Load(object sender, EventArgs e)
        {
    ...
    */
        ...
        private void btnQcSearchLot_Click(object sender, EventArgs e)
        {
            ViewQcLotList();
        }

        private void txtPackLotId_TextChanged(object sender, EventArgs e)
        {
