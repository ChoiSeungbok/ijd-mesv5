                ...
                switch (c_step)
                {
                    case MPGC.MP_STEP_CREATE:
                        ...
                        if (tabRule.SelectedTab == tbpItems)
                        {
                            ...
                            if (cdvKey.Text == "LOT_INFO_MATCH" || cdvKey.Text == "RES_INFO_MATCH")
                            {
            ...
            try
            {
                ...
                if (tabRule.SelectedTab == tbpItems)
                {
                    ...
                    if (c_step == MPGC.MP_STEP_UPDATE)
                    {
                        ...
                        if (cdvKey.Text == "LOT_INFO_MATCH" || cdvKey.Text == "RES_INFO_MATCH" || (MPCF.Trim(cdvKey.Tag).Length > 1 &&(MPCF.Trim(cdvKey.Tag).Substring(1, 1) == "K")))
                        {
