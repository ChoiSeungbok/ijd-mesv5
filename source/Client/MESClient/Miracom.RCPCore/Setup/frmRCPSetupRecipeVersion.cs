...
namespace Miracom.RCPCore
{
    public class frmRCPSetupRecipeVersion : Miracom.MESCore.SetupForm02
    {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            this.tbpAppNRel.Size = new System.Drawing.Size(394, 311);
            ...
            this.pnlReleaseInfo.Size = new System.Drawing.Size(388, 215);
            ...
            this.grpRelease.Size = new System.Drawing.Size(388, 210);
            ...
            this.tbpCopy.Size = new System.Drawing.Size(394, 311);
            ...
            this.lisParameter.Size = new System.Drawing.Size(388, 102);
            ...
            this.grpParameter.Location = new System.Drawing.Point(3, 107);
            this.grpParameter.Name = "grpParameter";
            this.grpParameter.Size = new System.Drawing.Size(388, 160);
            ...
            this.txtParameterID.MaxLength = 20;
        ...
        private bool View_Para_Version_List()
        {
            ...
            try
            {
                ...
                for (i = 0; i <= iDataCnt - 1; i++)
                {
                    ...
                    itmX = new ListViewItem(MPCF.Trim(out_node.GetList(0)[i].GetInt("PARA_SEQ")), (int)SMALLICON_INDEX.IDX_EVENT);
                    
                    itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("PARA_ID")));
                    itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("PARA_VALUE")));
                    itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("PARA_DESC")));
                    itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetChar("MODIFY_FLAG")));
                    itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("CREATE_USER_ID")));
                    itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("CREATE_TIME")));
                    itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("UPDATE_USER_ID")));
                    itmX.SubItems.Add(MPCF.Trim(out_node.GetList(0)[i].GetString("UPDATE_TIME")));
        ...
        private bool Update_Para_Version(char ProcStep)
        {
            ...
            try
            {
                ...
                if (MPCR.CallService("RCP", "RCP_Update_Para_Version", in_node, ref out_node) == false)
                {
                    return false;
                }
