...
//
//   System      : MES
//   File Name   : frmRCPViewSublotRecipeHistory.vb
//   Description : MES Cient Form View SubLot Recipe History Class
//
//   MES Version : 4.1.0.0
//
//   Function List
...
//       - View_Sublot_Recipe_History() :View SubLot Recipe History
//
//   Detail Description
//       -
//
...
{
    public class frmRCPViewSublotRecipeHistory : Miracom.MESCore.ViewForm01
    {
        
        #region " Windows Form auto generated code "
        
        public frmRCPViewSublotRecipeHistory()
        {
        ...
        [System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
        {
            ...
            // lblFormTitle
            // 
            this.lblFormTitle.Text = "View SubLot Recipe History";
            // 
            // grbGeneral
            // 
            ...
            this.spdRecipe_LotInfo.Cells.Get(0, 0).Value = "Sub Lot ID";
            ...
            this.spdRecipe_LotInfo.VisualStyles = FarPoint.Win.VisualStyles.Auto;
            ...
            // 
            // frmRCPViewSublotRecipeHistory
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(742, 546);
            this.Name = "frmRCPViewSublotRecipeHistory";
            this.Text = "View Sublot Recipe History";
            this.Activated += new System.EventHandler(this.frmRCPViewSublotRecipeHistory_Activated);
            this.Load += new System.EventHandler(this.frmRCPViewSublotRecipeHistory_Load);
        ...
        private bool CheckCondition(string FuncName)
        {
            ...
            try
            {
                switch (FuncName)
                {
                    case "View_Sublot_Recipe_History":
...
//            
        ...
        // View_Sublot_Recipe_History()
        //       - View SubLot Recipe History
        // Return Value
        //       - Boolean : True / False
        // Arguments
        //        -
        //
        private bool View_Sublot_Recipe_History(char c_step, string sSublot_id, int iHistSeq)
        {
            int i;
            int LastRow = 0;

            TRSNode in_node = new TRSNode("VIEW_SUBLOT_RECIPE_HISTORY_IN");
            TRSNode out_node = new TRSNode("VIEW_SUBLOT_RECIPE_HISTORY_OUT");
            ...
            try
            {
                ...
                if (MPCR.CallService("RCP", "RCP_View_Sublot_Recipe_History", in_node, ref out_node) == false)
                {
                    return false;
                }
                ...
                with_1.Cells[0, 1].Value = MPCF.Trim(sSublot_id);
        ...
        private void frmRCPViewSublotRecipeHistory_Load(object sender, System.EventArgs e)
        {
            try
            {
        ...
        private void frmRCPViewSublotRecipeHistory_Activated(object sender, System.EventArgs e)
        {
            try
            {
        ...
        private void btnView_Click(System.Object sender, System.EventArgs e)
        {
            ...
            try
            {
                InitRecipeInfo();
                MPCF.ClearList(spdParameter, true);
                if (CheckCondition("View_Sublot_Recipe_History") == true)
                {
                    if (View_Sublot_Recipe_History('1', txtSubLotID.Text, MPCF.ToInt(txtHistSeq.Text)) == false)
                    {
                        txtSubLotID.Focus();
                        return;
                    }
        ...
        private void btnExcel_Click(System.Object sender, System.EventArgs e)
        {
            ...
            sCond = "Sub Lot ID :" + txtSubLotID.Text + "Hist Seq. : " + txtHistSeq.Text;
