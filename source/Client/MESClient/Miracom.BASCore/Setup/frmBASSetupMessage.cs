...
//
//   Detail Description
//       - BAS_View_Message_Group_List()??寃쎌슦 listview, combobox 濡?overload ?섏뼱 ?덉쓬.
//
//   History
...
namespace Miracom.BASCore
{
    public partial class frmBASSetupMessage : Miracom.MESCore.SetupForm02
    {
        ...
        //       - boolean : True / False
        // Arguments
        //       - ByVla c_step                : Create/Update/Delete 援щ텇??
        //
        private bool Update_Message(char c_step)
        {
            ...
            try
            {
                ...
                //    in_node.SetString("STR2", "abcde대한민국");
        ...
        private void frmBASSetupMessage_Activated(object sender, System.EventArgs e)
        {
            if (b_load_flag == false)
            {
                ...
                if (BASLIST.ViewMessageGroupList(cboMsgGrp, '1', null, false, false) == true)
                {
                    ...
                    {
                        //Modify by J.S. 2015.05.14 존재하지 않는 항목이 올경우 0번째 항목 Display
                        int j = 0;
                        int i = 0;
                        if (s_msg_group != "")
                        {
