...
DllExport int SPM_Update_Spec_Character_Before_1(TRSNode *in_node, TRSNode *out_node);
DllExport int SPM_Update_Spec_Character_After_1(TRSNode *in_node, TRSNode *out_node);
